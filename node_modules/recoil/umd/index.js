(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    : typeof define === "function" && define.amd
      ...
      : ((global = global || self),
        factory((global.Recoil = {}), global.React, global.ReactDOM));
  ...
  const useMutableSource = // flowlint-next-line unclear-type:off
    ...
    _useMutableSource !== void 0
      ? _useMutableSource
      : react.unstable_useMutableSource; // https://github.com/reactwg/react-18/discussions/86

  const useSyncExternalStore = // flowlint-next-line unclear-type:off
    (_useSyncExternalStore = react.useSyncExternalStore) !== null &&
    _useSyncExternalStore !== void 0
      ? _useSyncExternalStore // flowlint-next-line unclear-type:off
  ...
  */
    ...
    var updateCollisionList = function updateCollisionList(
      mutate,
      edit,
      keyEq,
      h,
    ...
    var Leaf__modify = function Leaf__modify(
      edit,
      keyEq,
      shift,
      f,
    ...
    var Collision__modify = function Collision__modify(
      edit,
      keyEq,
      shift,
      f,
    ...
    var IndexedNode__modify = function IndexedNode__modify(
      edit,
      keyEq,
      shift,
      f,
    ...
    var ArrayNode__modify = function ArrayNode__modify(
      edit,
      keyEq,
      shift,
      f,
  ...
  */
  ...
  function mergeDepsIntoGraph(
    key,
    newDeps,
    graph, // If olderGraph is given then we will not overwrite changes made to the given
  ...
  const { invalidateMemoizedSnapshot: invalidateMemoizedSnapshot$1 } =
    ...
    function findReleasableNodesInner(searchFromNodes) {
      ...
      for (const node of releasableNodesFoundThisIteration) {
        for (const parent of (_graph$nodeDeps$get =
          graph.nodeDeps.get(node)) !== null && _graph$nodeDeps$get !== void 0
          ? _graph$nodeDeps$get
          : emptySet$1) {
          var _graph$nodeDeps$get;
  ...
  function getDownstreamNodesInTopologicalOrder(
    store,
    treeState,
    nodes, // Mutable set is destroyed in place
    doNotDescendInto1,
    doNotDescendInto2,
  ) {
    const graph = store.getGraph(treeState.version);
    ...
    if (graph) {
      ...
      if (deps !== undefined) {
        ...
        for (const dep of deps) {
          ...
          (_graph$nodeToNodeSubs = graph.nodeToNodeSubscriptions.get(dep)) ===
            null || _graph$nodeToNodeSubs === void 0
            ? void 0
  ...
  const { unstable_batchedUpdates: unstable_batchedUpdates$2 } =
  ...
  const isSSR = typeof Window === "undefined" || typeof window === "undefined"; // $FlowFixMe(site=recoil) Window does not have a FlowType definition https://github.com/facebook/flow/issues/6709
  ...
  const { initializeNode: initializeNode$1, peekNodeInfo: peekNodeInfo$1 } =
    Recoil_FunctionalCore;
  ...
  const { setInvalidateMemoizedSnapshot: setInvalidateMemoizedSnapshot$1 } =
    Recoil_SnapshotCache;
...
`; // A "Snapshot" is "read-only" and captures a specific set of values of atoms.
  ...
  const [memoizedCloneSnapshot, invalidateMemoizedSnapshot$2] =
    memoizeOneWithArgsHashAndInvalidation$1(
  ...
  const { createMutableSource: createMutableSource$1, reactMode: reactMode$2 } =
    Recoil_ReactMode;

  const { applyAtomValueWrites: applyAtomValueWrites$1 } =
    Recoil_RecoilValueInterface;

  const { releaseScheduledRetainablesNow: releaseScheduledRetainablesNow$1 } =
    Recoil_Retention;
  ...
  function sendEndOfBatchNotifications(store) {
    ...
    storeState.queuedComponentCallbacks_DEPRECATED.forEach((cb) =>
      cb(treeState),
    );
  ...
  function validateRecoilValue(
    recoilValue,
    hookName, // $FlowFixMe[missing-local-annot]
  ) {
    if (!isRecoilValue$2(recoilValue)) {
      throw Recoil_err(
        `Invalid argument to ${hookName}: expected an atom or selector but got ${String(recoilValue)}`,
      );
    }
  }
    ...
    const getSnapshot = useCallback$1(() => {
      ...
      const treeState = reactMode$3().early
        ? (_storeState$nextTree2 = storeState.nextTree) !== null &&
          ...
          : storeState.currentTree
        : storeState.currentTree;
      const loadable = getRecoilValueAsLoadable$2(
        store,
        recoilValue,
        treeState,
      );
  ...
  */
  ...
  const { RecoilRoot: RecoilRoot$1, useStoreRef: useStoreRef$5 } =
    Recoil_RecoilRoot;
  ...
  const { refreshRecoilValue: refreshRecoilValue$2 } =
    Recoil_RecoilValueInterface;
        ...
        for (const [nodeKey, nodeValue] of route) {
          ...
          handlers === null || handlers === void 0
            ...
            : (_handlers$onNodeVisit = handlers.onNodeVisit) === null ||
              ...
              ? void 0
              : _handlers$onNodeVisit.call(handlers, node); // Prepare for next iteration and install root if it is new.
  ...
  const { isReactNative: isReactNative$1, isWindow: isWindow$1 } =
    Recoil_Environment;
  ...
  const { markRecoilValueModified: markRecoilValueModified$1 } =
    Recoil_RecoilValueInterface;

  const { retainedByOptionWithDefault: retainedByOptionWithDefault$1 } =
    Recoil_Retention;
  ...
  function selector(options) {
    ...
    const retainedBy = retainedByOptionWithDefault$1(
    ...
    function selectorIsLive() {
      return (
        !Recoil_gkx("recoil_memory_managament_2020") || liveStoresCount > 0
      );
    }
    ...
    function notifyWaitingStores(executionID, clearWaitlist) {
      ...
      if (stores != null) {
        for (const waitingStore of stores) {
          markRecoilValueModified$1(
            waitingStore,
            Recoil_nullthrows(recoilValue),
          );
        }
    ...
    function wrapPendingDependencyPromise(
      ...
      return promise
        .then((resolvedDep) => {
          ...
          const cachedLoadable = getLoadableFromCacheAndUpdateDeps(
            store,
            state,
          );
    ...
    function selectorPeek(store, state) {
      ...
      return cache.get((nodeKey) => {
        ...
        !(typeof nodeKey === "string")
          ? Recoil_invariant(false, "Cache nodeKey is type string")
          : void 0;
        return (_peekNodeLoadable = peekNodeLoadable$1(
          store,
          state,
          nodeKey,
    ...
    if (set != null) {
      ...
      const selectorSet = (store, state, newValue) => {
        ...
        function setRecoilState(
          recoilState,
          valueOrUpdater, // $FlowFixMe[missing-local-annot]
        ) {
          if (syncSelectorSetFinished) {
            const msg =
              "Recoil: Async selector sets are not currently supported.";
  ...
  const { retainedByOptionWithDefault: retainedByOptionWithDefault$2 } =
    Recoil_Retention;
  ...
  function atom(options) {
    ...
    const optionsDefault =
      "default" in options // $FlowIssue[incompatible-type] No way to refine in Flow that property is not defined
        ? options.default
        : new Promise(() => {});
  ...
  function atomWithFallback(options) {
    ...
    setConfigDeletionHandler$1(
      sel.key,
      getConfigDeletionHandler$2(options.key),
    );
    return sel;
  } // $FlowFixMe[missing-local-annot]
  ...
  */
  ...
  function unwrapDependencies(dependencies) {
    return Array.isArray(dependencies)
      ? dependencies
      : Object.getOwnPropertyNames(dependencies).map(
  ...
  const { RecoilRoot: RecoilRoot$2, useRecoilStoreID: useRecoilStoreID$1 } =
    Recoil_RecoilRoot;
