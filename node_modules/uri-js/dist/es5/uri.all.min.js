...
!(function (e, r) {
  ...
  function S(e) {
    ...
    l(e, n),
      "suffix" !== r.reference && e.scheme && (t.push(e.scheme), t.push(":"));
    var a = C(e, r);
    if (
      (a !== undefined &&
  ...
  function O(e, r) {
    return (
      e && e.toString().replace(r && r.iri ? R.PCT_ENCODED : F.PCT_ENCODED, d)
    );
  }
  function N(e) {
  ...
  var F = u(!1),
    ...
    k = function (e, r, n) {
      var t = 0;
      for (e = n ? z(e / 700) : e >> 1, e += z(e / r); e > 455; t += 36)
        e = z(e / 35);
    ...
    ve = {
      ...
      parse: function (e, r) {
        ...
        for (var d = 0, l = t.length; d < l; ++d) {
          var m = t[d].split("@");
          if (((m[0] = O(m[0])), r.unicodeSupport))
            m[1] = O(m[1], r).toLowerCase();
          else
            try {
