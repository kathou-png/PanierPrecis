...
exports.getNamespaceModifiers =
  exports.isValidAssignmentTarget =
  exports.nodeCanBeDecorated =
  exports.getContainingFunction =
  exports.nodeIsPresent =
  ...
  exports.nodeHasIllegalDecorators =
  exports.createError =
  exports.TSError =
  ...
  exports.isESTreeBinaryOperator =
...
function getNamespaceModifiers(node) {
  ...
  while (
    ...
    const parentModifiers = (0, getModifiers_1.getModifiers)(
