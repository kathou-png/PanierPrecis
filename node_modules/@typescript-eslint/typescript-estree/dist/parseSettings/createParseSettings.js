...
exports.clearTSServerProjectService =
  exports.clearTSConfigMatchCache =
  exports.createParseSettings =
    void 0;
...
function createParseSettings(code, options = {}) {
  ...
  const parseSettings = {
    ...
    EXPERIMENTAL_projectService:
      ...
      (options.project &&
        ...
        ? (TSSERVER_PROJECT_SERVICE ??= (0,
          createProjectService_1.createProjectService)(
            options.EXPERIMENTAL_useProjectService,
            jsDocParsingMode,
          ))
        : undefined,
    ...
    extraFileExtensions:
      ...
      options.extraFileExtensions.every((ext) => typeof ext === "string")
        ...
        : [],
    filePath: (0, shared_1.ensureAbsolutePath)(
    ...
    tsconfigMatchCache: (TSCONFIG_MATCH_CACHE ??=
      new ExpiringCache_1.ExpiringCache(
        singleRun
          ? "Infinity"
  ...
  if (!parseSettings.programs && !parseSettings.EXPERIMENTAL_projectService) {
    parseSettings.projects = (0, resolveProjectList_1.resolveProjectList)({
      ...
      project: (0, getProjectConfigFiles_1.getProjectConfigFiles)(
        parseSettings,
        options.project,
      ),
