...
exports.ExpiringCache = exports.DEFAULT_TSCONFIG_CACHE_DURATION_SECONDS =
  void 0;
...
class ExpiringCache {
  constructor(cacheDurationSeconds) {
    ...
    __classPrivateFieldSet(
      this,
      _ExpiringCache_cacheDurationSeconds,
  ...
  get(key) {
    const entry = __classPrivateFieldGet(this, _ExpiringCache_map, "f").get(
      key,
    );
    if (entry?.value != null) {
      if (
      ...
      if (
        ageSeconds <
        __classPrivateFieldGet(this, _ExpiringCache_cacheDurationSeconds, "f")
      ) {
        // cache hit woo!
        return entry.value;
      }
...
(_ExpiringCache_cacheDurationSeconds = new WeakMap()),
  (_ExpiringCache_map = new WeakMap());
