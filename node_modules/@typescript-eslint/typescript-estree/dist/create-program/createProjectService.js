...
function createProjectService(optionsRaw, jsDocParsingMode) {
  ...
  (0, validateDefaultProjectForFilesGlob_1.validateDefaultProjectForFilesGlob)(
    options,
  );
  ...
  if (options.defaultProject) {
    ...
    try {
      ...
      throw new Error(
        `Could not parse default project '${options.defaultProject}': ${error.message}`,
      );
    }
    if (configRead.error) {
      throw new Error(
    ...
    service.setCompilerOptionsForInferredProjects(
      configRead.config.compilerOptions,
    );
  }
  return {
