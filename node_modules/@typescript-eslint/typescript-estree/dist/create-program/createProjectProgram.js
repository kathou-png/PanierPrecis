...
function createProjectProgram(parseSettings, programsForProjects) {
  ...
  const astAndProgram = (0, node_utils_1.firstDefined)(
    programsForProjects,
    (currentProgram) =>
      (0, shared_1.getAstFromProgram)(currentProgram, parseSettings.filePath),
  );
  ...
  const describeProjectFilePath = (projectFile) =>
    (0, describeFilePath_1.describeFilePath)(
      projectFile,
      parseSettings.tsconfigRootDir,
    );
  const describedFilePath = (0, describeFilePath_1.describeFilePath)(
