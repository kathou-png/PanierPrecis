...
exports.clearParseAndGenerateServicesCalls =
  ...
  exports.clearDefaultProjectMatchedFiles =
...
function getProgramAndAST(parseSettings, hasFullTypeInformation) {
  if (parseSettings.EXPERIMENTAL_projectService) {
    const fromProjectService = (0,
    useProgramFromProjectService_1.useProgramFromProjectService)(
  ...
  if (parseSettings.programs) {
    const fromProvidedPrograms = (0, useProvidedPrograms_1.useProvidedPrograms)(
  ...
  const fromProjectProgram = (0, createProjectProgram_1.createProjectProgram)(
    parseSettings,
    (0, getWatchProgramsForProjects_1.getWatchProgramsForProjects)(
      parseSettings,
    ),
  );
  ...
  if (parseSettings.DEPRECATED__createDefaultProgram) {
    // eslint-disable-next-line deprecation/deprecation -- will be cleaned up with the next major
    const fromDefaultProgram = (0, createDefaultProgram_1.createDefaultProgram)(
      parseSettings,
    );
...
function parseWithNodeMapsInternal(code, options, shouldPreserveNodeMaps) {
   ...
   */
  const parseSettings = (0, createParseSettings_1.createParseSettings)(
    code,
    options,
  );
  /**
...
function parseAndGenerateServices(code, options) {
      ...
      *[Symbol.iterator]() {
        for (const configFile of parseSettings.projects) {
          ...
          if (existingProgram) {
            ...
            const newProgram = (0,
            useProvidedPrograms_1.createProgramFromConfigFile)(configFile[1]);
  ...
  return {
    ast: estree,
    services: (0, createParserServices_1.createParserServices)(
      astMaps,
      program,
    ),
  };
