...
function useProgramFromProjectService(
  { allowDefaultProjectForFiles, maximumDefaultProjectFileMatchCount, service },
  parseSettings,
...
`);
  ...
  return (0, createProjectProgram_1.createProjectProgram)(parseSettings, [
    program,
  ]);
...
function filePathMatchedBy(filePath, allowDefaultProjectForFiles) {
  return !!allowDefaultProjectForFiles?.some((pattern) =>
    (0, minimatch_1.minimatch)(filePath, pattern),
  );
}
