 ...
 */
export declare function isLogicalOperator(
  operator: ts.BinaryOperatorToken,
): operator is ts.Token<LogicalOperatorKind>;
export declare function isESTreeBinaryOperator(
  operator: ts.BinaryOperatorToken,
 ...
 */
export declare function getBinaryExpressionType(
  operator: ts.BinaryOperatorToken,
):
  | {
...
export declare function nodeHasIllegalDecorators(
  node: ts.Node,
): node is ts.Node & {
...
export declare function nodeIsPresent(
  node: ts.Node | undefined,
): node is ts.Node;
export declare function getContainingFunction(
  node: ts.Node,
...
export declare function getNamespaceModifiers(
