...
export declare const isNodeOfType: <NodeType extends AST_NODE_TYPES>(
  nodeType: NodeType,
) => (node: TSESTree.Node | null | undefined) => node is
  | Extract<
      TSESTree.Program,
      {
        type: NodeType;
    ...
    >
  | Extract<
      TSESTree.AccessorPropertyComputedName,
      {
        type: NodeType;
      }
    >
  ...
  | Extract<
    ...
    >
  | Extract<
      TSESTree.TSAbstractAccessorPropertyComputedName,
      {
        type: NodeType;
      }
    >
  | Extract<
      TSESTree.TSAbstractAccessorPropertyNonComputedName,
      {
        type: NodeType;
      }
    >
  ...
  | Extract<
    ...
    >
  | Extract<
      TSESTree.TSModuleDeclarationModuleWithIdentifierId,
      {
        type: NodeType;
      }
    >
  ...
  | Extract<
    ...
    >
  | Extract<
      TSESTree.TSModuleDeclarationNamespace,
      {
        type: NodeType;
      }
    >
...
export declare const isNotTokenOfTypeWithConditions: <
  TokenType extends AST_TOKEN_TYPES,
  ExtractedToken extends
    | Extract<
        TSESTree.BooleanToken,
...
>(
  ...
  | Exclude<TSESTree.BooleanToken, Conditions & ExtractedToken>
  | Exclude<TSESTree.BlockComment, Conditions & ExtractedToken>
  | Exclude<TSESTree.LineComment, Conditions & ExtractedToken>
  | Exclude<TSESTree.IdentifierToken, Conditions & ExtractedToken>
  | Exclude<TSESTree.JSXIdentifierToken, Conditions & ExtractedToken>
  | Exclude<TSESTree.JSXTextToken, Conditions & ExtractedToken>
  | Exclude<TSESTree.KeywordToken, Conditions & ExtractedToken>
  | Exclude<TSESTree.NullToken, Conditions & ExtractedToken>
  | Exclude<TSESTree.NumericToken, Conditions & ExtractedToken>
  | Exclude<TSESTree.PunctuatorToken, Conditions & ExtractedToken>
  | Exclude<TSESTree.RegularExpressionToken, Conditions & ExtractedToken>
  | Exclude<TSESTree.StringToken, Conditions & ExtractedToken>
  | Exclude<TSESTree.TemplateToken, Conditions & ExtractedToken>;
