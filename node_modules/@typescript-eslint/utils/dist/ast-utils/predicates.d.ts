...
declare const isNotOptionalChainPunctuator: (
  token: TSESTree.Token | null | undefined,
) => token is
...
declare const isNotNonNullAssertionPunctuator: (
  token: TSESTree.Token | null | undefined,
) => token is
  | TSESTree.BooleanToken
  | TSESTree.BlockComment
...
declare const isLogicalOrOperator: (
  node: TSESTree.Node | null | undefined,
) => node is Partial<TSESTree.LogicalExpression> & TSESTree.LogicalExpression;
/**
...
declare const isConstructor: (
  ...
  | (Partial<TSESTree.MethodDefinitionComputedName> &
      TSESTree.MethodDefinitionComputedName)
  | (Partial<TSESTree.MethodDefinitionNonComputedName> &
      TSESTree.MethodDefinitionNonComputedName);
/**
