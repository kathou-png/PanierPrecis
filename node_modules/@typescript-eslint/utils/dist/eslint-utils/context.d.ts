...
export declare function getAncestors(
...
export declare function getDeclaredVariables(
  context: Readonly<RuleContext<string, unknown[]>>,
  node: TSESTree.Node,
): readonly Scope.Variable[];
/** @deprecated use `context.filename` */
export declare function getFilename(
  context: Readonly<RuleContext<string, unknown[]>>,
): string;
...
export declare function getSourceCode(
  context: Readonly<RuleContext<string, readonly unknown[]>>,
): Readonly<SourceCode>;
