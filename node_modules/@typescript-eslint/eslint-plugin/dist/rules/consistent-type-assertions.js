    ...
    function getTextWithParentheses(node) {
      ...
      if ((0, util_1.isParenthesized)(node, context.sourceCode)) {
        const bodyOpeningParen = (0, util_1.nullThrows)(
          context.sourceCode.getTokenBefore(node, util_1.isOpeningParenToken),
          util_1.NullThrowsReasons.MissingToken("(", "node"),
        );
        const bodyClosingParen = (0, util_1.nullThrows)(
          context.sourceCode.getTokenAfter(node, util_1.isClosingParenToken),
          util_1.NullThrowsReasons.MissingToken(")", "node"),
        );
