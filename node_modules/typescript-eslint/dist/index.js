...
const eslint_plugin_1 = __importDefault(
...
const configs = {
  ...
  recommendedTypeChecked: (0, recommended_type_checked_1.default)(
    plugin,
    parser,
  ),
  recommendedTypeCheckedOnly: (0, recommended_type_checked_only_1.default)(
    plugin,
    parser,
  ),
  strict: (0, strict_1.default)(plugin, parser),
  strictTypeChecked: (0, strict_type_checked_1.default)(plugin, parser),
  strictTypeCheckedOnly: (0, strict_type_checked_only_1.default)(
    plugin,
    parser,
  ),
  stylistic: (0, stylistic_1.default)(plugin, parser),
  stylisticTypeChecked: (0, stylistic_type_checked_1.default)(plugin, parser),
  stylisticTypeCheckedOnly: (0, stylistic_type_checked_only_1.default)(
    plugin,
    parser,
  ),
};
