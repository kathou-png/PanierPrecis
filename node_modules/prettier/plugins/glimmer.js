      ...
      if ((e && typeof e == "object") || typeof e == "function")
        for (let s of ts(e))
          !rs.call(t, s) &&
            ...
            Yt(t, s, {
              get: () => e[s],
              enumerable: !(n = es(e, s)) || n.enumerable,
            });
      return t;
    };
  var ss = (t) => ns(Yt({}, "__esModule", { value: !0 }), t);
  var Ur = (t, e, r) => {
    if (!e.has(t)) throw TypeError("Cannot " + r);
  };
  var W = (t, e, r) => (
      Ur(t, e, "read from private field"), r ? r.call(t) : e.get(t)
    ),
    Wt = (t, e, r) => {
      if (e.has(t))
    ...
    Kt = (t, e, r, n) => (
      Ur(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r
    );
  var ba = {};
  zt(ba, { languages: () => yn, parsers: () => Rr, printers: () => ga });
  var is = (t, e, r, n) => {
      if (!(t && e == null))
        return e.replaceAll
          ? e.replaceAll(r, n)
...
Expected it to be ${n}.`;
  ...
  var Mr = () => {},
    ...
    dt = Mr;
  function O(t) {
    return ge(t), { type: Le, contents: t };
  }
  function cs(t, e) {
    return ge(e), { type: _e, contents: e, n: t };
  }
  function B(t, e = {}) {
    return (
      ge(t),
  ...
  var Gr = { type: Ie };
  var us = { type: J, hard: !0 },
    hs = { type: J, hard: !0, literal: !0 },
    C = { type: J },
    G = { type: J, soft: !0 },
    be = [us, Gr],
    Yr = [hs, Gr];
...
`,
  ...
  function $r(t, e) {
    ...
    t.type === "ElementNode" &&
      (delete e.startTag, delete e.parts, delete e.endTag, delete e.nameNode),
      (t.type === "Block" || t.type === "ElementNode") &&
  ...
  var ys = 10;
  for (let t = 0; t <= ys; t++) Ze();
  function nr(t) {
    return Ze(t);
  }
  function Es(t, e = "type") {
    nr(t);
    function r(n) {
      let s = n[e],
        i = t[s];
    ...
    switch (n.type) {
      ...
      case "ElementNode": {
        ...
        return n.children.length === 0
          ? [b, O(L), v]
          : e.htmlWhitespaceSensitivity === "ignore"
            ? [b, O(sn(t, e, r)), be, O(L), v]
            : [b, O(B(sn(t, e, r))), O(L), v];
      }
      case "BlockStatement":
        return _s(t)
          ? [Ds(t, r), ln(t, r, e), cn(t, r, e)]
          : [Cs(t, r), B([ln(t, r, e), cn(t, r, e), Os(t, r, e)])];
      ...
      case "SubExpression":
        return B(["(", Fs(t, r), G, ")"]);
      case "AttrNode": {
        let { name: b, value: v } = n,
          L = v.type === "TextNode";
        if (L && v.chars === "" && Ee(v) === et(v)) return b;
        let T = L
            ? gt(v.chars, e.singleQuote)
      ...
      case "TextNode": {
        ...
        if (e.htmlWhitespaceSensitivity !== "ignore") {
          ...
          if (L) {
            ...
            let x = [C],
              se = Re(b);
            return se && (x = tt(se)), T && (x = x.map((ut) => Xt(ut))), x;
          }
          ...
          if (V) {
            if (!Q) {
              ne = [C];
              let x = Re(V);
              x && (ne = tt(x)), T && (ne = ne.map((se) => Xt(se)));
            }
            b = b.slice(0, -V.length);
          }
          return [...Pe, Jt(un(b)), ...ne];
        }
        let te = Re(b),
          H = Rs(b),
          $ = Hs(b);
        ...
        return (
          $ === 0 &&
            ((E = t.next) == null ? void 0 : E.type) === "MustacheStatement" &&
            (Ae = " "),
          H === 0 &&
            ((M = t.previous) == null ? void 0 : M.type) ===
              "MustacheStatement" &&
            (ve = " "),
          R && ((H = 0), (ve = "")),
          T && (($ = 0), (Ae = "")),
          Y.hasLeadingWhitespace(b) && (b = ve + Y.trimStart(b)),
          Y.hasTrailingWhitespace(b) && (b = Y.trimEnd(b) + Ae),
          [...tt(H), Jt(un(b)), ...tt($)]
        );
      }
  ...
  function vs(t, e) {
    let { node: r } = t,
      ...
      s = n.flatMap((i) => r[i]).sort(Ns);
    for (let i of n)
      t.each(({ node: a }) => {
        let o = s.indexOf(a);
        s.splice(o, 1, [C, e()]);
      }, i);
    return Xe(r.blockParams) && s.push(C, ar(r)), ["<", r.tag, O(s), As(r)];
  }
  function sn(t, e, r) {
    let { node: n } = t,
  ...
  function Cs(t, e) {
    ...
    return (
      s && n.push(B(s)),
      Xe(r.program.blockParams) && n.push(ar(r.program)),
      B([Ps(r), ir(t, e), n.length > 0 ? O([C, ye(C, n)]) : "", G, xs(r)])
    );
  }
  function Ls(t, e) {
    return [
      e.htmlWhitespaceSensitivity === "ignore" ? be : "",
      fn(t),
      "else",
      dn(t),
    ];
  ...
  function Ds(t, e) {
    ...
    return B([
      ...
      O([
        C,
        B(St(t, e)),
        ...(Xe(r.program.blockParams) ? [C, ar(r.program)] : []),
      ]),
      G,
      dn(n),
    ]);
...
`).length - 1
  ...
  function tt(t = 0) {
    return Array.from({ length: Math.min(t, pn) }).fill(be);
  }
  function qs(t, e) {
    let {
        node: { value: r },
      } = t,
      n = gt(r, Vs(t) ? !e.singleQuote : e.singleQuote);
    return [n, jt(!1, r, n, `\\${n}`), n];
  }
  function Vs(t) {
    let { ancestors: e } = t,
  ...
  var Us = new Set("!\"#%&'()*+,./;<=>@[\\]^`{|}~"),
    Ms = new Set(["true", "false", "null", "undefined"]),
    Gs = (t, e) =>
      (e !== 0 && Ms.has(t)) ||
      /\s/.test(t) ||
      /^\d/.test(t) ||
      Array.prototype.some.call(t, (r) => Us.has(r));
  function Ys(t) {
    if (t.data || (t.parts.length === 1 && t.original.includes("/")))
      return t.original;
    let { parts: e } = t;
    return (
      t.this && (e = ["this", ...e]),
      e.map((r, n) => (Gs(r, n) ? `[${r}]` : r)).join(".")
    );
  }
  var zs = {
      print: Ts,
  ...
  function rt(t, e = "unexpected empty list") {
    if (!Se(t)) throw new Error(e);
  }
  function wt(t, e = "unexpected empty list") {
    return rt(t, e), t;
  }
  function Tt(t) {
  ...
  function Js(t) {
    return (t |= 0), t < 0 ? js(t) : Qs(t);
  }
  function Zs(t) {
    return (t |= 0), t > lr.SIGN_BIT ? Xs(t) : $s(t);
  }
  [1, -1].forEach((t) => Zs(Js(t)));
  var nt = Object.assign;
  var En = console;
  function kn(t, e = "unexpected unreachable branch") {
    throw (
      (En.log("unreachable", t),
      En.log(`${e} :: ${JSON.stringify(t)} (${t})`),
      ...
      var t = function (ie, p, m, f) {
        ...
        Ht = {
          ...
          performAction: function (p, m, f, d, w, l, xe) {
            ...
            switch (w) {
              ...
              case 19:
                ...
                (Ue.chained = !0),
                  (this.$ = { strip: l[u - 2].strip, program: Ue, chain: !0 });
                break;
              case 21:
                this.$ = {
                  path: l[u - 1],
          ...
          table: [
            ...
            t(H, $),
            t(ve, [2, 80], { 53: 53 }),
            { 25: 54, 38: 56, 39: Ae, 43: 57, 44: Q, 45: 55, 47: [2, 52] },
            { 28: 60, 43: 61, 44: Q, 47: [2, 54] },
            { 13: 63, 15: r, 18: [1, 62] },
            t(R, [2, 84], { 57: 64 }),
            { 26: 65, 47: re },
            t(q, [2, 56], { 30: 67 }),
            ...
            { 55: [2, 83] },
            t(n, [2, 13]),
            { 38: 56, 39: Ae, 43: 57, 44: Q, 45: 112, 46: 111, 47: [2, 74] },
            t(q, [2, 68], { 40: 113 }),
            { 47: [2, 18] },
            t(n, [2, 14]),
            { 33: [1, 114] },
            ...
            { 33: [2, 87] },
            { 33: [1, 115] },
            { 32: 116, 33: [2, 60], 73: 117, 74: Rt },
            t(q, [2, 57]),
            t(x, [2, 59]),
            { 33: [2, 66], 37: 119, 73: 120, 74: Rt },
            t(q, [2, 63]),
            t(x, [2, 65]),
            { 23: [1, 121] },
            t(Pe, [2, 49]),
          ...
          parse: function (p) {
            ...
            for (
              var Zn = function () {
                  ...
                  return (
                    (z = A.lex() || Vr),
                    typeof z != "number" && (z = m.symbols_[z] || z),
                    z
                  );
                },
                D,
              ...
              if (
                ...
                this.defaultActions[me]
                  ? (F = this.defaultActions[me])
                  : ((D === null || typeof D > "u") && (D = Zn()),
                    (F = xe[me] && xe[me][D])),
              ...
              switch (F[0]) {
                ...
                case 2:
                  if (
                    ...
                    Jn &&
                      (Ce._$.range = [
                        l[l.length - (X || 1)].range[0],
                        l[l.length - 1].range[1],
                      ]),
                    (Mt = this.performAction.apply(
                      Ce,
                      [u, Ue, ae, de.yy, F[1], w, l].concat(Xn),
                    )),
                    typeof Mt < "u")
                  )
                    return Mt;
                  X &&
                    ...
                    (w = w.slice(0, -1 * X)),
                    (l = l.slice(0, -1 * X))),
                    f.push(this.productions_[F[1]][0]),
                    w.push(Ce.$),
                    l.push(Ce._$),
                    (Fr = xe[f[f.length - 2]][f[f.length - 1]]),
                    f.push(Fr);
                  break;
                case 3:
                  return !0;
...
` +
            ...
            next: function () {
              ...
              for (var w = this._currentRules(), l = 0; l < w.length; l++)
                if (
                  ((f = this._input.match(this.rules[w[l]])),
              ...
              return m
                ? ((p = this.test_match(m, w[d])), p !== !1 ? p : !1)
                : this._input === ""
                  ? this.EOF
                  : this.parseError(
                      "Lexical error on line " +
    ...
    for (var n = t.body, s = 0, i = n.length; s < i; s++) {
      ...
      if (o) {
        ...
        o.close && ke(n, s, !0),
          ...
          e && g && (ke((a.program || a.inverse).body), ce(n, s)),
          e && E && (ke(n, s), ce((a.inverse || a.program).body));
      }
    }
    return t;
  };
    ...
    K.prototype.PartialBlockStatement =
      function (t) {
        ...
        var i = {
          ...
          openStandalone: pr(e.body),
          closeStandalone: hr((n || e).body),
        };
      ...
      return (
        (t.prototype.parse = function (e) {
          if (e) {
            ...
            if (((r = e.match(pi)), r)) return this.named[r[1]];
          }
        }),
        t
      );
...
`
      ...
      return (
        ...
        (t.prototype.tokenizePart = function (e) {
          for (this.input += gi(e); this.index < this.input.length; ) {
...
`
    ...
    zo = (function () {
      function t(e, r) {
        r === void 0 && (r = {}),
          ...
          (this.startColumn = 0),
          (this.tokens = []),
          (this.tokenizer = new br(this, e, r.mode)),
  ...
  var Ko = Cn(yr.FlushElement);
  var jo = Cn(yr.GetSymbol);
  var bi = /["&\xA0]/u,
    sl = new RegExp(bi.source, "gu"),
    yi = /[&<>\xA0]/u,
    il = new RegExp(yi.source, "gu");
  var Ln = new Set([
    "area",
    "base",
    "br",
  ...
  var he = Object.freeze({ line: 1, column: 0 }),
    Ei = Object.freeze({ source: "(synthetic)", start: he, end: he }),
    Dt = Object.freeze({ source: "(nonexistent)", start: he, end: he }),
    ue = Object.freeze({ source: "(broken)", start: he, end: he }),
    y = (function (t) {
      return (
  ...
  var Pr = class t {
    ...
    I = class t {
      ...
      constructor(e) {
        (this.data = e),
          (this.isInvisible =
            e.kind !== y.CharPosition && e.kind !== y.HbsPosition);
      }
      getStart() {
      ...
      toSlice(e) {
        ...
        return (
          !1 &&
            ...
            r !== e &&
            console.warn(
              `unexpectedly found ${JSON.stringify(r)} when slicing source, but expected ${JSON.stringify(e)}`,
            ),
          new Pr({ loc: this, chars: e || r })
        );
      }
      get start() {
        return this.loc.start;
    ...
    ot = class {
      ...
      locDidUpdate({ start: e, end: r }) {
        e !== void 0 &&
          ...
          (this.hbsPositions.start = new fe(this.source, e, null))),
          r !== void 0 &&
            (this.updateProvided(r, "end"),
            (this.hbsPositions.end = new fe(this.source, r, null)));
      }
      asString() {
        let e = this.toCharPosSpan();
    ...
    j = Rn((t) =>
      t
        .when(y.HbsPosition, y.HbsPosition, (e, r) =>
          new ot(e.source, { start: e, end: r }).wrap(),
        )
        .when(y.CharPosition, y.CharPosition, (e, r) =>
          new at(e.source, { start: e, end: r }).wrap(),
        )
        .when(y.CharPosition, y.HbsPosition, (e, r) => {
          let n = r.toCharPos();
        ...
        .when(Nr, it, (e) => new ee(e.kind, ue).wrap())
        .when(it, Nr, (e, r) => new ee(r.kind, ue).wrap()),
    ),
    pe = "BROKEN",
    qe = class t {
    ...
    Te = class {
      ...
      toHbsPos() {
        ...
        if (e === null) {
          ...
          r === null
            ? (this._locPos = e = pe)
            : (this._locPos = e = new fe(this.source, r, this.charPos));
        }
        return e === pe ? null : e;
      }
    },
    fe = class {
      ...
      constructor(e, r, n = null) {
        (this.source = e),
          (this.hbsPos = r),
          (this._charPos = n === null ? null : new Te(e, n));
      }
      toCharPos() {
        let e = this._charPos;
        if (e === null) {
          ...
          r === null
            ? (this._charPos = e = pe)
            : (this._charPos = e = new Te(this.source, r));
        }
        return e === pe ? null : e;
      }
      toJSON() {
    ...
    ki = Rn((t) =>
      t
        ...
        .when(y.CharPosition, y.HbsPosition, ({ offset: e }, r) => {
          var n;
...
`,
          ...
          if ((c === -1 && (c = this.source.length), a === r - 1)) {
            if (o + n > c) return c;
            if (!1) {
              let h = this.hbsPosFor(o + n);
              P(h !== null, "the returned offset failed to round-trip"),
                P(
                  h.line === r,
...
`
  ...
  function xi(t, e, r, n) {
    ...
    if (Array.isArray(n))
      if (n.length === 1) On(t, e, n[0]);
      else throw n.length === 0 ? _n(r, t, e) : Ti(r, t, e);
    else On(t, e, n);
  }
  function Ci(t, e, r) {
    return r === null
  ...
  function Oi(t, e) {
    ...
    for (let a of e.program.blockParamNodes) {
      let c = new RegExp(`\\b${a.value}\\b`).exec(n),
        h = [s + c.index, 0];
      (h[1] = h[0] + a.value.length),
        (a.loc = t.spanFor({
  ...
  function Ii(t) {
    ...
    if (n !== -1 && e > n && Z(r[n + 1]).charAt(0) === "|") {
      ...
      if (
        s.charAt(s.length - 1) !== "|" ||
        or(s.match(/\|/gu), "block params must exist here").length !== 2
      )
        throw S("Invalid block parameters syntax, '" + s + "'", t.loc);
      let i = [];
      for (let a = n + 1; a < e; a++) {
        ...
        if (o !== "") {
          if (_i.test(o))
            throw S(
              "Invalid identifier for block parameters, '" + o + "'",
              t.loc,
            );
          let c = t.attributes[a].loc;
          r[a].startsWith("|") && (c = c.slice({ skipStart: 1 })),
            r[a].endsWith("|") && (c = c.slice({ skipEnd: 1 })),
            c.endPosition.column - c.startPosition.column > o.length &&
              (c = c.slice({
                skipEnd:
                  c.endPosition.column - c.startPosition.column - o.length,
              })),
            i.push({ type: "BlockParam", value: o, loc: c });
        }
      }
  ...
  var Er;
  function Sr() {
    return Er || (Er = new we("", "(synthetic)")), Er;
  }
  function qi(t, e, r, n, s, i) {
    return (
  ...
  function Vi(t, e, r, n, s, i, a, o, c) {
    let h, g;
    return (
      n.type === "Template" ? (h = nt({}, n, { type: "Block" })) : (h = n),
      s != null && s.type === "Template"
        ? (g = nt({}, s, { type: "Block" }))
        : (g = s),
      {
        type: "BlockStatement",
  ...
  function Mi(t, e) {
    return { type: "CommentStatement", value: t, loc: k(e || null) };
  }
  function Gi(t, e) {
    return { type: "MustacheCommentStatement", value: t, loc: k(e || null) };
  }
  function Yi(t, e) {
    if (!Se(t)) throw new Error("b.concat requires at least one part");
    return { type: "ConcatStatement", parts: t || [], loc: k(e || null) };
  }
  function zi(t, e = {}) {
    let {
        attrs: r,
    ...
    return (
          ...
          : (c = t),
      {
        type: "ElementNode",
        tag: c,
        nameNode: { type: "ElementNameNode", value: t },
        startTag: { type: "ElementStartNode", value: t },
        endTag: { type: "ElementEndNode", value: h ? "" : t },
        parts: c.split(".").map((g) => ({ type: "ElementPartNode", value: g })),
        selfClosing: h,
        attributes: r || [],
        blockParams: n || [],
        blockParamNodes:
          (n == null
            ? void 0
            : n.map((g) => ({ type: "BlockParam", value: g }))) || [],
        modifiers: s || [],
        comments: i || [],
        children: a || [],
        loc: k(o || null),
  ...
  function Wi(t, e, r) {
    return { type: "AttrNode", name: t, value: e, loc: k(r || null) };
  }
  function Ki(t, e) {
    return { type: "TextNode", chars: t || "", loc: k(e || null) };
  }
  function ji(t, e, r, n) {
    return {
      type: "SubExpression",
  ...
  function Bn(t, e) {
    ...
    return (
      r === "this"
        ? (s = { type: "ThisHead", loc: k(e || null) })
        : r[0] === "@"
          ? (s = { type: "AtHead", name: r, loc: k(e || null) })
          : (s = { type: "VarHead", name: r, loc: k(e || null) }),
      { head: s, tail: n }
    );
  }
  function Mn(t) {
    return { type: "ThisHead", loc: k(t || null) };
  }
  function Gn(t, e) {
    return (
      P(t[0] === "@", "call builders.at() with a string that starts with '@'"),
      { type: "AtHead", name: t, loc: k(e || null) }
    );
  }
  function Yn(t, e) {
    return (
      ...
      P(
        t[0] !== "@",
        `You called builders.var() with '${t}'. Call builders.at('${t}') instead`,
      ),
      { type: "VarHead", name: t, loc: k(e || null) }
    );
  }
  function $i(t, e) {
  ...
  function Qi(t, e) {
    return { type: "NamedBlockName", name: t, loc: k(e || null) };
  }
  function Xi(t, e, r) {
    let { original: n, parts: s } = Un(t),
      i = [...s, ...e],
      a = [...n, ...i].join(".");
  ...
  function ct(t, e) {
    if (typeof t != "string") {
      ...
      {
        let { head: s, tail: i } = Bn(t.head, I.broken());
        P(
          i.length === 0,
    ...
    let { head: r, tail: n } = Bn(t, I.broken());
    return new Ne(t, r, n, k(e || null));
  }
  function _t(t, e, r) {
    return { type: t, value: e, original: e, loc: k(r || null) };
  }
  function Fe(t, e) {
    return { type: "Hash", pairs: t || [], loc: k(e || null) };
  }
  function Ji(t, e, r) {
    return { type: "HashPair", key: t, value: e, loc: k(r || null) };
  }
  function Zi(t, e, r) {
    return {
      type: "Template",
  ...
  function ea(t, e, r = !1, n) {
    return {
      ...
      blockParamNodes:
        (e == null
          ? void 0
          : e.map((s) => ({ type: "BlockParam", value: s }))) || [],
      chained: r,
      loc: k(n || null),
    };
  }
  ...
  var na = {
    ...
    this: Mn,
    blockName: Qi,
    string: kr("StringLiteral"),
    boolean: kr("BooleanLiteral"),
    number: kr("NumberLiteral"),
    undefined() {
  ...
  var Ne = class {
      ...
      constructor(e, r, n, s) {
        ...
        r.type === "ThisHead"
          ? (this.this = !0)
          : r.type === "AtHead"
            ? ((this.data = !0), i.unshift(r.name.slice(1)))
            : i.unshift(r.name),
          (this.parts = i);
      }
      _head = void 0;
      get head() {
        ...
        this.this
          ...
          : this.data
            ? (e = `@${Nt(wt(this.parts))}`)
            : (rt(this.parts), (e = Nt(this.parts)));
        let r = this.loc
          .collapse("start")
          .sliceStartChars({ chars: e.length }).loc;
        return (this._head = na.head(e, r));
      }
      get tail() {
    ...
    Cr = class {
      ...
      blockItself({
        ...
        return {
          ...
          blockParamNodes:
            r == null
              ? void 0
              : r.map((i) => ({ type: "BlockParam", value: i })),
          chained: n,
          loc: s,
        };
      }
      ...
      element({
        ...
        return {
          type: "ElementNode",
          tag: e,
          nameNode: { type: "ElementNameNode", value: e },
          startTag: { type: "ElementStartNode", value: e },
          endTag: { type: "ElementEndNode", value: r ? "" : e },
          parts: e
            .split(".")
            .map((h) => ({ type: "ElementPartNode", value: h })),
          selfClosing: r,
          attributes: n || [],
          blockParams: s,
          blockParamNodes:
            s.map((h) => ({ type: "BlockParam", value: h })) || [],
          modifiers: i || [],
          comments: a || [],
          children: o || [],
          loc: c,
  ...
  var N = new Cr(),
    Lr = class {
      ...
      currentNode = null;
      tokenizer;
      constructor(e, r = new gr(xn), n = "precompile") {
        (this.source = e),
          (this.lines = e.source.split(/\r\n?|\n/u)),
          (this.tokenizer = new br(this, r, n));
      }
      offset() {
      ...
      get currentAttr() {
        return or(this.currentAttribute, "expected attribute");
      }
      get currentTag() {
...
`);
    ...
    _r = class extends Lr {
      ...
      BlockStatement(e) {
        ...
        e.program.loc || (e.program.loc = Dt),
          e.inverse && !e.inverse.loc && (e.inverse.loc = Dt);
      ...
      MustacheStatement(e) {
        ...
        if (Fn(e.path))
          ...
          let { path: o, params: c, hash: h } = wr(this, e);
          n = N.mustache({
            path: o,
            params: c,
            hash: h,
        ...
        switch (r.state) {
          ...
          case "afterAttributeValueQuoted":
            Tr(this.currentStartTag, n), r.transitionTo(In);
            break;
...
`).length - 1,
  ...
  function wr(t, e) {
          ...
          : a.type === "StringLiteral"
            ...
            : a.type === "NullLiteral"
              ...
              : a.type === "NumberLiteral"
                ...
                : (o = "undefined"),
        S(
          `${a.type} "${a.type === "StringLiteral" ? a.original : o}" cannot be called as a sub-expression, replace (${o}) with ${o}`,
    ...
    let r =
      ...
      i = e.hash
        ? t.Hash(e.hash)
        : { type: "Hash", pairs: [], loc: t.source.spanFor(s).collapse("end") };
  ...
  var Dr = class extends _r {
      ...
      finishData() {
        (this.currentData.loc = this.currentData.loc.withEnd(this.offset())),
          He(this.currentElement(), this.currentData);
      }
      tagOpen() {
      ...
      finishStartTag() {
        ...
        (o.startTag = { type: "ElementStartNode", value: e, loc: a }),
          (o.nameNode = {
            type: "ElementNameNode",
            value: e,
            loc: a
              .withStart(
                this.source.offsetFor(
                  a.startPosition.line,
                  a.startPosition.column + 1,
                ),
              )
              .withEnd(
                this.source.offsetFor(
                  a.startPosition.line,
                  a.startPosition.column + 1 + e.length,
                ),
              ),
          }),
          Bi(this.source, o),
      ...
      finishEndTag(e) {
        ...
        (n.loc = n.loc.withEnd(this.offset())), Di(n), He(s, n);
      }
...
`
            ...
            : (i = i.move(-1)),
            (this.currentAttr.currentPart = N.text({
              chars: e,
              loc: i.collapsed(),
            }));
        }
      ...
      assembleAttributeValue(e, r, n, s) {
        ...
        } else return Se(e) ? e[0] : N.text({ chars: "", loc: s });
      }
    },
    la = {},
    Or = class extends gr {
  ...
  function zn(t, e = {}) {
    ...
    let r = e.mode || "precompile",
      ...
      s;
    typeof t == "string"
      ? ((n = new we(t, (c = e.meta) == null ? void 0 : c.moduleName)),
        r === "codemod"
          ? (s = Ct(t, e.parseOptions))
          : (s = mr(t, e.parseOptions)))
      : t instanceof we
        ? ((n = t),
          r === "codemod"
            ? (s = Ct(t.source, e.parseOptions))
            : (s = mr(t.source, e.parseOptions)))
        : ((n = new we("", (h = e.meta) == null ? void 0 : h.moduleName)),
          (s = t));
    let i;
    r === "codemod" && (i = new Or());
    let a = I.forCharPositions(n, 0, n.source.length);
    s.loc = { source: "(program)", start: a.startPosition, end: a.endPosition };
    let o = new Dr(n, i, r).acceptTemplate(s);
    if (
      (e.strictMode && (o.blockParams = e.locals ?? []),
      e && e.plugins && e.plugins.ast)
    )
      for (let g of e.plugins.ast) {
        let E = nt({}, e, { syntax: la }, { plugins: void 0 }),
          M = g(E);
        Li(o, M.visitor);
      }
    return o;
...
`,
  ...
  function pa(t) {
    let e;
    try {
      e = zn(t, { mode: "codemod", plugins: { ast: [ha(t)] } });
    } catch (r) {
      let n = da(r);
      if (n) {
        let s = fa(r);
...
`);
  ...
  var ma = { parse: pa, astFormat: "glimmer", locStart: Ee, locEnd: et };
  var ga = { glimmer: bn };
  return ss(ba);
});
