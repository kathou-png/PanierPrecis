(function (f) {
  ...
  var ue = (t, e, s) => (
    ...
    hl = (t) => en(bt({}, "__esModule", { value: !0 }), t);
  var On = y((pe) => {
    "use strict";
...
`;
      ...
      let s = "";
      for (; s !== t; ) (s = t), (t = t.replace(Ul, `${e}$1 $2${e}`));
...
`
  ...
  var ne = y((yv, Li) => {
    ...
    function Ii(t) {
      return t.map(
        (e) => (e.nodes && (e.nodes = Ii(e.nodes)), delete e.source, e),
      );
    }
    function qi(t) {
    ...
    var z = class t extends bc {
      ...
      normalize(e, s) {
        if (typeof e == "string") e = Ii(Pi(e).nodes);
        ...
        : t.type === "rule"
          ...
          : t.type === "decl"
            ...
            : t.type === "comment"
              ...
              : t.type === "root" && Object.setPrototypeOf(t, Ri.prototype),
        (t[Ai] = !0),
        t.nodes &&
          t.nodes.forEach((e) => {
            z.rebuild(e);
      ...
      function F($) {
        ...
        switch (((i = r.charCodeAt(d)), i)) {
          ...
          case 64: {
            (Gt.lastIndex = d + 1),
              Gt.test(r),
              Gt.lastIndex === 0 ? (o = r.length - 1) : (o = Gt.lastIndex - 2),
...
`,
      ...
      decl(e, s) {
        ...
        for (
          n[0] === ";" && ((this.semicolon = !0), e.pop()),
            r.source.end = this.getPosition(n[3] || n[2] || Nc(e)),
            r.source.end.offset++;
          e[0][0] !== "word";
  ...
  var qe = y((Av, so) => {
    "use strict";
    var { SourceMapConsumer: qc, SourceMapGenerator: Lc } = ji(),
      { fileURLToPath: eo, pathToFileURL: Xt } = {},
      ...
      Ie = class {
        constructor(e, s = {}) {
          ...
          this.file || (this.id = "<input css " + Dc(6) + ">"),
        ...
        error(e, s, r, n = {}) {
          ...
          return (
            ...
            this.file &&
              (Xt && (i.input.url = Xt(this.file).toString()),
...
`),
          ...
          return (
            ...
            n && ((this.input = new zc(n)), (this.tokenizer = Wc(this.input))),
            !0
          );
        } else if (t[1] === "/") {
  ...
  var vo = y((Dv, wo) => {
    ...
    wo.exports = class extends jc {
      ...
      atrule(e) {
        go.bind(this)(e) ||
          (super.atrule(e), Zc(this.lastNode), ef(this.lastNode));
      }
      decl(...e) {
        super.decl(...e),
      ...
      rule(e) {
        ...
        if (
          r[0] === "at-word" &&
          s[0] === "{" &&
          (this.tokenizer.back(s), go.bind(this)(r))
        ) {
  ...
  var xs = y((zv, Ao) => {
    ...
    Ao.exports = function (e) {
      Co[e] ||
        ((Co[e] = !0), typeof console < "u" && console.warn && console.warn(e));
    };
  });
  var _s = y((Yv, Oo) => {
    "use strict";
  ...
  var Es = y((Hv, qo) => {
    ...
    var { isClean: H, my: lf } = Wt(),
      ...
      wf = { Once: !0, postcssPlugin: !0, prepare: !0 },
      Le = 0;
    function yt(t) {
    ...
    var ks = {},
      oe = class t {
        constructor(e, s, r) {
          ...
          (this.result = new Po(e, n, r)),
            (this.helpers = { ...ks, postcss: ks, result: this.result }),
        ...
        visitTick(e) {
          ...
          for (; s.eventIndex < i.length; ) {
            ...
            if (((s.eventIndex += 1), o === Le)) {
              r.nodes &&
                r.nodes.length &&
                ((r[H] = !0), (s.iterator = r.getIterator()));
              return;
    ...
    var vf = vs(),
      ...
      gt = class {
        constructor(e, s, r) {
          ...
          let n,
            i = xf;
          (this.result = new bf(this._processor, n, this._opts)),
            (this.result.css = s);
          let o = this;
...
`)
        ...
        n
          ...
          n &&
            ...
            i.type === "media-feature-expression" &&
              (i.nodes = aa(i.value, i.sourceIndex)),
            s.push(
              Array.isArray(i.nodes) ? new Rs.default(i) : new ia.default(i),
            ),
            (i = o()),
            (n = !1));
      }
  ...
  var D = y((B) => {
    ...
    var dx = (B.TAG = "tag"),
      mx = (B.STRING = "string"),
      yx = (B.SELECTOR = "selector"),
      gx = (B.ROOT = "root"),
      wx = (B.PSEUDO = "pseudo"),
      vx = (B.NESTING = "nesting"),
      xx = (B.ID = "id"),
      _x = (B.COMMENT = "comment"),
      bx = (B.COMBINATOR = "combinator"),
      kx = (B.CLASS = "class"),
      Ex = (B.ATTRIBUTE = "attribute"),
      Sx = (B.UNIVERSAL = "universal");
  });
  var ur = y((ar, ga) => {
    "use strict";
    ar.__esModule = !0;
    ...
    function Dd(t) {
      for (
        ...
        switch (((r = s.charCodeAt(m)), r === _t && ((h = m), (d += 1)), r)) {
          ...
          case $s:
            n = m;
            do (n += 1), (r = s.charCodeAt(n)), r === _t && ((h = n), (d += 1));
    ...
    var vm = (function () {
      function t(e) {
        ...
        return (
          ...
          (this.current = s),
          this.lossy
            ? (this.tokens = (0, eu.default)({
                safe: e.safe,
                css: e.css.trim(),
              }))
            : (this.tokens = (0, eu.default)(e)),
          this.loop()
        );
      }
      return (
        ...
        (t.prototype.splitWord = function (s, r) {
          ...
          var l = (0, hm.default)(
            (0, Wd.default)((0, Ud.default)([[0], c, f])),
          );
...
`)),
                (h = x.length - 1),
                h > 0
                  ? ((_ = a + h), (w = l - x[h].length))
                  : ((_ = a), (w = o)),
                r.push(["comment", d, a, u - o, _, l - w, u]),
                (o = w),
                (a = _),
                (u = l);
  ...
  var Ue = "string",
    ...
    Ge = "label",
    ke = "break-parent",
    kt = new Set([$e, xe, _e, We, be, ee, le, ze, Ye, Ve, Q, Ge, ke]);
  function ml(t) {
...
Expected it to be ${r}.`;
  ...
  function rn(t, e) {
    return ce(e), { type: _e, contents: e, n: t };
  }
  function L(t, e = {}) {
    return (
      ce(t),
  ...
  function Ke(t) {
    return Et(t), { type: ee, parts: t };
  }
  function St(t, e = "", s = {}) {
    return (
      ce(t),
      e !== "" && ce(e),
      { type: le, breakContents: t, flatContents: e, groupId: s.groupId }
    );
  }
  var Qe = { type: ke };
  var wl = { type: Q, hard: !0 };
  var O = { type: Q },
    M = { type: Q, soft: !0 },
    k = [wl, Qe];
  function V(t, e) {
  ...
  var nn = (t) => {
    ...
    if (t.type !== ee) throw new Error(`Expect doc to be 'array' or '${ee}'.`);
    return t.parts;
  };
  function xl(t, e) {
  ...
  function fn(t, e, s) {
    if (
      (Ee(t) && t.lang === "yaml" && delete e.value,
      t.type === "css-comment" &&
        s.type === "css-root" &&
        s.nodes.length > 0 &&
        (((s.nodes[0] === t || (Ee(s.nodes[0]) && s.nodes[1] === t)) &&
    ...
    if (
      ...
      t.type === "value-unknown" && (e.value = E(!1, e.value, /;$/g, "")),
      (t.type === "media-feature" ||
      ...
      (t.type === "media-value" ||
        ...
        t.type === "selector-tag") &&
        e.value &&
        (e.value = E(!1, e.value, /([\d+.e-]+)([a-z]*)/gi, (r, n, i) => {
          let o = Number(n);
  ...
  function Je(t) {
    if (je !== null && typeof je.property) {
      let e = je;
      return (je = Je.prototype = null), e;
    }
    return (je = Je.prototype = t ?? Object.create(null)), new Je();
  }
  var Nl = 10;
  for (let t = 0; t <= Nl; t++) Je();
  function Vr(t) {
    return Je(t);
  }
...
`,
  ...
  function Hr(t, e) {
    ...
    if (t.type === "css-comment" && t.inline)
      return Nt(e, t.source.startOffset);
    if (
  ...
  function Kr(t, e) {
    t.source &&
      ((t.source.startOffset = xn(t, e)), (t.source.endOffset = Hr(t, e)));
    for (let s in t) {
      let r = t[s];
      s === "source" ||
        !r ||
        ...
        (r.type === "value-root" || r.type === "value-unknown"
          ? _n(r, Ll(t), r.text || r.value)
          : Kr(r, e));
    }
  }
  function _n(t, e, s) {
    t.source &&
      ((t.source.startOffset = xn(t, s) + e),
      (t.source.endOffset = Hr(t, s) + e));
    for (let r in t) {
      let n = t[r];
...
`);
  ...
  function Pn(t) {
    ...
    let s = (0, re.extract)(t),
      { pragmas: r, comments: n } = (0, re.parseWithComments)(s);
  ...
  function In(t) {
    let { shebang: e, text: s, pragmas: r, comments: n } = Pn(t),
      i = (0, re.strip)(s),
      o = (0, re.print)({
        pragmas: { format: "", ...r },
...
`
  ...
  function It(t) {
    return Rt(t) || Ze(t) || j(t) || he(t) || jl(t);
  }
  function Hn(t) {
  ...
  function Jl(t, e, s) {
    ...
    for (let m = 0; m < r.groups.length; ++m) {
      ...
      if (
        (((F && Dt(v)) || (K && Mt(w))) && de(v)) ||
        (!_ && Ze(w)) ||
        (Se(t, "calc") && (j(w) || j(v) || he(w) || he(v)) && de(v))
      )
        continue;
      let $ =
          (j(w) || he(w)) &&
        ...
        C =
          v.type === "value-func" ||
          tt(v) ||
          (_ == null ? void 0 : _.type) === "value-func" ||
          (_ && tt(_));
      if (
        e.parser === "scss" &&
        F &&
  ...
  var oi = /(["'])(?:(?!\1)[^\\]|\\.)*\1/gs,
    ...
    tc = /[$@]?[_a-z\u0080-\uFFFF][\w\u0080-\uFFFF-]*/gi,
    rc = new RegExp(
      oi.source + `|(${tc.source})?(${Zl.source})(${ec.source})?`,
      "gi",
    );
  function W(t, e) {
    return E(!1, t, oi, (s) => Ct(s, e));
  }
  function ai(t, e) {
    let s = e.singleQuote ? "'" : '"';
...
` ||
  ...
  function ac(t, e) {
    let s = null,
      r = e;
    for (; r !== s; ) (s = r), (r = vn(t, r)), (r = li(t, r)), (r = Ot(t, r));
    return (r = ci(t, r)), (r = Ut(t, r)), r !== !1 && Ft(t, r);
  }
  var $t = ac;
  ...
  function lc(t, e) {
    return Wn(t.grandparent) && uc(t, e)
      ? ","
  ...
  function fi(t, e, s) {
    ...
    let o = t.map(({ node: g, isLast: x, index: h }) => {
        ...
        if (
          ...
          ((_ = g.groups[2]) == null ? void 0 : _.type) === "value-paren_group"
        ) {
        ...
        if (!x && g.type === "value-comma_group" && te(g.groups)) {
          ...
          !w.source && w.close && (w = w.close),
            w.source && $t(e.originalText, P(w)) && m.push(k);
        }
        return m;
      }, "groups"),
      a = Zn(r, n),
  ...
  function cc(t, e, s) {
    ...
    return (
      t.each(() => {
        ...
        let { next: o } = t;
        (o.type === "css-comment" &&
          !Ft(e.originalText, N(o), { backwards: !0 }) &&
          !Ee(n)) ||
        (o.type === "css-atrule" &&
          o.name === "else" &&
          n.type !== "css-comment")
          ? r.push(" ")
          : (r.push(e.__isHTMLStyleAttribute ? O : k),
            $t(e.originalText, P(n)) && !Ee(n) && r.push(k));
      }, "nodes"),
      r
    );
  }
  ...
  function fc(t, e, s) {
    ...
    switch (r.type) {
      ...
      case "css-decl": {
        ...
        return (
          ...
          !g &&
            ...
            (h = q([k, fe(h)])),
          [
            E(!1, r.raws.before, /[\s;]/g, ""),
            (f.type === "css-atrule" && f.variable) || Un(t)
              ? r.prop
              : se(r.prop),
            l.startsWith("//") ? " " : "",
            l,
            ...
            r.nodes
              ? [" {", q([M, Ae(t, e, s)]), M, "}"]
              : Qn(r) && !f.raws.semicolon && e.originalText[P(r) - 1] !== ";"
                ? ""
      ...
      case "css-atrule": {
        let f = t.parent,
          p = qt(r) && !f.raws.semicolon && e.originalText[P(r) - 1] !== ";";
        if (e.parser === "less") {
          if (r.mixin)
            return [
              s("selector"),
          ...
          if (r.variable)
            return [
              ...
              r.nodes
                ? ["{", q([r.nodes.length > 0 ? M : "", Ae(t, e, s)]), M, "}"]
                : "",
              p ? "" : ";",
            ];
        }
        ...
        return [
          "@",
          jr(r) || r.name.endsWith(":") || qt(r) ? r.name : se(r.name),
          r.params
            ? [
                jr(r)
                  ? ""
      ...
      case "media-url":
        return W(
          E(!1, E(!1, r.value, /^url\(\s+/gi, "url("), /\s+\)$/g, ")"),
          e,
        );
      case "media-unknown":
        return r.value;
      case "selector-root":
        return L([
          Te(t, "custom-selector")
            ? [t.findAncestor((f) => f.type === "css-atrule").customSelector, O]
            : "",
          V(
            [",", Te(t, ["extend", "custom-selector", "nest"]) ? O : k],
            t.map(s, "nodes"),
          ),
        ]);
      ...
      case "selector-tag":
        return [
          ...
          ((u = t.previous) == null ? void 0 : u.type) === "selector-nesting"
            ? r.value
            : me(Bn(t, r.value) ? r.value.toLowerCase() : r.value),
        ];
      case "selector-id":
        return ["#", r.value];
      case "selector-class":
      ...
      case "selector-combinator": {
        if (
          ...
          let l = t.parent;
          return [
            l.type === "selector-selector" && l.nodes[0] === r ? "" : O,
            r.value,
            Pt(t, r) ? "" : " ",
          ];
        }
      ...
      case "value-operator":
        return r.value;
      case "value-word":
        return (r.isColor && r.isHex) || Mn(r.value)
          ? r.value.toLowerCase()
          : r.value;
      case "value-colon": {
        let { previous: f } = t;
  ...
  var hc = { singleQuote: di.singleQuote },
    mi = hc;
  var Js = {};
  Zs(Js, { css: () => Ty, less: () => Cy, scss: () => Ay });
  var tl = ue(ht(), 1),
    rl = ue(bo(), 1),
    sl = ue(ra(), 1);
  function Zf(t, e) {
  ...
  function Xu(t, e) {
    if (t && typeof t == "object")
      for (let s in t)
        s !== "parent" &&
          (Xu(t[s], e),
          s === "nodes" && ((t.group = $r(vy(t, e))), delete t[s]));
    return t;
  }
  function xy(t, e) {
    ...
    if (t && typeof t == "object") {
      ...
      if (
        ...
        return n.startsWith("@") && n.endsWith(":")
          ...
          : t.mixin
            ? ((t.selector = ae(n, e)), t)
            : (el(t, e) && (t.isSCSSNesterProperty = !0),
              (t.selector = Z(n)),
              t);
      if (i.length > 0) {
        let a = i.match(Ey);
  ...
  var js = { astFormat: "postcss", hasPragma: qn, locStart: N, locEnd: P },
    Ty = { ...js, parse: il },
    Cy = { ...js, parse: ol },
    Ay = { ...js, parse: al };
  var Oy = { postcss: pi };
