(function (f) {
  ...
  var Lt = (a, t) => () => (
    ...
    Qs = (a, t) => {
      for (var e in t) we(a, e, { get: t[e], enumerable: !0 });
    },
    Dt = (a, t, e, s) => {
  ...
  var Ve = (a, t, e) => (
      ...
      Dt(
        t || !a || !a.__esModule
          ? we(e, "default", { value: a, enumerable: !0 })
          : e,
        a,
      )
    ),
    Zs = (a) => Dt(we({}, "__esModule", { value: !0 }), a);
  var wt = Lt((Pe) => {
    "use strict";
    ...
    var Mt = "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED",
      ...
      Ie = ({ type: a, prefix: t }) =>
        a === "UpdateExpression" ? Ot.UpdateExpression[String(t)] : Ot[a],
      ti = {
...
- Did you mean \`import { "${a}" as foo }\`?`,
        ...
        InvalidLhsBinding: ({ ancestor: a }) =>
          `Binding invalid left-hand side in ${Ie(a)}.`,
        InvalidLhsOptionalChaining: ({ ancestor: a }) =>
          `Invalid optional chaining in the left-hand side of ${Ie(a)}.`,
      ...
      ri = {
        ...
        PipeUnparenthesizedBody: ({ type: a }) =>
          `Hack-style pipe body cannot be an unparenthesized ${Ie({ type: a })}; please wrap it in parentheses.`,
        PipelineBodyNoArrow:
    ...
    function he(a) {
      return (
        a.loc.start && Bt(a.loc.start, "index"),
        a.loc.end && Bt(a.loc.end, "index"),
        a
      );
    }
    var li = (a) =>
    ...
    function P(a, t = {}) {
      ...
      return (
        ++fe,
        mt.push(a),
        yt.push((e = t.binop) != null ? e : -1),
        xt.push((s = t.beforeExpr) != null ? s : !1),
        Pt.push((i = t.startsExpr) != null ? i : !1),
        gt.push((r = t.prefix) != null ? r : !1),
        U.push(new Le(a, t)),
        fe
      );
    }
    ...
    var pi = {
      ...
      eq: P("=", { beforeExpr: b, isAssign: le }),
      assign: P("_=", { beforeExpr: b, isAssign: le }),
      slashAssign: P("_=", { beforeExpr: b, isAssign: le }),
      xorAssign: P("_=", { beforeExpr: b, isAssign: le }),
      moduloAssign: P("_=", { beforeExpr: b, isAssign: le }),
      ...
      _do: A("do", { isLoop: qe, beforeExpr: b }),
      _for: A("for", { isLoop: qe }),
        ...
        finalizeComment(t) {
          ...
          if (t.leadingNode !== null || t.trailingNode !== null)
            t.leadingNode !== null && is(t.leadingNode, e),
              t.trailingNode !== null && Di(t.trailingNode, e);
          else {
...
`);
    ...
    function tt(a, t, e, s, i, r, n, o) {
      let h = t,
        l;
      return (
        ({ n: l, pos: t } = as(a, t, e, s, 16, i, r, !1, o, !n)),
    ...
    function as(a, t, e, s, i, r, n, o, h, l) {
      let c = t,
        ...
        f = i === 16 ? Ee.hex : i === 10 ? Ee.dec : i === 8 ? Ee.oct : Ee.bin,
        d = !1,
        y = 0;
    ...
    var Ri = new Set([103, 109, 115, 105, 121, 117, 100, 118]),
      ...
      st = class extends Ze {
        ...
        skipBlockComment(t) {
          ...
          for (
            this.state.pos = i + t.length, Ce.lastIndex = s + 2;
            Ce.test(this.input) && Ce.lastIndex <= i;
        ...
        readNumber(t) {
          ...
          if (
            ...
            c === 109 &&
              ...
              (o || l) && this.raise(p.InvalidDecimal, s),
              ++this.state.pos,
              (n = !0)),
          ...
          flowParseDeclareExportDeclaration(e, s) {
            ...
            if (
              ...
              throw this.raise(
                ...
                this.state.startLoc,
                { unsupportedExportKind: i, suggestion: Ki[i] },
              );
            }
            if (
              this.match(74) ||
          ...
          flowParseObjectType({
            ...
            for (
              ...
              if (this.eat(0))
                ...
                let Se = this.flowParseObjectTypeProperty(
                  C,
                  d,
                  y,
                  E,
                ...
                Se === null
                  ...
                  : h.properties.push(Se);
              }
              this.flowObjectTypeSemicolon(),
                I &&
                  !this.match(8) &&
                  !this.match(9) &&
                  this.raise(g.UnexpectedExplicitInexactInObject, I);
            }
...
`))
      ...
      pt = class extends ht {
        ...
        checkLVal(
          ...
          let [u, f] = Array.isArray(c)
              ? c
              : [c, h === "ParenthesizedExpression"],
      ...
      class extends a {
        ...
        tsParseModifiers(
          ...
          let o = (l, c, u, f) => {
              c === u &&
                n[f] &&
                this.raise(x.InvalidModifiersOrder, l, {
                  orderedModifiers: [u, f],
                });
            },
            h = (l, c, u, f) => {
              ((n[u] && c === f) || (n[f] && c === u)) &&
                this.raise(x.IncompatibleModifiers, l, { modifiers: [u, f] });
            };
          for (;;) {
            ...
            qt(c)
              ? n.accessibility
                ? this.raise(x.DuplicateAccessibilityModifier, l, {
                    modifier: c,
                  })
                : (o(l, c, c, "override"),
                  o(l, c, c, "static"),
                  ...
                  (n.accessibility = c))
              : er(c)
                ? (n[c] && this.raise(x.DuplicateModifier, l, { modifier: c }),
                  (n[c] = !0),
                  o(l, c, "in", "out"))
                : (Object.hasOwnProperty.call(n, c)
                    ? this.raise(x.DuplicateModifier, l, { modifier: c })
            ...
            let o,
              h = this.tsTryParseAndCatch(() => {
                ...
                if (
                  c === 48 ||
                  c === 52 ||
                  (c !== 10 && Je(c) && !this.hasPrecedingLineBreak())
                )
                  return;
        ...
        pushClassMethod(e, s, i, r, n, o) {
          ...
          l &&
            (c === "get" || c === "set") &&
            this.raise(x.DeclareAccessor, s, { kind: c }),
        ...
        class extends a {
          ...
          assertNoSpace() {
            this.state.start > this.state.lastTokEndLoc.index &&
              this.raise(zt.UnexpectedSpace, this.state.lastTokEndLoc);
          }
        },
      nr = (a) =>
        class extends a {
    ...
    function or(a) {
      ...
      if (
        ...
        K(a, "optionalChainingAssign", "version") !== "2023-07"
      )
        throw new Error(
    ...
    var ut = class extends pt {
        ...
        parseCoverCallAndAsyncArrowHead(t, e, s, i) {
          ...
          h && (this.expressionScope.enter(ji()), (n = new ee())),
            l && (o.optional = i),
            i
          ...
          r === null &&
            (t ||
              this.raise(
                ...
                L(this.state.firstInvalidTemplateEscapePos, 1),
              ));
          let h = this.match(24),
            l = h ? -1 : -2,
            c = i + l;
...
`,
    ...
    var ft = class extends ut {
        parseTopLevel(t, e) {
          return (
            ...
            (t.comments = this.comments),
            this.options.tokens && (t.tokens = ur(this.tokens, this.input)),
          ...
          if ((this.parsePostMemberNameModifiers(u), this.isClassMethod())) {
            ...
            C &&
              ...
              s.hadConstructor &&
                ...
                this.raise(p.DuplicateConstructor, y),
              C &&
                this.hasPlugin("typescript") &&
                e.override &&
                this.raise(p.OverrideOnConstructor, y),
              (s.hadConstructor = !0),
              (E = s.hadSuperClass)),
        ...
        pushClassAccessorProperty(t, e, s) {
          if (!s && !e.computed) {
            ...
            (r.name === "constructor" || r.value === "constructor") &&
              this.raise(p.ConstructorClassField, r);
          }
      ...
      Oe = class extends ft {
        constructor(t, e) {
          (t = lr(t)),
            ...
            (this.plugins = fr(this.options.plugins)),
    ...
    function ue(a, t) {
      let e = Oe;
      return (
        a != null && a.plugins && (or(a.plugins), (e = Pr(a.plugins))),
        new e(a, t)
      );
    }
    var Jt = {};
...
`);
  ...
  function Br(a) {
    ...
    return (
      ...
      _e(t, { loc: { start: { line: e, column: s + 1 } }, cause: r })
    );
  }
  var Ue = Br;
  var re = Ve(Ds(), 1);
  ...
  function Wr(a) {
    return (
      ...
      { astFormat: "estree", hasPragma: Ms, locStart: D, locEnd: B, ...a }
    );
  }
  var Y = Wr;
  function Jr(a) {
  ...
  var ae = (a) => Y(ta(a)),
    ...
    Yr = ["recordAndTuple", { syntaxType: "hash" }],
    Fs = "v8intrinsic",
    Bs = [
    ...
    R = (a, t = Gr) => ({ ...t, plugins: [...t.plugins, ...a] }),
    Qr = /@(?:no)?flow\b/;
  function Zr(a, t) {
    var i;
  ...
  function ta({ isExpression: a = !1, optionsCombinations: t }) {
    return (e, s = {}) => {
      ...
      let i = t;
      (s.__babelSourceType ?? Os(s)) === "script" &&
        (i = i.map((l) => ({ ...l, sourceType: "script" }))),
        /#[[{]/.test(e) && (i = i.map((l) => R([Yr], l)));
      let n = /%[A-Z]/.test(e);
      e.includes("|>")
        ? (i = (n ? [...Bs, Fs] : Bs).flatMap((c) => i.map((u) => R([c], u))))
        : n && (i = i.map((l) => R([Fs], l)));
      let o = a ? $e.parseExpression : $e.parse,
        h;
      try {
      ...
      return (
        a && (h = je(h, { text: e, rootMarker: s.rootMarker })),
        Cs(h, { parser: "babel", text: e })
      );
    };
  }
  var sa = new Set([
    ...
    $s = [R(["jsx"])],
    Rs = ae({ optionsCombinations: $s }),
    _s = ae({
      optionsCombinations: [R(["jsx", "typescript"]), R(["typescript"])],
    }),
    Us = ae({ isExpression: !0, optionsCombinations: [R(["jsx"])] }),
    js = ae({ isExpression: !0, optionsCombinations: [R(["typescript"])] }),
    Vs = ae({
      optionsCombinations: [
        R(["jsx", ["flow", { all: !0, enums: !0 }], "flowComments"]),
      ],
    }),
    ia = ae({ optionsCombinations: $s.map((a) => R(["estree"], a)) }),
    qs = {
      babel: Rs,
      "babel-flow": Vs,
      "babel-ts": _s,
