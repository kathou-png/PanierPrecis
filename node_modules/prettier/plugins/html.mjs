...
var Yr = (t, e) => {
  for (var r in e) Js(t, r, { get: e[r], enumerable: !0 });
};
var jr = (t, e, r) => {
...
var Ie = ei;
var ti = (t) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(t);
function ri(t) {
...
function tn(t, e) {
  return re(t), { type: he, contents: t, groupId: e.groupId, negate: e.negate };
}
var ne = { type: fe };
var ni = { type: Y, hard: !0 },
  si = { type: Y, hard: !0, literal: !0 },
  A = { type: Y },
  v = { type: Y, soft: !0 },
  S = [ni, ne],
  rn = [si, ne];
          ...
          : !(
              (!t.next &&
                (t.parent.type === "root" ||
                  ...
                  U(t.parent) ||
                  Je(t.parent, e) ||
                  !Ti(t.parent.cssDisplay))) ||
              (t.next && !xi(t.next.cssDisplay))
            );
}
function vn(t) {
...
function Bn(t, e) {
  ...
  if (t.type === "element" && t.namespace === "svg")
    if (Li(t, (s) => s.fullName === "svg:foreignObject")) r = !0;
  ...
  switch (e.htmlWhitespaceSensitivity) {
    ...
    default:
      return (
        (t.type === "element" && (!t.namespace || r || de(t)) && gn[t.name]) ||
        mn
      );
  }
}
...
async function Nn(t, e) {
  let r = [];
  for (let [n, s] of t.split(hr).entries())
    if (n % 2 === 0) r.push(T(s));
    else
      try {
        r.push(
...
function fr({ parser: t }) {
  return (e, r, n) => x(P(n.node), e, { parser: t, trailingComma: "none" }, j);
}
var Ni = fr({ parser: "__ng_action" }),
  Ii = fr({ parser: "__ng_binding" }),
  Ri = fr({ parser: "__ng_directive" });
function $i(t, e) {
...
async function Gn(t, e, r, n) {
  let s = P(r.node),
    { left: i, operator: a, right: o } = Ki(s),
    u = Oe(r, n);
  return [
    E(
...
function Ji(t, e, { parseWithTs: r }) {
  return x(t, e, { parser: r ? "__vue_ts_expression" : "__vue_expression" }, j);
}
...
function ia(t, e, r) {
  ...
  let s =
    ...
    l = [L([o ? " " : A, M(p, a)])];
  return (
    (n.firstChild && tt(n.firstChild)) || (n.isSelfClosing && De(n.parent)) || o
...
var ga = /-+([a-z0-9])/g;
function ms(t) {
  return t.replace(ga, (...e) => e[1].toUpperCase());
}
var ae = class t {
    constructor(e, r, n, s) {
...
var Dr = { name: "custom-elements" },
  vr = { name: "no-errors-schema" };
var J;
(function (t) {
  (t[(t.NONE = 0)] = "NONE"),
    (t[(t.HTML = 1)] = "HTML"),
...
var Fa = "boolean",
  ...
  $a = Array.from(vs).reduce((t, [e, r]) => (t.set(e, r), t), new Map()),
  $t = class extends Rt {
    constructor() {
      super(),
    ...
    hasElement(e, r) {
      return r.some((n) => n.name === vr.name) ||
        (e.indexOf("-") > -1 &&
          (yr(e) || wr(e) || r.some((n) => n.name === Dr.name)))
        ? !0
...
function Ms(t, e, r, n = {}) {
  ...
  return (
    s.tokenize(), new Pr(fo(s.tokens), s.errors, s.nonNormalizedIcuExpressions)
  );
}
var ao = /\r\n?/g;
function Ye(t) {
  ...
  Nr = class {
    constructor(e, r, n) {
      (this._getTagContentType = r),
        ...
        (this._interpolationConfig = n.interpolationConfig || xr),
      ...
      (this._cursor = n.escapedString ? new Ir(e, s) : new Kt(e, s)),
...
var Kt = class t {
    ...
    advanceState(e) {
      ...
      r === 10 ? (e.line++, (e.column = 0)) : Sr(r) || e.column++,
        e.offset++,
        this.updatePeek(e);
    }
    updatePeek(e) {
    ...
    _collectExpansionExpTokens(e) {
      ...
      for (;;) {
        ...
        if (this._peek.type === 30)
          return (
            this.errors.push(
              $.create(null, e.sourceSpan, "Invalid ICU message. Missing '}'."),
            ),
            null
          );
...
`
    ...
    _consumeStartTag(e) {
      ...
      this._pushContainer(
        m,
        g instanceof G && this.getTagDefinition(g.name).isClosedByChild(m.name),
      ),
        a
...
var Eo = [
  { regex: /^(\[if([^\]]*)]>)(.*?)<!\s*\[endif]$/s, parse: Ao },
  { regex: /^\[if([^\]]*)]><!$/, parse: Do },
  { regex: /^<!\s*\[endif]$/, parse: vo },
];
function zs(t, e) {
  if (t.value)
        ...
        for (let d of c.attrs)
          d.namespace ||
            (d.name = _(
              d.name,
              (y) =>
                er.has(c.name) && (er.get("*").has(y) || er.get(c.name).has(y)),
            ));
    },
    I = (c) => {
      c.sourceSpan &&
