      ...
      return (
        typeof t == "string"
          ...
          : (Array.isArray(t) && (t = t[0]),
            t &&
              t.context &&
              (t.lineStarts || (t.lineStarts = vs(t.context.src)),
              (e = t.lineStarts),
              (n = t.context.src))),
        { lineStarts: e, src: n }
      );
...
${n}`,
          ...
          "'";
      return e.implicitKey ? r : jt(r, n, $s, qn(e));
    }
...
${a}`
    ...
    function Qo(t, e) {
      ...
      for (let o = 0; o < r.length; ++o) {
        let { key: a } = r[o];
        if (
          (a instanceof W && (i = !0), t.schema.merge && a && a.value === Bs)
        ) {
          r[o] = new Wt(r[o]);
...
${i.comment}`
  ...
  var Hn = ee((ai) => {
    ...
    var Ea = Jn.concat(
      ...
      Sa = { core: ya, failsafe: Jn, json: oi, yaml11: Ea },
      wa = {
        binary: D.binary,
        bool: Zs,
        float: ii,
  ...
  var ui = ee((nn) => {
    ...
    function Ma(t, e, { anchors: n, doc: r }) {
      ...
      return (
        i && ((n[i] = t), s.push(`&${i}`)),
        t.tag ? s.push(li(r, t.tag)) : e.default || s.push(li(r, e.tag)),
        s.join(" ")
      );
    }
    function Zt(t, e, n, r) {
    ...
    var tn = class t {
      ...
      listNonDefaultTags() {
        return ka(this.contents).filter(
          (e) => e.indexOf(ci.Schema.defaultPrefix) !== 0,
        );
      }
      setTagPrefix(e, n) {
        if (e[0] !== "!" || e[e.length - 1] !== "!")
...
`
    ...
    Y._defineProperty(tn, "defaults", fi);
    nn.Document = tn;
...
`,
        ...
        for (var n = [0], r = 0; r < e.length; )
          switch (e[r]) {
            case vt:
              ...
              break;
            case _r:
              (r += _r.length), e[r] === vt && (r += vt.length), n.push(r);
              break;
            default:
              r++;
              break;
    ...
    return (
      e.comments.push(...s, ...i),
      {
        createDocumentHeadWithTrailingComment: (l) => (
          l && e.comments.push(l), ts(o, r, i, l)
        ),
  ...
  var { Document: Si, parseCST: wi } = Ei.default;
  function bi(t) {
    let e = wi(t);
    ks(e);
    let n = e.map((a) => new Si({ merge: !1, keepCstNodes: !0 }).parse(a)),
      r = new xr(t),
      s = [],
      i = {
        text: t,
  ...
  function ja(t) {
    try {
      ...
      throw e != null && e.position
        ? Ni(e.message, { loc: e.position, cause: e })
        : e;
    }
  }
  var Qa = {
