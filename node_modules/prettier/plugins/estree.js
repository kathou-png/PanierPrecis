(function (f) {
  ...
  var Na = (e, t, r) => (
    ...
    Ga = (e) => Us(Tr({}, "__esModule", { value: !0 }), e);
  var Ys = (e, t, r) => {
  ...
  var it = (e, t, r) => (
    ...
    Vs = (e, t, r, n) => (
      Ys(e, t, "write to private field"), n ? n.call(e, r) : t.set(e, r), r
    );
  var yi = Wa((Pt) => {
    "use strict";
...
`;
      ...
      let r = "";
      for (; r !== e; ) (r = e), (e = e.replace(zp, `${t}$1 $2${t}`));
...
`,
  ...
  var nm = {};
  xr(nm, { languages: () => rm, options: () => La, printers: () => tm });
  var $s = [
    {
...
` ||
  ...
  function St(e, t) {
    ...
    if (e.arguments.length === 1) {
      ...
      (e.arguments[0].type === "TemplateLiteral" || te(e.arguments[0])) &&
      go(e.callee)
    )
      return e.arguments[2] && !Pe(e.arguments[2])
        ? !1
        : (e.arguments.length === 2
            ? Mt(e.arguments[1])
            : Co(e.arguments[1]) && $(e.arguments[1]).length <= 1) ||
            _n(e.arguments[1]);
    return !1;
  }
  var fu = (e) => (t) => (
  ...
  function Fu(e, { maxDepth: t = Number.POSITIVE_INFINITY } = {}) {
    if (A(e)) return !1;
    if (e.type === "ChainExpression") return Fu(e.expression, { maxDepth: t });
    if (!q(e)) return !1;
    let r = e,
      n = 0;
    for (; q(r) && n++ <= t; )
      if (!Rn(r.property) || ((r = r.object), A(r))) return !1;
    return Rn(r);
  }
  function Rn(e) {
...
`),
  ...
  function Or(e, t) {
    return (
      ((e.type === "TemplateLiteral" && pu(e)) ||
        (e.type === "TaggedTemplateExpression" && pu(e.quasi))) &&
      !Z(t, j(e), { backwards: !0 })
    );
  }
  function vr(e) {
  ...
  function be(e, t = 2) {
    ...
    let r = (n) => be(n, t - 1);
    if (Wn(e)) return Ze(e.pattern ?? e.regex.pattern) <= 5;
...
`),
    ...
    return q(e)
      ...
      : (e.type === "UnaryExpression" && So.has(e.operator)) ||
  ...
  function Yn(e, t) {
    let r = [];
    if (
      (e.type === "ChainExpression" && r.push("expression"),
      e.type === "ImportExpression")
    ) {
  ...
  function Ce(e) {
    return (
      e && (e.type === "ObjectProperty" || (e.type === "Property" && !ht(e)))
    );
  }
  var Ae = M([
      "TSAsExpression",
    ...
    Mr = M(["IntersectionTypeAnnotation", "TSIntersectionType"]);
  var bo = new Set([
      "range",
      "raw",
      "comments",
    ...
    if (
      ...
      e.type === "TemplateLiteral" &&
        (((u = e.leadingComments) != null &&
          u.some(
            (a) =>
              ee(a) && ["GraphQL", "HTML"].some((o) => a.value === ` ${o} `),
          )) ||
  ...
  var et = "string",
    ...
    Oe = "label",
    ve = "break-parent",
    jr = new Set([tt, Ge, Ue, rt, pe, de, xe, Ye, Xe, Ve, ce, Oe, ve]);
  function Po(e) {
...
Expected it to be ${n}.`;
  ...
  var Pu = () => {},
    ...
    Rr = Pu;
  function E(e) {
    return $e(e), { type: Ge, contents: e };
  }
  function ge(e, t) {
    return $e(t), { type: Ue, contents: t, n: e };
  }
  function D(e, t = {}) {
    return (
      $e(e),
      Rr(t.expandedStates, !0),
      {
        type: pe,
        id: t.id,
        contents: e,
  ...
  function Ct(e, t) {
    return (
      $e(e), { type: Ye, contents: e, groupId: t.groupId, negate: t.negate }
    );
  }
  function $n(e) {
  ...
  var ke = { type: Ve },
    Ee = { type: ve };
  var Hn = { type: ce, hard: !0 },
    wo = { type: ce, hard: !0, literal: !0 },
    d = { type: ce },
    F = { type: ce, soft: !0 },
    C = [Hn, Ee],
    qr = [wo, Ee],
  ...
  function st(e, t) {
    return $e(t), e ? { type: Oe, label: e, contents: t } : t;
  }
  var Wr = (e) => {
    if (Array.isArray(e)) return e;
    if (e.type !== de) throw new Error(`Expect doc to be 'array' or '${de}'.`);
    return e.parts;
  };
  function ct(e, t) {
...
`);
  ...
  var ns = {};
  xr(ns, { endOfLine: () => Yo, ownLine: () => Uo, remaining: () => Xo });
  function Jo(e) {
...
`
  ...
  function Ju({
    ...
    return (!t || !i) &&
      ...
      ? u.experimentalTernaries &&
        r.alternate === n &&
        !(ee(e) && !Te(u.originalText, j(e), I(e)))
        ? (he(r, e), !0)
        : (oe(n, e), !0)
      : !1;
  }
  ...
  function qu({
    ...
    if (zo.has(r == null ? void 0 : r.type)) {
      if (L(r.decorators) && (n == null ? void 0 : n.type) !== "Decorator")
  ...
  function rp({ comment: e, enclosingNode: t, text: r }) {
    return Ke(r, I(e)) !== ")"
      ? !1
      : t && ((Xu(t) && $(t).length === 0) || (pt(t) && ae(t).length === 0))
        ? (he(t, e), !0)
  ...
  function sp({
    ...
    return We(r)
      ? (ir(e) && ((n.prettierIgnore = !0), (e.unignore = !0)),
        t ? (K(t, e), !0) : !1)
      : (We(n) &&
          ir(e) &&
  ...
  function cp({ comment: e, enclosingNode: t, followingNode: r }) {
    return op.has(t == null ? void 0 : t.type) && r && (pp.has(r.type) || ee(e))
      ? (oe(r, e), !0)
      : !1;
  }
  ...
  function Dp({ comment: e, enclosingNode: t, followingNode: r }) {
    return !t ||
      ...
      r !== t.consequent[0]
      ? !1
      : (r.type === "BlockStatement" && Rt(e) ? bt(r, e) : he(t, e), !0);
  }
  function yp({
    comment: e,
    precedingNode: t,
...
`,
        ...
        case pe:
          switch (f) {
            ...
            case Se: {
              o = !1;
              let h = { ind: c, mode: ut, doc: l.contents },
                g = n - u,
                S = p.length > 0;
              if (!l.break && Nr(h, i, g, S, r)) i.push(h);
        ...
        case de: {
          ...
          if (g.length === 0) break;
          let [S, B] = g,
            O = { ind: c, mode: ut, doc: S },
            R = { ind: c, mode: Se, doc: S },
            _ = Nr(O, [], h, p.length > 0, r, !0);
          if (g.length === 1) {
            _ ? i.push(O) : i.push(R);
            break;
          }
          let T = { ind: c, mode: ut, doc: B },
            W = { ind: c, mode: Se, doc: B };
          if (g.length === 2) {
            _ ? i.push(T, O) : i.push(W, R);
            break;
          }
          g.splice(0, 2);
          let Fe = { ind: c, mode: f, doc: Wt(g) },
            X = g[0];
          Nr({ ind: c, mode: ut, doc: [S, B, X] }, [], h, p.length > 0, r, !0)
            ? i.push(Fe, T, O)
            : _
              ? i.push(Fe, W, O)
              : i.push(Fe, W, R);
            ...
            case Se:
              ...
              l.literal
                ? c.root
                  ...
                  : (a.push(s), (u = 0))
                : ((u -= is(a)), a.push(s + c.value), (u = c.length));
              break;
          }
          break;
        case Oe:
...
`);
  ...
  function Ur(e, t, r) {
    ...
    o &&
      (a = a.map(
        (m) => Gr(m, { ...r, printWidth: Number.POSITIVE_INFINITY }).formatted,
      )),
      i.push(ke, "`");
    let p = 0;
    return (
      e.each(({ index: m, node: y }) => {
...
`)
  ...
  function zu(e) {
    let t = e("quasi");
    return st(t.label && { tagged: !0, ...t.label }, [
      e("tag"),
      e("typeParameters"),
      ke,
      t,
...
`) && o.push({ hasLineBreak: !1, cells: [] });
      ...
      for (let { cells: c } of y.filter((f) => !f.hasLineBreak))
        for (let [f, l] of c.entries()) m[f] = Math.max(m[f], Ze(l));
      return (
        i.push(
          ke,
          "`",
            ...
            P(
              ...
              y.map((c) =>
                P(
                  " | ",
                  c.cells.map((f, l) =>
                    c.hasLineBreak ? f : f + " ".repeat(m[l] - Ze(f)),
                  ),
                ),
              ),
            ),
  ...
  function Yr(e, t) {
    return ct(e, (r) =>
      typeof r == "string" ? (t ? H(!1, r, /(\\*)`/g, "$1$1\\`") : as(r)) : r,
    );
  }
  function as(e) {
    return H(!1, e, /([\\`]|\${)/g, "\\$1");
  ...
  function Zu(e) {
    let t = (n) => n.type === "TemplateLiteral",
      r = (n, s) =>
        ...
        s === "value";
    return (
      e.match(t, (n, s) => G(n) && s === "elements", r, ...os) ||
      e.match(t, r, ...os)
    );
  }
  function ei(e) {
  ...
  async function Pp(e, t, r) {
    let { node: n } = r,
      ...
      i = s.reduce(
        (m, y, c) =>
          c === 0 ? y : m + "@prettier-placeholder-" + u++ + "-id" + y,
        "",
      ),
...
`),
      ...
      let B = null;
      S ? (B = _p(c)) : (B = await e(y, { parser: "graphql" })),
        B
          ? ((B = Yr(B, !1)),
            !p && h && i.push(""),
            i.push(B),
  ...
  async function si(e, t, r, n, s) {
    ...
    let a = (S) => `PRETTIER_HTML_PLACEHOLDER_${S}_${i}_IN_JS`,
      o = u.quasis
        .map((S, B, O) =>
          B === O.length - 1 ? S.value.cooked : S.value.cooked + a(B),
        )
        .join(""),
      p = Gt(n, r),
      m = new RegExp(a("(\\d+)"), "g"),
      ...
      f = ct(c, (S) => {
        ...
        for (let R = 0; R < O.length; R++) {
          ...
          if (R % 2 === 0) {
            _ &&
              ((_ = as(_)),
              s.__embeddedInHtml && (_ = H(!1, _, /<\/(?=script\b)/gi, "<\\/")),
              B.push(_));
            continue;
          }
          let T = Number(_);
  ...
  async function Np(e, t, r) {
    ...
    let a = Yr(await e(s, { parser: "markdown", __inJsTemplate: !0 }), !0);
    return ["`", i ? E([F, a]) : [qr, ku(a)], F, "`"];
  }
  function Gp(e) {
    let t = e.match(/^([^\S\n]*)\S/m);
    return t === null ? "" : t[1];
...
`);
  ...
  function sc(e) {
    ...
    let r = (0, At.extract)(e),
      { pragmas: n, comments: s } = (0, At.parseWithComments)(r);
    return { shebang: t, text: e, pragmas: n, comments: s };
  }
  function Ei(e) {
    let { shebang: t, text: r, pragmas: n, comments: s } = sc(e),
      u = (0, At.strip)(r),
      i = (0, At.print)({
        pragmas: { format: "", ...n },
...
`) +
      ...
      case "ClassExpression":
        if (
          ...
          (r.type === "ArrowFunctionExpression" ||
            ...
            (r.type === "ClassExpression" && L(r.decorators)))
        )
          return !0;
        break;
      ...
      case "NGPipeExpression":
        return !(
          ...
          (s.type === "ObjectProperty" &&
            !((y = r.extra) != null && y.parenthesized)) ||
          G(s) ||
          (n === "arguments" && w(s)) ||
  ...
  function Ci(e, t) {
    ...
    return r.type === "FunctionExpression" || r.type === "ClassExpression"
      ...
      : !jt(r) || (n.type !== "ExportDefaultDeclaration" && cs(e, t))
        ? !1
        : e.call(() => Ci(e, t), ...Lr(r));
  }
  function cc(e) {
  ...
  function lc(e, t) {
    let r = t - 1;
    (r = Je(e, r, { backwards: !0 })),
      (r = qe(e, r, { backwards: !0 })),
      (r = Je(e, r, { backwards: !0 }));
  ...
  function yc(e, t, r) {
    ...
    return !o || (r != null && r.hasLineSuffix)
      ? { doc: [$n([" ", s]), Ee], isBlock: o, hasLineSuffix: !0 }
      : { doc: [" ", s], isBlock: o, hasLineSuffix: !1 };
  }
  function J(e, t, r = {}) {
    let { node: n } = e;
    if (!L(n == null ? void 0 : n.comments)) return "";
    let { indent: s = !1, marker: u, filter: i = mc } = r,
      a = [];
    if (
      (e.each(({ node: p }) => {
...
\r	`),
  ...
  function fc(e, t, r) {
    ...
    let i = n.children.some(U),
      ...
      c = m ? " " : b([y, F], " "),
      f =
        ((R = (O = n.openingElement) == null ? void 0 : O.name) == null
          ? void 0
          : R.name) === "fbt",
      l = Ec(e, t, r, c, f),
        ...
        if (i.type === "JSXText") {
          ...
          if (lr(i)) {
            ...
            p[0] === "" &&
              (u.push(""),
              p.shift(),
              /\n/.test(p[0]) ? u.push(xi(s, p[1], i, a)) : u.push(n),
              p.shift());
            let m;
            if (
              (v(!1, p, -1) === "" && (p.pop(), (m = p.pop())), p.length === 0)
            )
              return;
            for (let [y, c] of p.entries()) y % 2 === 1 ? u.push(d) : u.push(c);
            m !== void 0
              ? /\n/.test(m)
                ? u.push(xi(s, v(!1, u, -1), i, a))
                : u.push(n)
              : u.push(Ti(s, v(!1, u, -1), i, a));
          } else
            /\n/.test(o)
              ? o.match(/\n/g).length > 1 && u.push("", C)
              : u.push("", n);
  ...
  function Ac(e, t, r) {
    ...
    if ((s.push(r("name")), n.value)) {
      ...
      if (te(n.value)) {
        ...
        (a = o === '"' ? H(!1, a, '"', "&quot;") : H(!1, a, "'", "&apos;")),
          (u = e.call(() => le(e, Ie(o + a + o), t), "value"));
      } else u = r("value");
      s.push("=", u);
    }
    return s;
      ...
      s = (u, i) =>
        ...
        (!A(u) &&
          (G(u) ||
            ...
            u.type === "DoExpression" ||
            (U(i) && (u.type === "ConditionalExpression" || me(u)))));
    return s(n.expression, e.parent)
      ? D(["{", r("expression"), ke, "}"])
      : D(["{", E([F, r("expression")]), F, ke, "}"]);
  }
  function Tc(e, t, r) {
    var a, o;
    let { node: n } = e,
...
`),
  ...
  function lr(e) {
    return (
      e.type === "JSXText" &&
      ($r.hasNonWhitespaceCharacter(De(e)) || !/\n/.test(De(e)))
    );
  }
  function Ic(e) {
    return (
  ...
  function Kr(e, t, r) {
    ...
    let { node: n, parent: s, grandparent: u, key: i } = e,
      ...
      o =
        n.operator === "|>" &&
        ((R = e.root.extra) == null ? void 0 : R.__isUsingHackPipeline),
      p = Fs(e, r, t, !1, a);
    if (a) return p;
    if (o) return D(p);
    if (
    ...
    let f = U(n.right),
      l = p.findIndex(
        (_) => typeof _ != "string" && !Array.isArray(_) && _.type === pe,
      ),
  ...
  function Fs(e, t, r, n, s) {
    ...
    if (!me(u)) return [D(t())];
    let i = [];
    sr(u.operator, u.left.operator)
      ? (i = e.call((g) => Fs(g, t, r, !0, s), "left"))
      : i.push(D(t("left")));
    let a = Ut(u),
      o =
        (u.operator === "|>" || u.type === "NGPipeExpression" || Oc(e, r)) &&
        !we(r.originalText, u.right),
    ...
    if ((i.push(o ? "" : " ", l ? D(y, { shouldBreak: f }) : y), n && A(u))) {
      let g = Nt(le(e, i, r));
      return Array.isArray(g) || g.type === de ? Wr(g) : [g];
    }
    return i;
  }
  function Ut(e) {
  ...
  function Oc(e, t) {
    return (
      ...
      Si(e.node) &&
      !e.hasAncestor((r) => !Si(r) && r.type !== "JsExpressionRoot")
    );
  }
  function bi(e, t, r) {
    let { node: n } = e;
  ...
  function ki(e, t, r) {
    let { node: n, parent: s } = e,
      { decorators: u } = n;
    if (!L(u) || Li(s) || Hr(e)) return "";
    let i =
      n.type === "ClassExpression" || n.type === "ClassDeclaration" || Ii(n, t);
    return [
      e.key === "declaration" && mu(s) ? C : i ? Ee : "",
      P(d, e.map(r, "decorators")),
      d,
    ];
  }
  function Ii(e, t) {
  ...
  function Mc(e, t, r) {
    ...
    let y = ["(", E([F, ...a]), b(p), F, ")"];
    return _r(e) ? y : D(y, { shouldBreak: a.some(re) || u });
  }
  function mr(e, t = !1) {
    return (
      (se(e) && (e.properties.length > 0 || A(e))) ||
      (G(e) && (e.elements.length > 0 || A(e))) ||
      (e.type === "TSTypeAssertion" && mr(e.expression)) ||
      (Ae(e) && mr(e.expression)) ||
      e.type === "FunctionExpression" ||
      (e.type === "ArrowFunctionExpression" &&
        ...
        (e.body.type === "BlockStatement" ||
          (e.body.type === "ArrowFunctionExpression" && mr(e.body, !0)) ||
          se(e.body) ||
          G(e.body) ||
  ...
  function Rc(e) {
    ...
    let [t, r] = e;
    return t.type === "ModuleExpression" && Wc(r)
      ? !0
      : !A(t) &&
  ...
  function wi(e) {
    ...
    if (Ae(e) || e.type === "TypeCastExpression") {
      ...
      return (
        ...
        Jt(r) && be(e.expression, 1)
      );
    }
    return pt(e) && ae(e).length > 1
      ? !1
      : me(e)
  ...
  function qc(e) {
    return (
      ...
      (e.body.some((t) => t.type !== "EmptyStatement") || A(e, x.Dangling))
    );
  }
  function Wc(e) {
    return (
    ...
    let n = r("object"),
      ...
      o =
        ...
        ((a.type === "AssignmentExpression" ||
          ...
          (Nc(u.object) || ((p = n.label) == null ? void 0 : p.memberChain)));
  ...
  function vi(e, t, r) {
      ...
      if (w(N) && (Et(N.callee) || w(N.callee))) {
        ...
        Et(N)
          ? (u.unshift({
              node: N,
              needsParens: Be(k, t),
              printed: le(k, q(N) ? ds(k, t, r) : zr(k, t, r), t),
            }),
            k.call((Q) => a(Q), "object"))
          : N.type === "TSNonNullExpression"
            ? (u.unshift({ node: N, printed: le(k, "!", t) }),
              k.call((Q) => a(Q), "expression"))
            : u.unshift({ node: N, printed: r() });
    }
    let { node: o } = e;
    u.unshift({ node: o, printed: [V(e), ze(e, t, r), Dr(e, t, r)] }),
    ...
    for (
      ...
      (u[y].node.type === "TSNonNullExpression" ||
        w(u[y].node) ||
        (q(u[y].node) && u[y].node.computed && Pe(u[y].node.property)));
      ++y
    )
      m.push(u[y]);
    if (!w(u[0].node))
    ...
    for (; y < u.length; ++y) {
      ...
      (w(u[y].node) || u[y].node.type === "ImportExpression") && (c = !0),
        m.push(u[y]),
        A(u[y].node, x.Trailing) && (p.push(m), (m = []), (c = !1));
    }
    m.length > 0 && p.push(m);
    function f(k) {
      return /^[A-Z]|^[$_]+$/.test(k);
    ...
    function h(k) {
      ...
      if (k[0].length === 1) {
        ...
        return (
          ...
          (xt.type === "Identifier" && (f(xt.name) || (s && l(xt.name)) || N))
        );
      }
      let Q = v(!1, k[0], -1).node;
      return (
        q(Q) && Q.property.type === "Identifier" && (f(Q.property.name) || N)
      );
    }
    ...
    let O = p.map(S),
      ...
      T = p.flat(),
      W =
        T.slice(1, -1).some((k) => A(k.node, x.Leading)) ||
        T.slice(0, -1).some((k) => A(k.node, x.Trailing)) ||
        (p[_] && A(p[_][0].node, x.Leading));
    if (
      p.length <= _ &&
      !W &&
      !p.some((k) => v(!1, k, -1).hasTrailingEmptyLine)
    )
      return _r(e) ? R : D(R);
    ...
    return (
      W ||
      (z.length > 2 && z.some((k) => !k.arguments.every((N) => be(N)))) ||
      O.slice(0, -1).some(re) ||
      wt()
        ? (Ht = D(ue))
        : (Ht = [re(R) || X ? Ee : "", He([R, ue])]),
      st({ memberChain: !0 }, Ht)
    );
  }
  var _i = vi;
  function Qr(e, t, r) {
    ...
    let { node: n, parent: s } = e,
      ...
      a = V(e),
      o = ae(n),
      p = o.length === 1 && Or(o[0], t.originalText);
    ...
    if (
      ...
      return a
        ? i.type === "ArrowFunctionExpression" &&
          ...
          : "chain-tail"
        : "chain";
    if ((!a && Zr(i.right)) || we(t.originalText, i))
  ...
  function zc(e) {
    ...
    return (
      L(r) &&
      r.length > 1 &&
      r.some((n) => L(Mi(n)) || n.type === "TSConditionalType")
    );
  }
  function Ts(e) {
    var t;
  ...
  function qi(e, t, r, n = !1) {
    ...
    if (w(s)) {
      ...
      let o = ae(s);
      return !(o.length === 0 || (o.length === 1 && nr(o[0], t))) || el(s, r)
        ? !1
        : e.call(u, "callee");
    }
    return q(s)
  ...
  function Zc(e, t, r) {
    return Ce(e)
      ? ((t = Nt(t)), typeof t == "string" && Ze(t) < r.tabWidth + 3)
      : !1;
  }
  function el(e, t) {
    let r = tl(e);
  ...
  function Dt(e, t, r, n, s) {
    ...
    if (i.length === 0)
      return [
        a,
        "(",
        J(e, r, { filter: (l) => Ke(r.originalText, I(l)) === ")" }),
        ")",
      ];
    let { parent: o } = e,
      p = St(o),
    ...
    if (
      (gu(e, (l, h) => {
        ...
        g && u.rest && y.push("..."),
          ...
          !g &&
            (y.push(","),
            p || m ? y.push(" ") : fe(i[h], r) ? y.push(C, C) : y.push(d));
      }),
      n && !sl(e))
    ) {
    ...
    return (
      ...
      (r.type === "ObjectPattern" ||
        ...
        (r.type === "Identifier" &&
          ...
          Le(r.typeAnnotation.typeAnnotation)) ||
  ...
  function V(e) {
    ...
    return !t.optional || (t.type === "Identifier" && t === e.parent.key)
      ? ""
      : w(t) || (q(t) && t.computed) || t.type === "OptionalIndexedAccessType"
        ? "?."
        : "?";
  }
  function Dn(e) {
  ...
  function ne(e) {
    let { node: t } = e;
    return t.declare ||
      (cl.has(t.type) && e.parent.type !== "DeclareExportDeclaration")
      ? "declare "
      : "";
  }
  var ll = new Set([
  ...
  function Vt(e, t, r) {
    ...
    if (o.length === 0) s.push(ml(e, t, u, i));
      ...
      s.push(
        D(
          [u, E([F, l ? yl(e, t, r, h) : [Dl(e, t, a, r), h], J(e, t)]), F, i],
          { shouldBreak: f, id: c },
        ),
      );
    }
  ...
  function As(e, t) {
    return (
      ...
      e.elements.every(
        (r) =>
          r &&
          (Pe(r) || (qn(r) && !A(r.argument))) &&
          !A(
            r,
            x.Trailing | x.Line,
            (n) => !Z(t.originalText, j(n), { backwards: !0 }),
          ),
      )
    );
  }
  ...
  function yl(e, t, r, n) {
    ...
    return (
      e.each(({ isLast: u, next: i }) => {
        s.push([r(), u ? n : ","]),
          u || s.push(Ui(e, t) ? [C, C] : A(i, x.Leading | x.Line) ? C : d);
      }, "elements"),
      Wt(s)
    );
  }
  var Yi = new Proxy(() => {}, { get: () => Yi }),
    fn = Yi;
  function fl(e) {
    return e
      .toLowerCase()
  ...
  function ft(e, t, r) {
    ...
    let { parent: s } = e,
      { key: u } = n;
    if (t.quoteProps === "consistent" && !En.has(s)) {
      let i = (s.properties || s.body || s.members).some(
        (a) => !a.computed && a.key && te(a.key) && !Gn(a, t),
      );
      En.set(s, i);
    }
    if (
      (u.type === "Identifier" ||
        (Pe(u) &&
          Un(Qe(De(u))) &&
          String(u.value) === Qe(De(u)) &&
          !(t.parser === "typescript" || t.parser === "babel-ts"))) &&
      (t.parser === "json" ||
        t.parser === "jsonc" ||
        (t.quoteProps === "consistent" && En.get(s)))
    ) {
      let i = at(
    ...
    return Gn(n, t) &&
      (t.quoteProps === "as-needed" ||
        (t.quoteProps === "consistent" && !En.get(s)))
      ? e.call(
          (i) => le(i, /^\d/.test(u.value) ? Qe(u.value) : u.value, t),
          "key",
        )
      : r("key");
  }
  ...
  var El = ({ node: e, key: t, parent: r }) =>
    ...
    (r.type === "ObjectMethod" ||
      ...
      r.type === "TSAbstractMethodDefinition" ||
      r.type === "TSDeclareMethod" ||
      (r.type === "Property" && ht(r)));
  function Fn(e, t, r, n) {
    if (El(e)) return Cn(e, r, t);
    let { node: s } = e,
      u = !1;
    if (
      ...
      w(m) &&
        (ae(m).length > 1 ||
          $(s).every((y) => y.type === "Identifier" && !y.typeAnnotation)) &&
        (u = !0);
    }
    let i = [
        ne(e),
      ...
      p = kt(s, o);
    return (
      i.push(ze(e, r, t), D([p ? D(a) : a, o]), s.body ? " " : "", t("body")),
  ...
  function yr(e, t, r) {
    ...
    return (
      !s || s === "init" || s === "method" || s === "constructor"
        ...
        : (fn.ok(s === "get" || s === "set"), i.push(s, " ")),
      u.generator && i.push("*"),
      i.push(
        ft(e, t, r),
        n.optional || n.key.optional ? "?" : "",
        n === u ? Cn(e, t, r) : r("value"),
      ),
      i
    );
  }
  function Cn(e, t, r) {
    let { node: n } = e,
      ...
      i = Wi(n),
      a = kt(n, u),
      o = [ze(e, t, r), D([i ? D(s, { shouldBreak: !0 }) : a ? D(s) : s, u])];
  ...
  function Cl(e, t) {
    if (
      we(e.originalText, t) ||
      (A(t, x.Leading, (r) => Te(e.originalText, j(r), I(r))) && !U(t))
    )
      return !0;
    if (jt(t)) {
      let r = t,
  ...
  function zi(e, t, r, n = {}) {
    ...
    (function g() {
      ...
      o &&
        (a ||
          (a =
            (S.returnType && $(S).length > 0) ||
            S.typeParameters ||
            $(S).some((O) => O.type !== "Identifier"))),
    ...
    return (
      o &&
        (y || n.assignmentLayout) &&
        ((h = !0),
        (l = n.assignmentLayout === "chain-tail-arrow-chain" || (y && !m))),
      (u = xl(e, t, n, {
        bodyDoc: u,
        bodyComments: i,
        functionBody: p,
      ...
      D([
        D(h ? E([F, f]) : f, { shouldBreak: l, id: c }),
        " =>",
        o ? Ct(u, { groupId: c }) : D(u),
        o && y ? b(F, "", { groupId: c }) : "",
      ])
    );
  }
  ...
  function dl(e, t, r) {
    ...
    return (
      ...
      (((n = t.label) == null ? void 0 : n.hug) !== !1 &&
        (((s = t.label) == null ? void 0 : s.embed) || Or(e, r.originalText)))
    );
  }
  function Tl(e, t, { signatureDocs: r, shouldBreak: n }) {
    ...
    return (u !== "callee" && pt(s)) || me(s)
      ? D([r[0], " =>", E([d, P([" =>", d], r.slice(1))])], { shouldBreak: n })
      : (u === "callee" && pt(s)) || t.assignmentLayout
        ? D(P([" =>", d], r), { shouldBreak: n })
        : D(E(P([" =>", d], r)), { shouldBreak: n });
  }
  function xl(
    e,
    t,
    ...
    let { node: a, parent: o } = e,
      ...
      m =
        (r.expandLastArg || o.type === "JSXExpressionContainer") && !A(a)
          ? F
          : "";
    return i && Hi(u)
      ? [" ", D([b("", "("), E([F, n]), b("", ")"), p, m]), s]
    ...
    return (
      e.each(({ node: a }) => {
        a.type !== "EmptyStatement" &&
          (u.push(r()), a !== i && (u.push(C), fe(a, t) && u.push(C)));
      }, n),
      u
    );
  }
  ...
  function bs(e, t, r) {
    ...
    return (
      s &&
        ...
        (u || i) && (a.push(C), fe(v(!1, n.directives, -1), t) && a.push(C))),
  ...
  function ea(e, t, r) {
    ...
    return D(
      [
        "{",
        E([
          t.bracketSpacing ? d : F,
          D([
            r("typeParameter"),
            n.optional ? Ps(n.optional, "?") : "",
            n.typeAnnotation ? ": " : "",
            r("typeAnnotation"),
          ]),
          t.semi ? b(";") : "",
  ...
  function It(e, t, r, n) {
    ...
    let u = e.getNode(2),
      i = u && St(u),
      a = e.match(
        (m) => !(m[n].length === 1 && Le(m[n][0])),
        void 0,
        (m, y) => y === "typeAnnotation",
        (m) => m.type === "Identifier",
        Ts,
      );
    if (
      ...
      (!a &&
        (i ||
          (s[n].length === 1 &&
            (s[n][0].type === "NullableTypeAnnotation" || gs(s[n][0])))))
    )
  ...
  function gn(e, t, r) {
    ...
    if (s.type === "TSMappedType")
      return (
        s.readonly && u.push(Ps(s.readonly, "readonly"), " "),
        u.push("[", i),
  ...
  function hn(e, t, r) {
    ...
    if ((a.push(ks(e, t, r, "mixins"), ks(e, t, r, "implements")), u)) {
      let o;
      na(n) ? (o = [...i, E(a)]) : (o = E([...i, a])),
        s.push(D(o, { id: ra(n) }));
    } else s.push(...i, ...a);
    return s.push(" ", r("body")), s;
  }
  var ra = xn("heritageGroup");
  function Is(e) {
  ...
  function na(e) {
    return (
      e.typeParameters && !A(e.typeParameters, x.Trailing | x.Line) && !Pl(e)
    );
  }
  function ks(e, t, r, n) {
    let { node: s } = e;
    ...
    return [
      na(s) ? b(" ", d, { groupId: Er(s.typeParameters) }) : d,
      u,
      u && C,
      n,
      D(E([d, P([",", d], e.map(r, n))])),
  ...
  function Sn(e, t, r) {
    let { node: n } = e,
      s = [];
    return (
      L(n.decorators) && s.push(Cs(e, t, r)),
      s.push(Xt(n)),
  ...
  function Bn(e, t, r) {
    ...
    L(n.decorators) && s.push(Cs(e, t, r)),
      ...
      (n.type === "ClassAccessorProperty" ||
        ...
        s.push("accessor "),
      s.push(ft(e, t, r), V(e), Dn(e), Y(e, r));
    let i =
  ...
  function sa(e, t, r) {
    ...
    return (
      e.each(({ node: u, next: i, isLast: a }) => {
        s.push(r()),
          !t.semi && ta(u) && Il(u, i) && s.push(";"),
          a || (s.push(C), fe(u, t) && s.push(C));
      }, "body"),
      A(n, x.Dangling) && s.push(J(e, t)),
      [
        L(n.body) ? Is(e.parent) : "",
        "{",
        s.length > 0 ? [E([C, s]), C] : "",
        "}",
      ]
  ...
  function ia(e, t) {
    ...
    return Be(e, t) ? !0 : jt(r) ? e.call(() => ia(e, t), ...Lr(r)) : !1;
  }
  ...
  function aa(e, t, r) {
    ...
    return (
      Os(e, t)
        ? ws(e.node.expression) && n.push(";")
        : Ls(e, t) || (t.semi && n.push(";")),
      n
    );
  }
  function oa(e, t, r) {
  ...
  function Pn(e, t, r) {
    ...
    return (
      A(n, x.Dangling) && (s.push(" ", J(e, t)), vr(n) && s.push(C)),
      u
  ...
  function Ea(e, t) {
    return e.type !== "ImportDeclaration" ||
      ...
      e.importKind === "type"
      ? !0
      : Fr(t, j(e), j(e.source)).trimEnd().endsWith("from");
  }
  function Ml(e, t) {
    var n, s;
    ...
    let r = Fr(
      t,
      I(e.source),
      (s = e.attributes) != null && s[0] ? j(e.attributes[0]) : I(e),
    ).trimStart();
    return r.startsWith("assert")
      ? "assert"
      : r.startsWith("with") || L(e.attributes)
        ? "with"
        : void 0;
  }
  function Fa(e, t, r) {
  ...
  function Ca(e, t, r) {
    ...
    return (
      ...
      p && !jl(n) && (y = r(a)),
      [
        vs(s === "ImportSpecifier" ? n.importKind : n.exportKind, !1),
        m,
        m && y ? " as " : "",
        y,
      ]
  ...
  function Tt(e, t, r) {
    ...
    let o = a.flatMap((T) =>
      e.map(({ node: W }) => ({ node: W, printed: r(), loc: j(W) }), T),
    );
      ...
      S = o.map((T) => {
        ...
        return (
          ...
          (T.node.type === "TSPropertySignature" ||
            ...
            A(T.node, x.PrettierIgnore) &&
            g.shift(),
          fe(T.node, t) && g.push(C),
          W
        );
      });
    if (s.inexact || s.hasUnknownMembers) {
      ...
      if (A(s, x.Dangling)) {
        ...
        T = [
          J(e, t),
          W || Z(t.originalText, I(v(!1, ot(s), -1))) ? C : d,
          "...",
        ];
      } else T = ["..."];
      S.push([...g, ...T]);
    ...
    if (S.length === 0) {
      ...
      R = [
        y && L(s.properties) ? Is(p) : "",
        l,
        E([t.bracketSpacing ? d : F, ...S]),
        b(O && (f !== "," || ye(t)) ? f : ""),
        t.bracketSpacing ? d : F,
        h,
        V(e),
    ...
    return e.match((T) => T.type === "ObjectPattern" && !L(T.decorators), Ms) ||
      (Le(s) &&
        (e.match(
          void 0,
          (T, W) => W === "typeAnnotation",
          (T, W) => W === "typeAnnotation",
          Ms,
        ) ||
          e.match(
            void 0,
            (T, W) => T.type === "FunctionTypeParam" && W === "typeAnnotation",
            Ms,
          ))) ||
      (!c &&
        e.match(
    ...
    if (s && (U(n[a[0]]) || U(o) || U(p) || Rl(O))) {
      ...
      m.push(
        c.type !== n.type || c[i] === n || f
          ...
          : t.useTabs
            ? Jr(E(ue))
            : ge(Math.max(0, t.tabWidth - 2), ue),
      );
    }
    let R = [u, i, ...a].some((X) =>
        A(n[X], (ue) => ee(ue) && Te(t.originalText, j(ue), I(ue))),
      ),
      _ = (X) => (c === B ? D(X, { shouldBreak: R }) : R ? [X, Ee] : X),
      T =
        !y &&
        (q(c) || (c.type === "NGPipeExpression" && c.left === n)) &&
        !c.computed,
      W = Wl(e),
  ...
  function Gl(e, t, r, n) {
    return [...e.map((u) => ot(u)), ot(t), ot(r)]
      .flat()
      .some((u) => ee(u) && Te(n.originalText, j(u), I(u)));
  }
  var Ul = new Map([
    ["AssignmentExpression", "right"],
    ["VariableDeclarator", "init"],
  ...
  function $t(e, t, r, n) {
    ...
    let { node: s } = e,
      ...
      T,
      W = 0;
    do (T = _ || s), (_ = e.getParentNode(W)), W++;
    ...
    let Fe = _ || f,
      X =
        ...
        (f.type === "AssignmentExpression" ||
          ...
          f.type === "Property"),
      ue =
        (f.type === "ReturnStatement" || f.type === "ThrowStatement") &&
        !(S || B),
      z =
        u &&
    ...
    A(s.test, x.Dangling) &&
      ...
      A(s, x.Dangling) && Kt.push(J(e, t));
    let Ws = Symbol("test"),
      wa = Symbol("consequent"),
      Ar = Symbol("test-and-consequent"),
      Oa = u
        ? [js(r("test")), s.test.type === "ConditionalExpression" ? Ee : ""]
        : [
            r("checkType"),
            " ",
            "extends",
      ...
      Ns = D([Oa, " ?"], { id: Ws }),
      va = r(a),
      dr = E([S || (z && (U(m) || l || O)) ? C : d, qs, va]),
      _a = xt
        ? D([Ns, O ? dr : b(dr, D(dr, { id: wa }), { groupId: Ws })], {
            id: Ar,
          })
        : [Ns, dr],
      On = r(o),
      Gs = je ? b(On, Jr(js(On)), { groupId: Ar }) : On,
      zt = [
        _a,
        Kt.length > 0
          ? [E([C, Kt]), C]
  ...
  function da(e, t, r, n) {
    ...
    switch (s.type) {
      ...
      case "BindExpression":
        return (
          s.object && i.push(r("object")), i.push(D(E([F, zr(e, t, r)]))), i
        );
      case "Identifier":
        return [s.name, V(e), Dn(e), Y(e, r)];
      ...
      case "IfStatement": {
        ...
        if ((i.push(o), s.alternate)) {
          let p = A(s.consequent, x.Trailing | x.Line) || vr(s),
        ...
        return !s.init && !s.test && !s.update
          ...
          : [
              ...
              D([
                "for (",
                D([
                  E([F, r("init"), ";", d, r("test"), ";", d, r("update")]),
                  F,
                ]),
                ")",
                a,
      ...
      case "CatchClause":
        if (s.param) {
          let a = A(
              ...
              (p) =>
                !ee(p) ||
                (p.leading && Z(t.originalText, I(p))) ||
                (p.trailing && Z(t.originalText, j(p), { backwards: !0 })),
            ),
            o = r("param");
          return [
            "catch ",
  ...
  function kn(e, t, r) {
    ...
    return (u === "callee" && w(n)) || (u === "object" && q(n))
      ? D([E([F, ...i]), F])
      : i;
  }
  function Ta(e, t, r) {
  ...
  function Ln(e, t, r) {
    ...
    return [
      ...
      t("id"),
      " ",
      n.type === "TSEnumDeclaration" ? Ta(e, t, r) : t("body"),
    ];
  }
  function wn(e, t, r) {
    let { node: n } = e,
    ...
    return (
      L(n.extends) &&
        i.push(
          a ? b(" ", d, { groupId: Er(n.typeParameters) }) : d,
          "extends ",
          (n.extends.length === 1 ? du : E)(P([",", d], e.map(r, "extends"))),
        ),
      A(n.id, x.Trailing) || L(n.extends)
        ? a
          ? s.push(D([...u, E(i)]))
          : s.push(D(E([...u, ...i])))
        : s.push(...u, ...i),
  ...
  function ga(e, t, r) {
    ...
    switch (n.type) {
      ...
      case "Variance": {
        let { kind: u } = n;
        return fn.ok(u === "plus" || u === "minus"), u === "plus" ? "+" : "-";
      }
    ...
    switch (n.type) {
      ...
      case "TSImportType":
        return [
          ...
          It(e, t, r, n.typeArguments ? "typeArguments" : "typeParameters"),
        ];
      case "TSLiteralType":
        return r("literal");
      ...
      case "TSModuleDeclaration": {
        ...
        if (o) u.push(".");
          ...
          let y =
            n.kind ??
            (te(n.id) || Fr(t, j(n), j(n.id)).trim().endsWith("module")
              ? "module"
              : "namespace");
          u.push(y, " ");
        }
  ...
  var Lt = "JavaScript",
    ...
    La = em;
  var tm = { estree: Rs, "estree-json": Js },
    rm = [...$s, ...Ba];
  return Ga(nm);
});
