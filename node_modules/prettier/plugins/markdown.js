(function (n) {
  ...
  var Ne = (e, r, t) => (
    ...
    al = (e) => Pn(xr({}, "__esModule", { value: !0 }), e);
  var kr = C((Om, Ln) => {
    "use strict";
    Ln.exports = cl;
    function cl(e) {
  ...
  var Lu = C(($g, Pu) => {
    ...
    function gf(e, r) {
      ...
      c.push(["footnoteDefinition"]),
        t.inlineNotes && (xt(o, "reference", "inlineNote"), (u.inlineNote = m)),
        xt(i, "definition", "footnoteDefinition"),
        xt(o, "reference", "footnoteCall"),
        (a.definition = y),
      ...
      function p(b, g, A) {
        for (
          var x = this,
            ...
            Fe,
            z;
          q < w && ((S = g.charCodeAt(q)), !(S !== lr && S !== ze));
        ...
        if (g.charCodeAt(q++) === Me && g.charCodeAt(q++) === fr) {
          ...
          if (!(_ === void 0 || O === _ || g.charCodeAt(q++) !== Df)) {
            if (A) return !0;
            for (
              R = g.slice(O, _), P = b.now(), X = 0, K = 0, me = q, Fe = [];
              q < w;

            ) {
              if (((S = g.charCodeAt(q)), S !== S || S === Rr))
                (z = {
                  start: X,
                  contentStart: me || q,
                  contentEnd: q,
            ...
            for (
              q = -1, w = Fe.length;
              w > 0 && ((z = Fe[w - 1]), z.contentStart === z.contentEnd);
            ...
            for (ke = b(g.slice(0, z.contentEnd)); ++q < w; )
              (z = Fe[q]),
                (k[P.line + q] =
                  (k[P.line + q] || 0) + (z.contentStart - z.start)),
          ...
          for (R = k; k < E; ) {
            ...
            if (S === void 0)
              if (T === pf) k += 2;
                ...
                for (_ = k, S = 1; g.charCodeAt(_ + S) === Ur; ) S++;
                k += S;
              } else k++;
            else if (T === Ur) {
              for (_ = k, P = 1; g.charCodeAt(_ + P) === Ur; ) P++;
      ...
      function F(b, g, A) {
        ...
        if (
          (g.charCodeAt(x) === ff && x++,
          g.charCodeAt(x) === Me && g.charCodeAt(x + 1) !== fr)
        )
...
`)
  ...
  var Yu = C((Wg, Mu) => {
    ...
    function kf(e) {
      let r = this.Parser,
        t = this.Compiler;
      Iu.isRemarkParser(r) && wf(r, e), Iu.isRemarkCompiler(t) && Bf(t, e);
    }
    function wf(e, r) {
      let t = e.prototype,
        n = t.inlineMethods;
      ...
      function u(i, o, s) {
        let l = o.length,
          ...
          v;
        if (
          (o.charCodeAt(D) === Uu && ((f = !0), D++), o.charCodeAt(D) === Mr)
        ) {
          if ((D++, f))
...
`,
  ...
  var pr = C((lv, Si) => {
    ...
    function gD(e, r) {
      ...
      function K(Fe, z) {
        var lt = X();
        (lt.column += z), (lt.offset += z), i.call(l, ye[Fe], lt, Fe);
      }
      function me() {
        ...
        function A(E, k) {
          ...
          return (
            q &&
              ...
              Li(q) &&
              Li(E) &&
              ((T = E.type === "text" ? AD : xD), (E = T.call(a, q, E))),
            E !== q && w.push(E),
  ...
  var ca = C((yv, sa) => {
    ...
    function XD(e, r, t) {
      for (
        ...
        u < i && ((n = KD.exec(r.slice(u))), n != null);
...
`,
    ...
    function np(e, r, t) {
      ...
      if (i)
        return t
          ? !0
          : e(u)({ type: "code", lang: null, meta: null, value: ep(i) });
    }
  });
  var Fa = C((wv, ma) => {
    "use strict";
        ...
        if (((v = i), (c = r.charAt(i)), !(c !== up && c !== ha))) {
          ...
          if (!(s < ip)) {
            ...
            for (
              f = "", p = "";
              i < u &&
              ((c = r.charAt(i)), !(c === Hr || (l === ha && c === l)));

            )
              c === $e || c === dr ? (p += c) : ((f += p + c), (p = "")), i++;
            if (((c = r.charAt(i)), !(c && c !== Hr))) {
              if (t) return !0;
              (B = e.now()),
                (B.column += o.length),
                (B.offset += o.length),
  ...
  var $t = C((_v, Sa) => {
    ...
    function xp(e) {
      for (
        ...
        for (
          u = n === Ta ? Ap : yp, t += u, u > 1 && (t = Math.floor(t / u) * u);
          i < t;
      ...
      if (
        ...
        for (s = 0, x = [], E = [], k = []; s < l; ) {
          for (
            ...
            if (((p = r.charAt(s)), p === Xr)) f += Ae - (f % Ae);
            else if (p === de) f++;
            else break;
            s++;
          }
          if (
            (w && f >= w.indent && (P = !0), (p = r.charAt(s)), (v = null), !P)
          ) {
            if (p === jt || p === Ia || p === Wt) (v = p), s++, f++;
            else {
            ...
            if (v)
              if (((p = r.charAt(s)), p === Xr)) (f += Ae - (f % Ae)), s++;
              else if (p === de) {
          ...
          if (((g = A), (A = !y && !_p(B).length), P && w))
            ...
            k.length !== 0 &&
              ((R = !0), w.value.push(""), (w.trail = k.concat())),
              (w = { value: [b], indent: f, trail: [] }),
              x.push(w),
              (E = E.concat(k, b)),
              (k = []);
          else if (A) {
    ...
    function Id(e, r, t) {
      ...
      if (((f = r.charAt(u)), f === Zt)) {
        ...
        if (!(!c || r.charAt(u) !== gr || r.charAt(u + 1) !== ro)) {
          for (
            h = c, o += c + gr + ro, u = o.length, c = "";
            u < i && ((f = r.charAt(u)), !(f !== Jr && f !== Qr && f !== We));

          )
            (o += f), u++;
          if (((f = r.charAt(u)), (c = ""), (s = o), f === to)) {
            for (u++; u < i && ((f = r.charAt(u)), !!Qt(f)); ) (c += f), u++;
            if (((f = r.charAt(u)), f === Qt.delimiter)) (o += to + c + f), u++;
            else {
              if (a) return;
              (u -= c.length + 1), (c = "");
            }
          ...
          if (c) {
            ...
            for (; u < i && ((f = r.charAt(u)), !(f !== Jr && f !== Qr)); )
              (o += f), u++;
    ...
    function cn(e, r, t) {
      ...
      if (a) {
        ...
        if (
          ...
          for (
            m = D, h = D;
            D < i && ((d = r.charCodeAt(D)), !(f0(d) || d === b0));
              ...
              t
                ...
                : ((D = n.enterLink()),
                  ...
                  e(c)({
                    type: "link",
                    title: null,
                    url: "mailto:" + S0(c, { nonTerminated: !1 }),
                    children: f,
                  }))
            );
        }
          ...
          if (r.charAt(u) === Cr)
            return t
              ...
              : ((a += Cr),
                ...
                (w = { type: F ? "image" : "link", title: b || null, url: x }),
                F
                  ? (w.alt = n.decode.raw(n.unescape(y), E) || null)
                  : ((k = n.enterLink()),
                    (w.children = n.tokenizeInline(y, E)),
                    k()),
                e(a)(w));
        }
      }
  ...
  var ts = C((rE, rs) => {
    ...
    function es(e, r, t) {
      var n = this,
        ...
        y,
        v;
      if ((u === rh && ((c = Q0), (l = u), (u = r.charAt(++i))), u === tt)) {
        for (i++, l += u, F = "", v = 0; i < o; ) {
          if (((u = r.charAt(i)), u === tt)) (y = !0), v++;
          else if (u === ut) {
            if (!v) break;
            v--;
          }
        ...
        if (((s = F), (D = F), (u = r.charAt(i)), u === ut)) {
          if ((i++, (s += u), (F = ""), !a))
            for (; i < o && ((u = r.charAt(i)), !!K0(u)); ) (F += u), i++;
          if (((u = r.charAt(i)), u === tt)) {
            for (
              h = "", F += u, i++;
              i < o && ((u = r.charAt(i)), !(u === tt || u === ut));

            )
              u === nt && ((h += nt), (u = r.charAt(++i))), (h += u), i++;
            (u = r.charAt(i)),
              u === ut ? ((f = h ? Fn : eh), (F += h + u), i++) : (h = ""),
              (s += F),
              (F = "");
          } else {
            if (!D) return;
    ...
    function bs(e, r, t) {
      ...
      if (
        ...
        for (
          ...
          if (((a = r.charAt(s)), a === it && u === it && (!i || !Es(i))))
            return t
              ? !0
              : e(Cs + o + Cs)({
                  type: "delete",
...
`,
  ...
  var zs = C((dE, Us) => {
    ...
    function Ns(e, r) {
      (this.file = r),
        (this.offset = {}),
        (this.options = wh(this.options)),
        this.setOptions({}),
        (this.inList = !1),
        (this.inBlock = !1),
        (this.inLink = !1),
        (this.atStart = !0),
        (this.toOffset = Bh(r).toOffset),
        (this.unescape = qh(this, "escape")),
        (this.decode = Th(this));
    }
    var U = Ns.prototype;
    U.setOptions = $i();
              ...
              o !== a &&
                (c && a && (Js(a) || (u = Xs(a)))
                  ? (u
                      ? ((u = !1), (i = n && Xs(n) ? n : []))
                      : (i = n && Js(n) ? n : {}),
                    Qs(o, { name: t, newValue: e(c, i, a) }))
                  : typeof a < "u" && Qs(o, { name: t, newValue: a }));
      return o;
    };
  });
  var uc = C((vE, nc) => {
    ...
    function cc() {
      ...
      function t() {
        ...
        function o(s) {
          ...
          (u = f),
            l ? sc(l, o).apply(null, u) : i.apply(null, [null].concat(u));
        }
      }
      function n(a) {
  ...
  var hc = C((bE, dc) => {
    ...
    function Ih(e) {
      return !e || typeof e != "object"
        ? ""
        : Ke.call(e, "position") || Ke.call(e, "type")
          ? Dc(e.position)
          : Ke.call(e, "start") || Ke.call(e, "end")
            ? Dc(e)
            : Ke.call(e, "line") || Ke.call(e, "column")
              ? yn(e)
              : "";
    }
    function yn(e) {
      return (
        (!e || typeof e != "object") && (e = {}),
        pc(e.line) + ":" + pc(e.column)
      );
    }
    function Dc(e) {
      return (
        (!e || typeof e != "object") && (e = {}), yn(e.start) + "-" + yn(e.end)
      );
    }
    function pc(e) {
  ...
  var Ac = C((kE, yc) => {
    ...
    Object.defineProperty(he.prototype, "path", { get: Kh, set: Xh });
    Object.defineProperty(he.prototype, "dirname", { get: Jh, set: Qh });
    Object.defineProperty(he.prototype, "basename", { get: Zh, set: em });
    Object.defineProperty(he.prototype, "extname", { get: rm, set: tm });
    Object.defineProperty(he.prototype, "stem", { get: nm, set: um });
    function he(e) {
      var r, t;
      if (!e) e = {};
      else if (typeof e == "string" || Wh(e)) e = { contents: e };
    ...
    function em(e) {
      wn(e, "basename"),
        kn(e, "basename"),
        (this.path = ue.join(this.dirname || "", e));
    }
    function rm() {
    ...
    function nm() {
      return typeof this.path == "string"
        ? ue.basename(this.path, this.extname)
        : void 0;
    }
    function um(e) {
      wn(e, "stem"),
        kn(e, "stem"),
        (this.path = ue.join(this.dirname || "", e + (this.extname || "")));
    }
    function im(e) {
  ...
  var kc = C((wE, xc) => {
    ...
    var am = gc(),
      st = Ac();
    xc.exports = st;
    st.prototype.message = om;
    st.prototype.info = cm;
    st.prototype.fail = sm;
    function om(e, r, t) {
      var n = new am(e, r, t);
      return (
        this.path &&
  ...
  var Nc = C((qE, Ic) => {
    ...
    function Lc() {
        ...
        function B(g) {
          ...
          if (g != null)
            if (typeof g == "object" && "length" in g)
              for (; ++A < g.length; ) v(g[A]);
            else throw new Error("Expected a list of plugins, not `" + g + "`");
        }
        function b(g, A) {
          var x = l(g);
          x
            ? (Tc(x[1]) && Tc(A) && (A = ct(!0, x[1], A)), (x[1] = A))
            : e.push(fm.call(arguments));
        }
      }
      function l(m) {
      ...
      function c(m) {
        ...
        return (
          ...
          (y = u.Parser),
          Bn("parse", y),
          Sc(y, "parse") ? new y(String(F), F).parse() : y(String(F), F)
        );
      }
      function f(m, F, y) {
        if (
      ...
      function h(m, F) {
        ...
        return (
          ...
          qn("stringify", v),
          _c(m),
          Sc(v, "compile") ? new v(m, y).compile() : v(m, y)
        );
      }
      function p(m, F) {
      ...
      function d(m) {
        ...
        return (
          i(),
          Bn("processSync", u.Parser),
          qn("processSync", u.Compiler),
          (F = Ar(m)),
          p(F, v),
          Oc("processSync", "process", y),
          F
        );
        function v(B) {
          (y = !0), qc(B);
    ...
    function Sc(e, r) {
      return (
        typeof e == "function" &&
        e.prototype &&
        (Fm(e.prototype) || r in e.prototype)
      );
    }
    function Fm(e) {
      var r;
  ...
  var ie = "string",
    ...
    le = "label",
    ee = "break-parent",
    wr = new Set([ge, Q, Z, ae, j, W, H, oe, se, ce, $, le, ee]);
  function ll(e) {
...
Expected it to be ${n}.`;
  ...
  function qr(e) {
    return Br(e), { type: W, parts: e };
  }
  function Un(e, r = "", t = {}) {
    return (
      Be(e),
      r !== "" && Be(r),
      { type: H, breakContents: e, flatContents: r, groupId: t.groupId }
    );
  }
  var Ze = { type: ee };
  var Re = { type: $, hard: !0 },
    dl = { type: $, hard: !0, literal: !0 },
    Tr = { type: $ },
    er = { type: $, soft: !0 },
    L = [Re, Ze],
    rr = [dl, Ze];
...
`;
  ...
  function Xn(e) {
    return Hn(e, (r) =>
      Array.isArray(r) ? jn(r) : r.parts ? { ...r, parts: jn(r.parts) } : r,
    );
  }
  function Ee(e, r = rr) {
    return Hn(e, (t) =>
...
`,
          ...
          switch (h) {
            ...
            case V: {
              ...
              let d = { ind: D, mode: re, doc: p.contents },
                m = n - u,
                F = l.length > 0;
              if (!p.break && Sr(d, i, m, F, t)) i.push(d);
              ...
              } else i.push({ ind: D, mode: V, doc: p.contents });
              break;
            }
          }
        ...
        case W: {
          ...
          if (m.length === 0) break;
          let [F, y] = m,
            v = { ind: D, mode: re, doc: F },
            B = { ind: D, mode: V, doc: F },
            b = Sr(v, [], d, l.length > 0, t, !0);
          if (m.length === 1) {
            b ? i.push(v) : i.push(B);
            break;
          }
          let g = { ind: D, mode: re, doc: y },
            A = { ind: D, mode: V, doc: y };
          if (m.length === 2) {
            b ? i.push(g, v) : i.push(A, B);
            break;
          }
          m.splice(0, 2);
          let x = { ind: D, mode: h, doc: qr(m) },
            E = m[0];
          Sr({ ind: D, mode: re, doc: [F, y, E] }, [], d, l.length > 0, t, !0)
            ? i.push(x, g, v)
            : b
              ? i.push(x, A, v)
              : i.push(x, A, B);
            ...
            case V:
              ...
              p.literal
                ? D.root
                  ...
                  : (o.push(a), (u = 0))
                : ((u -= pt(o)), o.push(a + D.value), (u = D.length));
              break;
          }
          break;
        case le:
...
`,
    ...
    if (
      ((e.type === "definition" || e.type === "link" || e.type === "image") &&
        e.title &&
        (r.title = N(!1, e.title, /\\(?=["')])/g, "")),
      (t == null ? void 0 : t.type) === "root" &&
        t.children.length > 0 &&
        (t.children[0] === e || (nu(t.children[0]) && t.children[1] === e)) &&
        e.type === "html" &&
        ht(e.value))
    )
      return null;
  ...
  var cu = su;
  var lu =
      /(?:[\u02ea-\u02eb\u1100-\u11ff\u2e80-\u2e99\u2e9b-\u2ef3\u2f00-\u2fd5\u2ff0-\u303f\u3041-\u3096\u3099-\u309f\u30a1-\u30fa\u30fc-\u30ff\u3105-\u312f\u3131-\u318e\u3190-\u4dbf\u4e00-\u9fff\ua700-\ua707\ua960-\ua97c\uac00-\ud7a3\ud7b0-\ud7c6\ud7cb-\ud7fb\uf900-\ufa6d\ufa70-\ufad9\ufe10-\ufe1f\ufe30-\ufe6f\uff00-\uffef]|[\ud840-\ud868\ud86a-\ud86c\ud86f-\ud872\ud874-\ud879\ud880-\ud883\ud885-\ud887][\udc00-\udfff]|\ud81b[\udfe3]|\ud82b[\udff0-\udff3\udff5-\udffb\udffd-\udffe]|\ud82c[\udc00-\udd22\udd32\udd50-\udd52\udd55\udd64-\udd67]|\ud83c[\ude00\ude50-\ude51]|\ud869[\udc00-\udedf\udf00-\udfff]|\ud86d[\udc00-\udf39\udf40-\udfff]|\ud86e[\udc00-\udc1d\udc20-\udfff]|\ud873[\udc00-\udea1\udeb0-\udfff]|\ud87a[\udc00-\udfe0]|\ud87e[\udc00-\ude1d]|\ud884[\udc00-\udf4a\udf50-\udfff]|\ud888[\udc00-\udfaf])(?:[\ufe00-\ufe0f]|\udb40[\udd00-\uddef])?/,
    fu =
  ...
  var mt = new Set([
    ...
    Pr = new Set([...mt, "tableCell", "paragraph", "heading"]),
    Oe = "non-cjk",
    De = "cj-letter",
    Ce = "k-letter",
    or = "cjk-punctuation";
...
`)
  ...
  function Vl(e, r) {
    ...
    function n(a) {
      ...
      return s !== l
        ...
        : s % r.tabWidth === 0
          ? !0
          : Ue(i, r.originalText).leadingSpaces.length > 1;
    }
  }
  var Eu = Nl;
  ...
  function Hl(e, r) {
    ...
    let a = t.kind,
      u = n.kind;
    return (yu(a) && yu(u)) || (a === Ce && u === De) || (u === Ce && a === De)
      ? !0
      : a === or || u === or || (a === De && u === De)
        ? !1
        : Cu.has(n.value[0]) || Cu.has(M(!1, t.value, -1))
          ? !0
    ...
    return !(
      (r === "" &&
        (((u == null ? void 0 : u.kind) === Ce &&
          bu(i == null ? void 0 : i.kind)) ||
          ((i == null ? void 0 : i.kind) === Ce &&
            bu(u == null ? void 0 : u.kind)))) ||
      (!a && ((i && jl.has(i.value[0])) || (u && $l.has(M(!1, u.value, -1)))))
    );
  }
  function vt(e, r, t, n) {
    if (
  ...
  function Jl(e, r, t) {
    ...
    if (uf(e))
      return Lr(
        ...
        o.type === "word" ? o.value : vt(e, o.value, r.proseWrap, !0),
      );
    switch (n.type) {
      case "front-matter":
      ...
      case "paragraph":
        return Y(e, r, t, { postprocessor: qr });
      case "sentence":
        return Y(e, r, t);
      case "word": {
        let o = N(
            ...
            N(!1, n.value, "*", "\\*"),
            new RegExp(
              [`(^|${Te.source})(_+)`, `(_+)(${Te.source}|$)`].join("|"),
              "g",
            ),
            (c, f, D, h, p) => N(!1, D ? `${f}${D}` : `${h}${p}`, "_", "\\_"),
          ),
      ...
      case "emphasis": {
        let o;
        if (Ft(n.children[0])) o = r.originalText[n.position.start.offset];
        else {
          let { previous: s, next: l } = e;
          o =
            ((s == null ? void 0 : s.type) === "sentence" &&
              ((a = M(!1, s.children, -1)) == null ? void 0 : a.type) ===
                "word" &&
              !M(!1, s.children, -1).hasTrailingPunctuation) ||
            ((l == null ? void 0 : l.type) === "sentence" &&
              ((u = l.children[0]) == null ? void 0 : u.type) === "word" &&
...
`,
          ...
          case "<": {
            ...
            return [
              ...
              r.originalText.slice(
                ...
                n.position.start.offset + 1 + o.length,
              ) !== o
                ? n.url.slice(o.length)
                : n.url,
              ">",
            ];
          }
          case "[":
            return ["[", Y(e, r, t), "](", Et(n.url, ")"), Nr(n.title, r), ")"];
          default:
            return r.originalText.slice(
              n.position.start.offset,
              n.position.end.offset,
      ...
      case "image":
        return ["![", n.alt || "", "](", Et(n.url, ")"), Nr(n.title, r), ")"];
      case "blockquote":
        return ["> ", ve("> ", Y(e, r, t))];
      case "heading":
      ...
      case "code": {
        ...
        let o = r.__inJsTemplate ? "~" : "`",
          s = o.repeat(Math.max(3, _r(n.value, o) + 1));
        return [
          s,
          n.lang || "",
          n.meta ? " " + n.meta : "",
          L,
          Ee(Ir(n, r.originalText), L),
          L,
          s,
        ];
      }
      ...
      case "list": {
        ...
        return Y(e, r, t, {
          processor(l) {
            ...
            function D() {
              let h = n.ordered
                ? (l.isFirst ? n.start : s ? 1 : n.start + l.index) +
                  (o % 2 === 0 ? ". " : ") ")
                : o % 2 === 0
                  ? "- "
                  : "* ";
      ...
      case "definition": {
        let o = r.proseWrap === "always" ? Tr : " ";
        return Qe([
          Ct(n),
          ":",
          Je([o, Et(n.url), n.title === null ? "" : [o, Nr(n.title, r, !1)]]),
        ]);
      }
      case "footnote":
        return ["[^", Y(e, r, t), "]"];
          ...
          o
            ...
            : Qe([
                ve(
                  " ".repeat(4),
                  Y(e, r, t, {
                    processor: ({ isFirst: s }) => (s ? Qe([er, t()]) : t()),
                  }),
                ),
                ((i = e.next) == null ? void 0 : i.type) ===
                "footnoteDefinition"
                  ? er
                  : "",
              ]),
      ...
      case "tableCell":
        return Y(e, r, t);
      case "break":
        return /\s/.test(r.originalText[n.position.start.offset])
          ? ["  ", qe(rr)]
          : ["\\", L];
      case "liquidNode":
        return Ee(n.value, L);
  ...
  function Y(e, r, t, n = {}) {
    let { postprocessor: a = (o) => o, processor: u = () => t() } = n,
      i = [];
    return (
      e.each(() => {
        let o = u(e);
        o !== !1 &&
          (i.length > 0 &&
            tf(e) &&
            (i.push(L), (nf(e, r) || Bu(e)) && i.push(L), Bu(e) && i.push(L)),
          i.push(o));
      }, "children"),
      a(i)
    );
    ...
    if (e.type === "html")
      ...
      e.type === "esComment"
        ...
        : e.type === "paragraph" &&
          ...
          e.children[0].type === "esComment" &&
          (t = e.children[0]),
        t && (r = t.value.match(/^prettier-ignore(?:-(start|end))?$/));
    }
    return r ? r[1] || "next" : !1;
  }
...
`)
  ...
  function Et(e, r = []) {
    ...
    return new RegExp(t.map((n) => `\\${n}`).join("|")).test(e)
      ? `<${af(e, "<>")}>`
      : e;
  }
  function Nr(e, r, t = !0) {
  ...
  var lf = { proseWrap: yt.proseWrap, singleQuote: yt.singleQuote },
    Ou = lf;
  var _n = {};
  On(_n, { markdown: () => km, mdx: () => wm, remark: () => km });
  var Kc = Ne(Lu(), 1),
    Xc = Ne(Ku(), 1),
    Jc = Ne(Gs(), 1),
    Qc = Ne(Nc(), 1);
...
`,
  ...
  function ym() {
    return (e) =>
      be(e, (r, t, [n]) =>
        r.type !== "html" || Uc.test(r.value) || Pr.has(n.type)
          ? r
          : { ...r, type: "jsx" },
      );
  }
  ...
  function Zc({ isMDX: e }) {
    return (r) => {
      let t = (0, Qc.default)()
        .use(Jc.default, { commonmark: !0, ...(e && { blocks: [Rc] }) })
        .use(Kc.default)
        .use(Gc)
        .use(Xc.default)
        .use(e ? Vc : Hc)
  ...
  function Hc() {}
  var el = { astFormat: "mdast", hasPragma: iu, locStart: Se, locEnd: _e },
    km = { ...el, parse: Zc({ isMDX: !1 }) },
    wm = { ...el, parse: Zc({ isMDX: !0 }) };
  var Bm = { mdast: Su };
  return al(qm);
});
