(function (n) {
      ...
      if ((e && typeof e == "object") || typeof e == "function")
        for (let n of Pt(e))
          !Lt.call(r, n) &&
            ...
            Pe(r, n, {
              get: () => e[n],
              enumerable: !(s = Rt(e, n)) || s.enumerable,
            });
      return r;
    };
  var bt = (r) => Kt(Pe({}, "__esModule", { value: !0 }), r);
  var Lr = {};
  ze(Lr, { parsers: () => Qe });
  var Qe = {};
  ze(Qe, {
  ...
  var Ce = new O(-1, -1, f.Character, 0, ""),
    Be = class {
      ...
      scanToken() {
        ...
        switch (s) {
          case 46:
            return (
              this.advance(),
              K(this.peek) ? this.scanNumber(i) : tt(i, this.index, 46)
            );
          case 40:
          case 41:
          case 123:
      ...
      scanIdentifier() {
        ...
        return pr.indexOf(t) > -1 ? xr(e, this.index, t) : ur(e, this.index, t);
      }
      ...
      scanNumber(e) {
        ...
        for (this.advance(); ; ) {
          if (!K(this.peek))
            if (this.peek === 95) {
              if (
                !K(this.input.charCodeAt(this.index - 1)) ||
                !K(this.input.charCodeAt(this.index + 1))
              )
              ...
              if (
                (this.advance(), Sr(this.peek) && this.advance(), !K(this.peek))
              )
        ...
        s && (n = n.replace(/_/g, ""));
        let i = t ? wr(n) : parseFloat(n);
        return fr(e, this.index, i);
      }
      scanString() {
        let e = this.index,
          t = this.peek;
        ...
        for (; this.peek != t; )
          if (this.peek == 92) {
            ...
            } else (h = mr(this.peek)), this.advance();
        ...
        return this.advance(), dr(e, this.index, s + a);
      }
      scanQuestion(e) {
        this.advance();
        let t = "?";
  ...
  var U = class {
        ...
        if (this.consumeOptionalOperator("?")) {
          ...
          if (this.consumeOptionalCharacter(58)) n = this.parsePipe();
            ...
            this.error(
              ...
              (n = new $(this.span(e), this.sourceSpan(e)));
          }
          ...
          switch (t) {
            case "+":
              return (
                this.advance(),
                (s = this.parsePrefix()),
                B.createPlus(this.span(e), this.sourceSpan(e), s)
              );
            case "-":
              return (
                this.advance(),
                (s = this.parsePrefix()),
                B.createMinus(this.span(e), this.sourceSpan(e), s)
              );
            case "!":
              return (
                this.advance(),
                (s = this.parsePrefix()),
                new ee(this.span(e), this.sourceSpan(e), s)
              );
          }
        }
      ...
      parsePrimary() {
        ...
        if (this.consumeOptionalCharacter(40)) {
          ...
          if (this.next.isKeywordNull())
            return (
              this.advance(), new C(this.span(e), this.sourceSpan(e), null)
            );
          if (this.next.isKeywordUndefined())
            return (
              this.advance(), new C(this.span(e), this.sourceSpan(e), void 0)
            );
        ...
        if (s)
          this.consumeOptionalAssignment()
            ? (this.error("The '?.' operator cannot be used in the assignment"),
              (h = new $(this.span(t), this.sourceSpan(t))))
            : (h = new z(this.span(t), this.sourceSpan(t), a, e, i));
      ...
      parseKeyedReadOrWrite(e, t, s) {
        return this.withContext(pe.Writable, () => {
          ...
          if (
            (n instanceof $ && this.error("Key access cannot be empty"),
            this.rbracketsExpected--,
            this.expectCharacter(93),
            this.consumeOptionalOperator("="))
          )
            ...
            return s
              ...
              : new q(this.span(t), this.sourceSpan(t), e, n);
      ...
      skip() {
        ...
        for (
          ...
          (!(this.context & pe.Writable) || !e.isOperator("="));
  ...
  function lt(r) {
    return Oe(r, (e, t) => t.parseSimpleBinding(e, ...Ae));
  }
  function xt(r) {
  ...
  function St(r, e, t) {
    ...
    return {
      hasParens: (t ? s - 1 : s) !== 0,
      outerSpan: ct(t ? { start: n.start + 1, end: n.end - 1 } : n, e),
      innerSpan: ct(r, e),
    };
  }
  function mt(r) {
  ...
  function wt(r, e, t) {
    ...
    throw new Error(
      `Cannot find front char ${e} from index ${t} in ${JSON.stringify(r)}`,
    );
  }
  function yt(r, e, t) {
    let s = mt(e);
    ...
    throw new Error(
      `Cannot find character ${e} from index ${t} in ${JSON.stringify(r)}`,
    );
  }
  function Et(r) {
  ...
  var D = (r, e, t = !1) => {
    ...
    switch (s) {
      case "Unary": {
        let { operator: o, expr: u } = r,
          v = n(u);
        return a(
          "UnaryExpression",
          { prefix: !0, argument: v, operator: o },
          r.sourceSpan,
          { hasParentParens: t },
        );
      }
      case "Binary": {
        let { left: o, operation: u, right: v } = r,
          c = n(o),
          x = n(v);
        return a(
          u === "&&" || u === "||" || u === "??"
            ? "LogicalExpression"
            : "BinaryExpression",
          { left: c, right: x, operator: u },
          { start: E(c), end: S(x) },
          { hasParentParens: t },
        );
      }
      case "BindingPipe": {
        let { exp: o, name: u, args: v } = r,
          c = n(o),
          x = e.getCharacterIndex(/\S/, e.getCharacterIndex("|", S(c)) + 1),
          l = a("Identifier", { name: u }, { start: x, end: x + u.length }),
          p = v.map(n);
        return a(
          "NGPipeExpression",
          { left: c, right: l, arguments: p },
          { start: E(c), end: S(p.length === 0 ? l : Ne(!1, p, -1)) },
          { hasParentParens: t },
        );
      }
      case "Chain": {
      ...
      case "Comment": {
        let { value: o } = r;
        return a("CommentLine", { value: o }, r.sourceSpan, {
          processSpan: !1,
        });
      }
      case "Conditional": {
        let { condition: o, trueExp: u, falseExp: v } = r,
          c = n(o),
          x = n(u),
          l = n(v);
        return a(
          "ConditionalExpression",
          { test: c, consequent: x, alternate: l },
          { start: E(c), end: S(l) },
          { hasParentParens: t },
        );
      }
      ...
      case "SafeKeyedRead": {
        let o = s === "SafeKeyedRead",
          { key: u } = r,
          v = Object.prototype.hasOwnProperty.call(r, "receiver")
            ? r.receiver
            : r.obj,
          c = n(u);
        return h(
          v,
          c,
          { computed: !0, optional: o },
          { end: r.sourceSpan.end, hasParentParens: t },
        );
      }
      case "LiteralArray": {
        let { expressions: o } = r;
        return a("ArrayExpression", { elements: o.map(n) }, r.sourceSpan, {
          hasParentParens: t,
        });
      }
      case "LiteralMap": {
        let { keys: o, values: u } = r,
          v = u.map((x) => n(x)),
          c = o.map(({ key: x, quoted: l }, p) => {
            let k = v[p],
              m = E(k),
              N = S(k),
              ue = e.getCharacterIndex(
                /\S/,
                p === 0
                  ? r.sourceSpan.start + 1
                  : e.getCharacterIndex(",", S(v[p - 1])) + 1,
              ),
              It =
                m === ue
                  ? N
                  : e.getCharacterLastIndex(
                      /\S/,
                      e.getCharacterLastIndex(":", m - 1) - 1,
                    ) + 1,
              He = { start: ue, end: It },
              ge = l
                ? a("StringLiteral", { value: x }, He)
                : a("Identifier", { name: x }, He),
              kt = ge.end < ge.start || ue === m;
            return a(
              "ObjectProperty",
              { key: ge, value: k, shorthand: kt, computed: !1 },
              { start: E(ge), end: N },
            );
          });
        return a("ObjectExpression", { properties: c }, r.sourceSpan, {
          hasParentParens: t,
        });
      }
      case "LiteralPrimitive": {
        ...
        switch (typeof o) {
          ...
          case "number":
            return a("NumericLiteral", { value: o }, r.sourceSpan, {
              hasParentParens: t,
            });
          case "object":
            return a("NullLiteral", {}, r.sourceSpan, { hasParentParens: t });
          case "string":
            return a("StringLiteral", { value: o }, r.sourceSpan, {
              hasParentParens: t,
            });
          case "undefined":
          ...
          default:
            throw new Error(
              `Unexpected LiteralPrimitive value type ${typeof o}`,
            );
        }
      }
      case "Call":
      case "SafeCall": {
        ...
        return a(
          ...
          { start: E(x), end: r.sourceSpan.end },
          { hasParentParens: t },
        );
      }
      case "NonNullAssert": {
        ...
        return a(
          "TSNonNullExpression",
          { expression: u },
          { start: E(u), end: r.sourceSpan.end },
          { hasParentParens: t },
        );
      }
      case "PrefixNot": {
        ...
        return a(
          "UnaryExpression",
          { prefix: !0, operator: "!", argument: u },
          { start: r.sourceSpan.start, end: S(u) },
          { hasParentParens: t },
        );
      }
      case "PropertyRead":
      case "SafePropertyRead": {
        let o = s === "SafePropertyRead",
          ...
          x = a(
            "Identifier",
            { name: v },
            { start: c - v.length, end: c },
            g(u) ? { hasParentParens: t } : {},
          );
      ...
      case "KeyedWrite": {
        ...
        return a(
          ...
          { left: l, operator: "=", right: x },
          { start: E(l), end: S(x) },
          { hasParentParens: t },
        );
      }
      case "PropertyWrite": {
        let { receiver: o, name: u, value: v } = r,
          c = n(v),
          x =
            e.getCharacterLastIndex(
              /\S/,
              e.getCharacterLastIndex("=", E(c) - 1) - 1,
            ) + 1,
          l = a("Identifier", { name: u }, { start: x - u.length, end: x }),
          p = h(o, l, { computed: !1, optional: !1 });
        return a(
          "AssignmentExpression",
          { left: p, operator: "=", right: c },
          { start: E(p), end: S(c) },
          { hasParentParens: t },
        );
      }
    ...
    function h(o, u, v, { end: c = S(u), hasParentParens: x = !1 } = {}) {
      ...
      let l = n(o),
        p = d(l);
      return a(
        v.optional || p ? "OptionalMemberExpression" : "MemberExpression",
        {
          object: l,
          property: u,
          computed: v.computed,
          ...(v.optional ? { optional: !0 } : p ? { optional: !1 } : null),
        },
        { start: E(l), end: c },
        { hasParentParens: x },
      );
    ...
    function g(o) {
      return (
        o.sourceSpan.start >= o.sourceSpan.end ||
        /^\s+$/.test(e.text.slice(o.sourceSpan.start, o.sourceSpan.end))
      );
    }
    function d(o) {
      return (
  ...
  function $t(r, e) {
    ...
    for (let c = 0; c < n.length; c++) {
      ...
      if (a && E(a) && S(x) && x.value && x.value.source === a.key.source) {
        let l = d("NGMicrosyntaxKey", { name: x.key.source }, x.key.span),
          p = (N, ue) => ({ ...N, ...Ie({ start: N.start, end: ue }, e) }),
          k = (N) => ({ ...p(N, l.end), alias: l }),
          m = i.pop();
    ...
    return d(
      ...
      i.length === 0
        ? r[0].sourceSpan
        : { start: i[0].start, end: Ne(!1, i, -1).end },
    );
    function h(c, x) {
      if (E(c)) {
        let { key: l, value: p } = c;
        return p
          ? x === 0
            ? d(
                ...
                { expression: g(p.ast), alias: null },
                p.sourceSpan,
              )
            : d(
                "NGMicrosyntaxKeyedExpression",
                {
                  key: d("NGMicrosyntaxKey", { name: y(l.source) }, l.span),
                  expression: d(
                    "NGMicrosyntaxExpression",
                    { expression: g(p.ast), alias: null },
                    p.sourceSpan,
                ...
                { start: l.span.start, end: p.sourceSpan.end },
              )
          : d("NGMicrosyntaxKey", { name: y(l.source) }, l.span);
      } else {
        ...
        if (/^let\s$/.test(e.text.slice(p.start, p.start + 4))) {
          ...
          return d(
            "NGMicrosyntaxLet",
            {
              key: d("NGMicrosyntaxKey", { name: l.source }, l.span),
              value: m
                ? d("NGMicrosyntaxKey", { name: m.source }, m.span)
                : null,
            },
            { start: p.start, end: m ? m.span.end : l.span.end },
          );
        } else {
          let m = v(c);
          return d(
            "NGMicrosyntaxAs",
            {
              key: d("NGMicrosyntaxKey", { name: m.source }, m.span),
              alias: d("NGMicrosyntaxKey", { name: l.source }, l.span),
            },
            { start: m.span.start, end: l.span.end },
          );
        }
      }
    }
    ...
    function v(c) {
      if (!c.value || c.value.source !== Ge) return c.value;
  ...
  function Ve(r) {
    var s, n, i;
    let e = ((s = r.range) == null ? void 0 : s[0]) ?? r.start,
      t =
        (i =
          ((n = r.declaration) == null ? void 0 : n.decorators) ??
          r.decorators) == null
          ? void 0
          : i[0];
    return t ? Math.min(Ve(t), e) : e;
  }
  function Nt(r) {
    var e;
    return ((e = r.range) == null ? void 0 : e[1]) ?? r.end;
  }
  function Re(r) {
    return {
      astFormat: "estree",
      parse(e) {
        ...
        return {
          type: "NGRoot",
          node:
            r === We && t.type !== "NGChainedExpression"
