...
var ue = (t, e, s) => (
  ...
  hl(
    e || !t || !t.__esModule
      ? $r(s, "default", { value: t, enumerable: !0 })
      : s,
    t,
  )
);
...
var qe = y((Cv, so) => {
  ...
  var { SourceMapConsumer: qc, SourceMapGenerator: Lc } = ji(),
    { fileURLToPath: eo, pathToFileURL: Jt } = {},
    ...
    Ie = class {
      ...
      error(e, s, r, n = {}) {
        ...
        return (
          ...
          this.file &&
            (Jt && (i.input.url = Jt(this.file).toString()),
...
var D = y((B) => {
  ...
  var hx = (B.TAG = "tag"),
    dx = (B.STRING = "string"),
    mx = (B.SELECTOR = "selector"),
    yx = (B.ROOT = "root"),
    gx = (B.PSEUDO = "pseudo"),
    wx = (B.NESTING = "nesting"),
    vx = (B.ID = "id"),
    xx = (B.COMMENT = "comment"),
    _x = (B.COMBINATOR = "combinator"),
    bx = (B.CLASS = "class"),
    kx = (B.ATTRIBUTE = "attribute"),
    Ex = (B.UNIVERSAL = "universal");
});
var ar = y((or, ga) => {
  "use strict";
  or.__esModule = !0;
    ...
    for (
      ...
      switch (((r = s.charCodeAt(m)), r === _t && ((h = m), (d += 1)), r)) {
        ...
        case Td:
          ...
          do
            for (
              l = !1, n = s.indexOf(i, n + 1), n === -1 && _("quote", i), g = n;
              s.charCodeAt(g - 1) === Us;
  ...
  var vm = (function () {
    function t(e) {
      ...
      return (
        ...
        (this.current = s),
        this.lossy
          ? (this.tokens = (0, eu.default)({ safe: e.safe, css: e.css.trim() }))
    ...
    for (; u < i; ) {
      switch (((p = n.charCodeAt(u)), p === 10 && ((o = u), (a += 1)), p)) {
        ...
        case 34:
          ...
          do
            for (
              v = !1, l = n.indexOf(g, l + 1), l === -1 && K("quote", g), R = l;
              n.charCodeAt(R - 1) === 92;
        ...
        case 64:
          (Br.lastIndex = u + 1),
            Br.test(n),
            Br.lastIndex === 0 ? (l = n.length - 1) : (l = Br.lastIndex - 2),
...
`)),
              (h = x.length - 1),
              h > 0 ? ((_ = a + h), (w = l - x[h].length)) : ((_ = a), (w = o)),
...
var He = ml;
var yl = (t) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(t);
function gl(t) {
...
function fn(t, e, s) {
  ...
  if (
    ...
    t.type === "selector-combinator" && (e.value = E(!1, e.value, /\s+/g, " ")),
  ...
  let o = t.map(({ node: g, isLast: x, index: h }) => {
      ...
      if (!x && g.type === "value-comma_group" && te(g.groups)) {
        ...
        !w.source && w.close && (w = w.close),
          w.source && Ft(e.originalText, P(w)) && m.push(k);
      }
      return m;
    }, "groups"),
    a = Zn(r, n),
    ...
    p = u || a,
    l = L(
      [r.open ? s("open") : "", q([M, V(O, o)]), M, r.close ? s("close") : ""],
      { shouldBreak: f },
    );
  return p ? fe(l) : l;
}
...
function fc(t, e, s) {
  ...
  switch (r.type) {
    ...
    case "css-atrule": {
      ...
      return [
        "@",
        jr(r) || r.name.endsWith(":") || It(r) ? r.name : se(r.name),
        r.params
          ? [
              jr(r)
                ? ""
...
function Xu(t, e) {
  if (t && typeof t == "object")
    for (let s in t)
      s !== "parent" &&
        (Xu(t[s], e), s === "nodes" && ((t.group = Fr(vy(t, e))), delete t[s]));
  return t;
}
function xy(t, e) {
  ...
  if (t && typeof t == "object") {
    ...
    if (
      ...
      return n.startsWith("@") && n.endsWith(":")
        ...
        : t.mixin
          ? ((t.selector = ae(n, e)), t)
          : (el(t, e) && (t.isSCSSNesterProperty = !0), (t.selector = Z(n)), t);
    if (i.length > 0) {
      let a = i.match(Ey);
      a &&
        ((i = i.slice(0, a.index)),
...
function Qs(t, e, s) {
  ...
  try {
    ...
    throw typeof c != "number"
      ? o
      : sa(`${a}: ${u}`, { loc: { start: { line: c, column: f } }, cause: o });
  }
  return (
    (s.originalText = e),
    (i = nl(J(i, "css-"), s)),
