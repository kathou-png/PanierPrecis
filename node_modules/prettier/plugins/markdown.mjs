...
var C = (e, r) => () => (r || e((r = { exports: {} }).exports, r), r.exports),
  Pn = (e, r) => {
    for (var t in r) lt(e, t, { get: r[t], enumerable: !0 });
  },
  al = (e, r, t, n) => {
...
var Ne = (e, r, t) => (
  ...
  al(
    r || !e || !e.__esModule
      ? lt(t, "default", { value: e, enumerable: !0 })
      : t,
    e,
  )
);
  ...
  function gf(e, r) {
    ...
    function p(b, g, A) {
      ...
      if (g.charCodeAt(q++) === Me && g.charCodeAt(q++) === fr) {
        for (O = q; q < w; ) {
          if (
            ((S = g.charCodeAt(q)), S !== S || S === Nr || S === lr || S === ze)
          )
            return;
          if (S === At) {
            (_ = q), q++;
        ...
        if (!(_ === void 0 || O === _ || g.charCodeAt(q++) !== Df)) {
          ...
          for (
            ...
            if (((S = g.charCodeAt(q)), S !== S || S === Nr))
              (z = { start: X, contentStart: me || q, contentEnd: q, end: q }),
                Fe.push(z),
                S === Nr && ((X = q + 1), (K = 0), (me = void 0), (z.end = X));
            else if (K !== void 0)
              if (S === ze || S === lr)
                (K += S === ze ? 1 : Ur - (K % Ur)),
                  K > Ur && ((K = void 0), (me = q));
    ...
    function d(b, g, A) {
      ...
      if (g.charCodeAt(E++) === Me && g.charCodeAt(E++) === fr) {
        for (w = E; E < x; ) {
          if (
            ((T = g.charCodeAt(E)), T !== T || T === Nr || T === lr || T === ze)
          )
            return;
          if (T === At) {
            (q = E), E++;
    ...
    if (a) {
      ...
      if (((v = i), (c = r.charAt(i)), !(c !== up && c !== ha))) {
        ...
        if (!(s < ip)) {
          ...
          for (
            f = "", p = "";
            i < u && ((c = r.charAt(i)), !(c === Wr || (l === ha && c === l)));
    ...
    if (
      ...
      for (s = 0, x = [], E = [], k = []; s < l; ) {
        for (
          ...
          if (((p = r.charAt(s)), p === Kr)) f += Ae - (f % Ae);
          else if (p === de) f++;
          else break;
          s++;
        }
        if (
          ...
          if (v)
            if (((p = r.charAt(s)), p === Kr)) (f += Ae - (f % Ae)), s++;
            else if (p === de) {
    ...
    if (((f = r.charAt(u)), f === Zt)) {
      ...
      if (!(!c || r.charAt(u) !== gr || r.charAt(u + 1) !== ro)) {
        for (
          ...
          u < i && ((f = r.charAt(u)), !(f !== Xr && f !== Jr && f !== We));
        ...
        if (((c = r.charAt(i)), !(!o || c !== tn)))
          return t
            ...
            : ((l += o),
              ...
              f.offset++,
              s &&
                (l.slice(0, Zr).toLowerCase() === un
                  ? ((D = D.slice(Zr)), (f.column += Zr), (f.offset += Zr))
                  : (l = un + l)),
...
var $o = C((Jv, Go) => {
  ...
  function Vo(e, r, t) {
    ...
    if (
      !(r.charAt(0) !== R0 || a < 3) &&
      ((u = r.charAt(1)),
      !(!L0(u) && u !== U0 && u !== z0 && u !== M0) && ((i = r.match(N0)), !!i))
    )
      return t
        ? !0
        : ((i = i[0]),
    ...
    if ((u === rh && ((c = Q0), (l = u), (u = r.charAt(++i))), u === rt)) {
      ...
      if (((s = F), (D = F), (u = r.charAt(i)), u === nt)) {
        ...
        if (((u = r.charAt(i)), u === rt)) {
          for (
            h = "", F += u, i++;
            i < o && ((u = r.charAt(i)), !(u === rt || u === nt));

          )
            u === tt && ((h += tt), (u = r.charAt(++i))), (h += u), i++;
          (u = r.charAt(i)),
            u === nt ? ((f = h ? Fn : eh), (F += h + u), i++) : (h = ""),
            (s += F),
            (F = "");
        } else {
          if (!D) return;
    ...
    Js = function (r) {
      ...
      var t = at.call(r, "constructor"),
        n =
          ...
          at.call(r.constructor.prototype, "isPrototypeOf");
...
var hc = C((CE, dc) => {
  ...
  function yn(e) {
    return (
      (!e || typeof e != "object") && (e = {}), pc(e.line) + ":" + pc(e.column)
    );
  }
  function Dc(e) {
    return (
  ...
  function Lc() {
    ...
    function s(m) {
      ...
      function b(g, A) {
        var x = l(g);
        x
          ? (Tc(x[1]) && Tc(A) && (A = st(!0, x[1], A)), (x[1] = A))
...
`,
        ...
        switch (h) {
          ...
          case V: {
            ...
            let d = { ind: D, mode: re, doc: p.contents },
              m = n - u,
              F = l.length > 0;
            if (!p.break && Tr(d, i, m, F, t)) i.push(d);
      ...
      case W: {
        ...
        m.splice(0, 2);
        let x = { ind: D, mode: h, doc: Br(m) },
          E = m[0];
        Tr({ ind: D, mode: re, doc: [F, y, E] }, [], d, l.length > 0, t, !0)
          ? i.push(x, g, v)
          : b
            ? i.push(x, A, v)
            : i.push(x, A, B);
...
function Nl(e, r) {
  return (
    (e = Rl(e, r)), (e = zl(e)), (e = Yl(e, r)), (e = Vl(e, r)), (e = Ml(e)), e
  );
}
function Rl(e, r) {
  return be(e, (t) =>
...
`,
    ...
    case "definition": {
      ...
      return Qe([
        Ct(n),
        ":",
        Je([o, Et(n.url), n.title === null ? "" : [o, Ir(n.title, r, !1)]]),
      ]);
    }
    case "footnote":
      return ["[^", Y(e, r, t), "]"];
      ...
      return [
        ...
        o
          ...
          : Qe([
              ...
              ((i = e.next) == null ? void 0 : i.type) === "footnoteDefinition"
                ? er
                : "",
            ]),
      ];
...
function ym() {
  return (e) =>
    be(e, (r, t, [n]) =>
      r.type !== "html" || Uc.test(r.value) || Or.has(n.type)
        ? r
        : { ...r, type: "jsx" },
    );
}
