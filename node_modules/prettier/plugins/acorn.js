(function (n) {
  ...
  var Ae = (e, t, i) => (
    ...
    _i = (e) => et(ce({}, "__esModule", { value: !0 }), e);
  var Jt = Ee((Ys, qt) => {
    qt.exports = {};
  });
  var Ge = Ee(($s, Je) => {
    ...
    function Kt(e) {
      ...
      if (!t) {
        let i = e.tokTypes,
          ...
          o = new s("</tag", !1),
          u = new s("<tag>...</tag>", !0, !0),
          h = { tc_oTag: n, tc_cTag: o, tc_expr: u },
          l = {
    ...
    function us(e, t) {
      ...
      return class extends t {
            ...
            switch (m) {
              ...
              case 123:
                return this.pos === this.start
                  ? m === 60 && this.exprAllowed
                    ? (++this.pos, this.finishToken(n.jsxTagStart))
                    : this.getTokenFromCode(m)
                  : ((p += this.input.slice(d, this.pos)),
                    this.finishToken(n.jsxText, p));
              case 38:
                (p += this.input.slice(d, this.pos)),
                  (p += this.jsx_readEntity()),
                  (d = this.pos);
                break;
              case 62:
              case 125:
        ...
        jsx_readNewLine(p) {
          ...
          return (
            ++this.pos,
            d === 13 && this.input.charCodeAt(this.pos) === 10
              ? (++this.pos,
                (m = p
                  ? `
`
...
`))
        ...
        jsx_readString(p) {
          ...
          for (;;) {
            ...
            if (g === p) break;
            g === 38
              ? ((d += this.input.slice(m, this.pos)),
                (d += this.jsx_readEntity()),
                (m = this.pos))
              : x(g)
                ? ((d += this.input.slice(m, this.pos)),
                  (d += this.jsx_readNewLine(!1)),
                  (m = this.pos))
                : ++this.pos;
          }
          return (
            (d += this.input.slice(m, this.pos++)),
            this.finishToken(r.string, d)
          );
        }
        jsx_readEntity() {
          let p = "",
          ...
          for (; this.pos < this.input.length && d++ < 10; ) {
            if (((g = this.input[this.pos++]), g === ";")) {
              p[0] === "#"
                ? p[1] === "x"
                  ? ((p = p.substr(2)),
                    ns.test(p) && (m = String.fromCharCode(parseInt(p, 16))))
                  : ((p = p.substr(1)),
                    os.test(p) && (m = String.fromCharCode(parseInt(p, 10))))
                : (m = as[p]);
              break;
            }
            p += g;
        ...
        jsx_readWord() {
          let p,
            d = this.pos;
          do p = this.input.charCodeAt(++this.pos);
          while (B(p) || p === 45);
        ...
        jsx_parseIdentifier() {
          ...
          return (
            this.type === n.jsxName
              ? (p.name = this.value)
              : this.type.keyword
                ? (p.name = this.type.keyword)
                : this.unexpected(),
            this.next(),
            this.finishNode(p, "JSXIdentifier")
          );
        }
        ...
        jsx_parseElementName() {
          ...
          for (
            ...
            (g.object = m),
              ...
              (m = this.finishNode(g, "JSXMemberExpression"));
          }
          return m;
        }
        jsx_parseAttributeValue() {
          switch (this.type) {
            case r.braceL:
              ...
              return (
                p.expression.type === "JSXEmptyExpression" &&
                  this.raise(
                    p.start,
        ...
        jsx_parseExpressionContainer() {
          ...
          return (
            ...
            this.finishNode(p, "JSXExpressionContainer")
          );
        }
        jsx_parseAttribute() {
          let p = this.startNode();
          return this.eat(r.braceL)
            ? (this.expect(r.ellipsis),
              (p.argument = this.parseMaybeAssign()),
              this.expect(r.braceR),
              this.finishNode(p, "JSXSpreadAttribute"))
            : ((p.name = this.jsx_parseNamespacedName()),
              (p.value = this.eat(r.eq)
                ? this.jsx_parseAttributeValue()
                : null),
              this.finishNode(p, "JSXAttribute"));
        }
        jsx_parseOpeningElementAt(p, d) {
          ...
          return (
            (m.selfClosing = this.eat(r.slash)),
            this.expect(n.jsxTagEnd),
            this.finishNode(m, g ? "JSXOpeningElement" : "JSXOpeningFragment")
          );
        }
        jsx_parseClosingElementAt(p, d) {
          ...
          return (
            g && (m.name = g),
            this.expect(n.jsxTagEnd),
            this.finishNode(m, g ? "JSXClosingElement" : "JSXClosingFragment")
          );
        }
        jsx_parseElementAt(p, d) {
          ...
          let we = E.name ? "Element" : "Fragment";
          return (
            (m["opening" + we] = E),
            (m["closing" + we] = pe),
            (m.children = g),
...
`;
      ...
      for (; (n = ei.exec(e)); ) {
        ...
        typeof s[n[1]] == "string" || Array.isArray(s[n[1]])
          ? (s[n[1]] = si.concat(s[n[1]], o))
          : (s[n[1]] = o);
      }
          ...
          : e < 91
            ...
            : e < 97
              ...
              : e < 123
                ? !0
                : e <= 65535
                  ? e >= 170 && Ai.test(String.fromCharCode(e))
                  : t === !1
                    ? !1
                    : Ve(e, nt) || Ve(e, Ci);
  }
...
Defaulting to 2020, but this will stop working in the future.`)),
  ...
  function Ri(e, t) {
    return function (i, s, r, n, o, u) {
      ...
      e.locations && (h.loc = new xe(this, o, u)),
  ...
  var fe = 0,
    ...
    T = function (t, i, s) {
      ...
      (this.reservedWordsStrict = G(n)),
        (this.reservedWordsStrictBind = G(n + " " + Pe.strictBind)),
        (this.input = String(i)),
        (this.containsEsc = !1),
        s
          ? ((this.pos = s),
...
`,
  ...
  f.parseStatement = function (e, t, i) {
    ...
    switch ((this.isLet(e) && ((s = a._var), (n = "let")), s)) {
      ...
      default:
        ...
        return s === a.name && x.type === "Identifier" && this.eat(a.colon)
          ? this.parseLabeledStatement(r, l, x, e)
          : this.parseExpressionStatement(r, x);
    }
  };
  ...
  f.parseFunction = function (e, t, i, s, r) {
    this.initFunction(e),
      (this.options.ecmaVersion >= 9 ||
        ...
        (this.type === a.star && t & Re && this.unexpected(),
  ...
  f.parseClassElement = function (e) {
    ...
    if (
      ...
      (this.eatContextual("get") || this.eatContextual("set")) &&
        (this.isClassElementNameStart() ? (o = h) : (s = h));
    }
    if (
      (s
        ? ((i.computed = !1),
      ...
      var l = !i.static && de(i, "constructor"),
        x = l && e;
      l &&
        o !== "method" &&
        this.raise(i.key.start, "Constructor can't have get/set modifier"),
        (i.kind = l ? "constructor" : o),
        this.parseClassMethod(i, r, n, x);
  ...
  f.parseImport = function (e) {
    return (
      this.next(),
      this.type === a.string
        ? ((e.specifiers = Di), (e.source = this.parseExprAtom()))
  ...
  a.backQuote.updateContext = function () {
    this.curContext() === C.q_tmpl
      ? this.context.pop()
      : this.context.push(C.q_tmpl),
      (this.exprAllowed = !1);
  };
  ...
  y.parseMaybeAssign = function (e, t, i) {
    ...
    if ((i && (l = i.call(this, l, u, h)), this.type.isAssign)) {
      ...
      return (
        ...
        (x.left = l),
        this.next(),
        (x.right = this.parseMaybeAssign(e)),
        o > -1 && (t.doubleProto = o),
        this.finishNode(x, "AssignmentExpression")
      );
    } else s && this.checkExpressionErrors(t, !0);
    return (
      r > -1 && (t.parenthesizedAssign = r), n > -1 && (t.trailingComma = n), l
    );
  };
  ...
  y.parseMaybeUnary = function (e, t, i, s) {
    ...
    if (this.isContextual("await") && this.canAwait)
      ...
      (u.operator = this.value),
        (u.prefix = !0),
        this.next(),
        (u.argument = this.parseMaybeUnary(null, !0, h, s)),
        ...
        h
          ...
          : this.strict &&
            ...
            : u.operator === "delete" && bt(u.argument)
              ? this.raiseRecoverable(
                  u.start,
                  "Private fields can not be deleted",
                )
              : (t = !0),
        (o = this.finishNode(u, h ? "UpdateExpression" : "UnaryExpression"));
  ...
  function bt(e) {
    return (
      ...
      (e.type === "ChainExpression" && bt(e.expression))
    );
  }
  ...
  y.parseSubscript = function (e, t, i, s, r, n, o) {
    ...
    if (
      ...
      (x.object = e),
        l
          ? ((x.property = this.parseExpression()), this.expect(a.bracketR))
          : this.type === a.privateId && e.type !== "Super"
            ? (x.property = this.parsePrivateIdent())
            : (x.property = this.parseIdent(
      ...
      if (r && !h && this.shouldParseAsyncArrow())
        return (
          ...
          this.parseSubscriptAsyncArrow(t, i, m, o)
        );
          ...
          if (
            ...
            return (
              ...
              (this.canInsertSemicolon() || !this.eat(a.arrow)) &&
                this.unexpected(),
              this.parseArrowExpression(this.startNodeAt(n, o), [h], !0, t)
            );
        }
        return h;
      case a.regexp:
  ...
  y.parseParenAndDistinguishExpression = function (e, t) {
    ...
    if (this.options.ecmaVersion >= 6) {
      ...
      (!h.length || x) && this.unexpected(this.lastTokStart),
        d && this.unexpected(d),
        this.checkExpressionErrors(_, !0),
        (this.yieldPos = B || this.yieldPos),
        (this.awaitPos = p || this.awaitPos),
...
`,
  ...
  W.declareName = function (e, t, i) {
    ...
    if (t === J) {
      ...
      for (var u = this.scopeStack.length - 1; u >= 0; --u) {
        ...
        if (
          (h.var.push(e),
          this.inModule && h.flags & ie && delete this.undefinedExports[e],
          h.flags & Fe)
        )
          break;
      }
  ...
  var _t =
    ...
    wt = kt,
    Ui = wt,
    qi = { 9: _t, 10: Ct, 11: Tt, 12: kt, 13: wt, 14: Ui },
    Ji =
    ...
    Wi = { 9: Et, 10: At, 11: Pt, 12: It, 13: Nt, 14: Ki },
    Vt = {};
  function Xi(e) {
    var t = (Vt[e] = {
      binary: G(qi[e] + " " + rt),
      binaryOfStrings: G(Gi[e]),
      nonBinary: { General_Category: G(rt), Script: G(Wi[e]) },
    });
  ...
  for (le = 0, Ne = [9, 10, 11, 12, 13, 14]; le < Ne.length; le += 1)
    (at = Ne[le]), Xi(at);
  var at,
    le,
    Ne,
  ...
  c.regexp_eatRegExpIdentifierStart = function (e) {
    ...
    return (
      ...
      s === 92 &&
        ...
        (s = e.lastIntValue),
      zi(s) ? ((e.lastIntValue = s), !0) : ((e.pos = t), !1)
    );
  };
  function zi(e) {
    ...
    if (e.eat(92))
      return this.regexp_eatCharacterEscape(e) ||
        ...
        : e.eat(98)
          ...
          : ((e.pos = t), !1);
    var i = e.current();
    return i < 0 || (i === e.lookahead() && Zi(i)) || es(i)
      ? !1
    ...
    e: for (; this.pos < this.input.length; ) {
      ...
      switch (e) {
        ...
        default:
          if (
            (e > 8 && e < 14) ||
            (e >= 5760 && ht.test(String.fromCharCode(e)))
          )
            ++this.pos;
          else break e;
      }
...
`);
  ...
  function he(e) {
    ...
    return (ue = he.prototype = e ?? Object.create(null)), new he();
  }
  var ys = 10;
...
`);
  ...
  function Ns(e) {
    ...
    let i = (0, Z.extract)(e),
      { pragmas: s, comments: r } = (0, Z.parseWithComments)(i);
  ...
  function Vs(e) {
    return (
      ...
      { astFormat: "estree", hasPragma: oi, locStart: P, locEnd: j, ...e }
    );
  }
  var Te = Vs;
  function Ls(e) {
  ...
  function Os(e) {
    ...
    return be(t.replace(/ \(\d+:\d+\)$/, ""), {
      loc: { start: { line: s, column: r + 1 } },
      cause: e,
    });
  }
  var ui,
    Bs = () => (ui ?? (ui = T.extend((0, hi.default)())), ui);
  function Ds(e, t) {
    let i = Bs(),
      s = [],
      r = [],
  ...
  function Ms(e, t) {
    let i = e[0],
      s = e[e.length - 1],
      r = { type: w.Template, value: t.slice(i.start, s.end) };
    return (
  ...
  Qe.prototype = {
    ...
    translate(e, t) {
      ...
      if (i === s.name)
        (e.type = w.Identifier),
          e.value === "static" && (e.type = w.Keyword),
          t.ecmaVersion > 5 &&
        ...
        t.jsxAttrValueToken
          ? ((t.jsxAttrValueToken = !1), (e.type = w.JSXText))
          : (e.type = w.String),
  ...
  function Js(e, t, i, s, r, n, o) {
    ...
    return (
      ...
      typeof r == "object" && (h.loc = { start: r, end: n }),
      h
    );
  }
  var Ze = () => (e) => {
...
`,
  ...
  var Gs = {
    ...
    get regular() {
      return (
        this._regular === null && (this._regular = T.extend(Ze())),
        this._regular
      );
    },
    get jsx() {
      return (
        this._jsx === null && (this._jsx = T.extend((0, fi.default)(), Ze())),
        this._jsx
      );
    },
    get(e) {
