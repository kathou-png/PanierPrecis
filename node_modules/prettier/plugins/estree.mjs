  ...
  if (
    ...
    e.type === "TemplateLiteral" &&
      (((u = e.leadingComments) != null &&
        u.some(
          (a) => ee(a) && ["GraphQL", "HTML"].some((o) => a.value === ` ${o} `),
        )) ||
...
function Ct(e, t) {
  return $e(e), { type: Ye, contents: e, groupId: t.groupId, negate: t.negate };
}
function $n(e) {
...
function Yo(e) {
  return [Vo, Nu, Ju, Uu, Zn, es, Ru, qu, Gu, np, up, rs, cp, ts, Dp, yp].some(
    (t) => t(e),
  );
}
function Xo(e) {
...
function sp({
  ...
  return We(r)
    ? (ir(e) && ((n.prettierIgnore = !0), (e.unignore = !0)),
      t ? (K(t, e), !0) : !1)
    : (We(n) && ir(e) && ((n.types[0].prettierIgnore = !0), (e.unignore = !0)),
      !1);
}
...
`,
        ...
        switch (f) {
          ...
          case Se: {
            ...
            let h = { ind: c, mode: ut, doc: l.contents },
              g = n - u,
              S = p.length > 0;
            if (!l.break && Wr(h, i, g, S, r)) i.push(h);
      ...
      case de: {
        ...
        let Fe = { ind: c, mode: f, doc: Wt(g) },
          X = g[0];
        Wr({ ind: c, mode: ut, doc: [S, B, X] }, [], h, p.length > 0, r, !0)
          ? i.push(Fe, T, O)
          : _
            ? i.push(Fe, W, O)
            : i.push(Fe, W, R);
...
function Gr(e, t, r) {
  ...
  o &&
    (a = a.map(
      (m) => Nr(m, { ...r, printWidth: Number.POSITIVE_INFINITY }).formatted,
    )),
    i.push(ke, "`");
  let p = 0;
  return (
  ...
  if (s.length > 1 || s.some((u) => u.length > 0)) {
    ...
    let i = [],
      a = u.map(
        (c) =>
          "${" +
          Nr(c, { ...t, printWidth: Number.POSITIVE_INFINITY, endOfLine: "lf" })
            .formatted +
          "}",
      ),
      ...
      return (
        ...
        (t.callee.type === "MemberExpression" &&
          ((t.callee.object.type === "MemberExpression" &&
            (Xr(t.callee.object.object) || ti(t.callee.object))) ||
            (t.callee.object.type === "CallExpression" &&
              Xr(t.callee.object.callee))))
      );
    case "Identifier":
      return t.name === "css";
    default:
...
function lr(e) {
  return (
    e.type === "JSXText" &&
    (Vr.hasNonWhitespaceCharacter(De(e)) || !/\n/.test(De(e)))
  );
}
function Ic(e) {
  return (
...
function Yc(e, t, r, n, s) {
  ...
  if (
    e.match(
      ...
      (c) =>
        !a ||
        (c.type !== "ExpressionStatement" && c.type !== "VariableDeclaration"),
    )
  )
    return a
  ...
  if (o.length === 0) s.push(ml(e, t, u, i));
    ...
    let p = v(!1, o, -1),
      ...
      h = m
        ...
        : "";
    s.push(
      D([u, E([F, l ? yl(e, t, r, h) : [Dl(e, t, a, r), h], J(e, t)]), F, i], {
        shouldBreak: f,
        id: c,
      }),
    );
...
function ft(e, t, r) {
  ...
  if (
    ...
    (t.parser === "json" ||
      t.parser === "jsonc" ||
      (t.quoteProps === "consistent" && fn.get(s)))
  ) {
    let i = at(
...
function dl(e, t, r) {
  ...
  return (
    ...
    (((n = t.label) == null ? void 0 : n.hug) !== !1 &&
      (((s = t.label) == null ? void 0 : s.embed) || wr(e, r.originalText)))
  );
}
...
function Sn(e, t, r) {
  ...
  L(n.decorators) && s.push(Cs(e, t, r)),
    ...
    (n.type === "ClassAccessorProperty" ||
      ...
      s.push("accessor "),
    s.push(ft(e, t, r), V(e), mn(e), Y(e, r));
  let i =
...
function bn(e, t, r) {
  ...
  return (
    A(n, x.Dangling) && (s.push(" ", J(e, t)), Or(n) && s.push(C)),
    u
...
function $t(e, t, r, n) {
  ...
  let Ns = Symbol("test"),
    ...
    _a = xt
      ? D([Gs, O ? dr : b(dr, D(dr, { id: wa }), { groupId: Ns })], { id: Ar })
      : [Gs, dr],
    wn = r(o),
    Us = je ? b(wn, Rr(js(wn)), { groupId: Ar }) : wn,
    zt = [
      _a,
      Kt.length > 0
        ? [E([C, Kt]), C]
    ...
    case "ForStatement": {
      ...
      return !s.init && !s.test && !s.update
        ...
        : [
            ...
            D([
              "for (",
              D([E([F, r("init"), ";", d, r("test"), ";", d, r("update")]), F]),
              ")",
              a,
            ]),
          ];
...
function ha(e, t, r) {
  ...
  switch (n.type) {
    ...
    case "TSModuleDeclaration": {
      ...
      return (
        u.push(r("id")),
        p ? u.push(r("body")) : n.body ? u.push(" ", D(r("body"))) : u.push(s),
        u
      );
    }
    case "TSConditionalType":
