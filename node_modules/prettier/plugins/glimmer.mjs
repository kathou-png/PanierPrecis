...
var Yt = (t, e) => {
  for (var r in e) es(t, r, { get: e[r], enumerable: !0 });
};
var Ur = (t, e, r) => {
...
var Qe = rs;
var ns = (t) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(t);
function ss(t) {
...
var Gr = { type: Ie };
var as = { type: J, hard: !0 },
  os = { type: J, hard: !0, literal: !0 },
  C = { type: J },
  G = { type: J, soft: !0 },
  be = [as, Gr],
  Yr = [os, Gr];
...
var ds = 10;
for (let t = 0; t <= ds; t++) Ze();
function rr(t) {
  return Ze(t);
}
function ms(t, e = "type") {
  rr(t);
  function r(n) {
    let s = n[e],
      i = t[s];
...
function Es(t, e, r) {
  ...
  switch (n.type) {
    ...
    case "BlockStatement":
      return Ps(t)
        ? [xs(t, r), ln(t, r, e), cn(t, r, e)]
        : [vs(t, r), B([ln(t, r, e), cn(t, r, e), Cs(t, r, e)])];
...
function vs(t, e) {
  ...
  return (
    s && n.push(B(s)),
    Xe(r.program.blockParams) && n.push(ir(r.program)),
    B([Ts(r), sr(t, e), n.length > 0 ? O([C, ye(C, n)]) : "", G, Ns(r)])
  );
}
function As(t, e) {
  return [
...
function xs(t, e) {
  ...
  return B([
    ...
    O([
      C,
      B(St(t, e)),
      ...(Xe(r.program.blockParams) ? [C, ir(r.program)] : []),
    ]),
    G,
    dn(n),
  ]);
...
var Hs = new Set("!\"#%&'()*+,./;<=>@[\\]^`{|}~"),
  ...
  Vs = (t, e) =>
    ...
    /\s/.test(t) ||
    /^\d/.test(t) ||
    Array.prototype.some.call(t, (r) => Hs.has(r));
function Fs(t) {
...
function js(t) {
  return (t |= 0), t < 0 ? Ys(t) : Ws(t);
}
function $s(t) {
  return (t |= 0), t > or.SIGN_BIT ? Ks(t) : zs(t);
}
[1, -1].forEach((t) => $s(js(t)));
...
var Mo = Cn(br.FlushElement);
var Go = Cn(br.GetSymbol);
var fi = /["&\xA0]/u,
  Zo = new RegExp(fi.source, "gu"),
  di = /[&<>\xA0]/u,
  el = new RegExp(di.source, "gu");
var Ln = new Set([
  "area",
  "base",
  "br",
...
var he = Object.freeze({ line: 1, column: 0 }),
  mi = Object.freeze({ source: "(synthetic)", start: he, end: he }),
...
var Ar = class t {
  ...
  j = Rn((t) =>
    t
      ...
      .when(Tr, it, (e) => new ee(e.kind, ue).wrap())
      .when(it, Tr, (e, r) => new ee(r.kind, ue).wrap()),
  ),
  pe = "BROKEN",
  qe = class t {
...
function Ni(t, e, r, n) {
  ...
  if (Array.isArray(n))
    ...
    else throw n.length === 0 ? _n(r, t, e) : Ei(r, t, e);
  else On(t, e, n);
}
function vi(t, e, r) {
  return r === null
...
function Ci(t, e) {
  ...
  for (let a of e.program.blockParamNodes) {
    ...
    (h[1] = h[0] + a.value.length),
      (a.loc = t.spanFor({ start: t.hbsPosFor(h[0]), end: t.hbsPosFor(h[1]) }));
  }
}
function Li(t, e) {
  let r = [e.loc.getStart().offset, e.loc.getEnd().offset],
  ...
  for (let i of e.parts) {
    ...
    (o[1] = o[0] + i.value.length),
      (s = t.slice(o[1], r[1])),
      (n = o[1]),
      (i.loc = t.spanFor({ start: t.hbsPosFor(o[0]), end: t.hbsPosFor(o[1]) }));
  }
}
function _i(t) {
  ...
  if (n !== -1 && e > n && Z(r[n + 1]).charAt(0) === "|") {
    ...
    if (
      s.charAt(s.length - 1) !== "|" ||
      ar(s.match(/\|/gu), "block params must exist here").length !== 2
    )
...
function Qi(t, e, r = !1, n) {
  return {
    type: "Block",
    body: t || [],
    blockParams: e || [],
    blockParamNodes:
      (e == null ? void 0 : e.map((s) => ({ type: "BlockParam", value: s }))) ||
      [],
    chained: r,
    loc: k(n || null),
  };
  ...
  xr = class {
    ...
    blockItself({
      ...
      return {
        ...
        blockParams: r,
        blockParamNodes:
          r == null ? void 0 : r.map((i) => ({ type: "BlockParam", value: i })),
        chained: n,
        loc: s,
      };
    }
    ...
    element({
      ...
      return {
        ...
        parts: e.split(".").map((h) => ({ type: "ElementPartNode", value: h })),
        selfClosing: r,
        attributes: n || [],
        blockParams: s,
        blockParamNodes: s.map((h) => ({ type: "BlockParam", value: h })) || [],
        modifiers: i || [],
        comments: a || [],
        children: o || [],
        loc: c,
...
var N = new xr(),
  Cr = class {
    ...
    get currentTag() {
      ...
      return (
        P(e && (e.type === "StartTag" || e.type === "EndTag"), "expected tag"),
        e
      );
    }
    get currentStartTag() {
...
function zn(t, e = {}) {
  ...
  if (
    ...
    for (let g of e.plugins.ast) {
      let E = nt({}, e, { syntax: sa }, { plugins: void 0 }),
        M = g(E);
      Ai(o, M.visitor);
    }
  return o;
...
function la(t) {
  let e;
  try {
    e = zn(t, { mode: "codemod", plugins: { ast: [oa(t)] } });
  } catch (r) {
    let n = ua(r);
    if (n) {
      let s = ca(r);
...
var ha = { parse: la, astFormat: "glimmer", locStart: Ee, locEnd: et };
var pa = { glimmer: bn };
var bl = Rr;
export { bl as default, yn as languages, Ir as parsers, pa as printers };
