...
var require_has_flag = __commonJS({
  "node_modules/@babel/code-frame/node_modules/has-flag/index.js"(
    ...
    module.exports = (flag, argv) => {
      ...
      return (
        pos2 !== -1 && (terminatorPos === -1 ? true : pos2 < terminatorPos)
      );
    };
  },
});
    ...
    function parseArguments(name, args) {
      ...
      for (const chunk of chunks) {
        if (!isNaN(chunk)) {
          ...
          results.push(
            matches[2].replace(ESCAPE_REGEX, (m, escape2, chr) =>
              escape2 ? unescape(escape2) : chr,
            ),
          );
        } else {
          throw new Error(
      ...
      tmp.replace(
        ...
        (m, escapeChar, inverse, style, close, chr) => {
          if (escapeChar) {
            ...
            chunk = [];
            chunks.push(
              styles3.length === 0 ? str2 : buildStyle(chalk2, styles3)(str2),
            );
...
var require_chalk = __commonJS({
  "node_modules/@babel/code-frame/node_modules/chalk/index.js"(
    ...
    for (const key2 of Object.keys(ansiStyles2)) {
      ansiStyles2[key2].closeRe = new RegExp(
        escapeStringRegexp2(ansiStyles2[key2].close),
        "g",
      );
      styles3[key2] = {
        get() {
...
import {
  URL as URL3,
  fileURLToPath as fileURLToPath5,
...
function massageAst(ast, options8) {
  ...
  function recurse(node, parent) {
    ...
    for (const key2 in node) {
      if (
        !Object.prototype.hasOwnProperty.call(node, key2) ||
