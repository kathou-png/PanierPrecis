...
var he = (e, t, r) => (
  ...
  Cu = (e) => ur($e({}, "__esModule", { value: !0 }), e);
var hu = (e, t, r) => {
        ...
        for (var F = -1 * a; F <= a; F += 2) {
          ...
          if (
            (!h || (B && E.newPos < C.newPos)
              ? ((m = Au(C)), u.pushComponent(m.components, void 0, !0))
              : ((m = E),
                m.newPos++,
...
var Pn = Me((Et) => {
  ...
  function vn(e, t, r = {}) {
    let n = (r.highlightCode || r.forceColor) && (0, wn.shouldHighlight)(r),
      ...
      i = (F, m) => (n ? F(m) : m),
      s = e.split(Sn),
      { start: D, end: a, markerLines: c } = Ao(t, s, r),
...
var M = "string",
  ...
  O = "label",
  b = "break-parent",
  Ue = new Set([W, S, T, v, _, x, k, P, L, I, A, O, b]);
function xu(e) {
...
function Ar(e) {
  ...
  function n(u, i, s) {
    ...
    if (u.type === A) {
      let c =
        ((D = s == null ? void 0 : s[i + 1]) == null ? void 0 : D.type) === b;
      return u.literal
        ? c
          ? "literalline"
    ...
    if (u.type === b)
      return ((a = s == null ? void 0 : s[i - 1]) == null ? void 0 : a.type) ===
        A && s[i - 1].hard
        ? void 0
        : "breakParent";
...
function wr(e) {
  for (
    e = [...e];
    e.length >= 2 && y(!1, e, -2).type === A && y(!1, e, -1).type === b;
...
`,
      ...
      case x: {
        ...
        let Q = { ind: f, mode: p, doc: Ge(m) },
          nr = m[0];
        Qe({ ind: f, mode: K, doc: [E, C, nr] }, [], F, a.length > 0, r, !0)
          ? i.push(Q, Z, g)
          : B
            ? i.push(Q, $, g)
            : i.push(Q, $, h);
          ...
          case R:
            ...
            l.literal
              ? f.root
                ...
                : (s.push(o), (u = 0))
              : ((u -= xt(s)), s.push(o + f.value), (u = f.length));
            break;
        }
        break;
      case O:
...
var $r = new Set([
  ...
  zu = (e) => Object.keys(e).filter((t) => !$r.has(t));
function Gu(e) {
  return e ? (t) => e(t, $r) : zu;
}
var H = Gu;
  ...
  for (let o of ro(Object.assign({}, ...e.map(({ options: u }) => u), Jr)))
    (!t && o.deprecated) ||
      (Array.isArray(o.choices) &&
        ...
        o.name === "parser" &&
          (o.choices = [...o.choices, ...to(o.choices, r, e)])),
    ...
    t &&
      n.push(
        [`- ${se.default.blue(t.title)}:`].concat(
          t.values.map((o) => on(o, r - rn.length).replace(/^|\n/g, `$&${rn}`)),
        ).join(`
`),
      ),
    sn(n, r)
...
function fo(e, { isCLI: t, FlagSchema: r }) {
  ...
  for (let o of e)
    n.push(Fo(o, { isCLI: t, optionInfos: e, FlagSchema: r })),
      o.alias && t && n.push(st.create({ name: o.alias, sourceName: o.name }));
  return n;
}
...
function Xn(e, t) {
  let { cursorOffset: r, rangeStart: n, rangeEnd: o, endOfLine: u } = Gn(e, t),
    i = e.charAt(0) === qn;
  if (
    (i && ((e = e.slice(1)), r--, n--, o--),
    u === "auto" && (u = Dr(e)),
