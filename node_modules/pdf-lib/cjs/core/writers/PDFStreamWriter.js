...
var PDFCrossRefStream_1 = tslib_1.__importDefault(
  require("../structures/PDFCrossRefStream"),
);
var PDFObjectStream_1 = tslib_1.__importDefault(
  require("../structures/PDFObjectStream"),
);
      ...
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            xrefStream = PDFCrossRefStream_1.default.create(
          ...
          case 7:
            ...
            objectStream = PDFObjectStream_1.default.withContextAndObjects(
              this.context,
              chunk,
              this.encodeStreams,
            );
          ...
          case 10:
            ...
            xrefStream.dict.set(
              PDFName_1.default.of("Size"),
              PDFNumber_1.default.of(objectNumber),
            );
            ...
            trailer =
              PDFTrailer_1.default.forLastCrossRefSectionOffset(xrefOffset);
