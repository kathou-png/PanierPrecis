...
var PDFAcroNonTerminal_1 = tslib_1.__importDefault(
  require("./PDFAcroNonTerminal"),
);
...
var PDFAcroPushButton_1 = tslib_1.__importDefault(
  require("./PDFAcroPushButton"),
);
var PDFAcroRadioButton_1 = tslib_1.__importDefault(
  require("./PDFAcroRadioButton"),
);
...
var isNonTerminalAcroField = function (dict) {
  ...
  if (kids instanceof PDFArray_1.default) {
    for (var idx = 0, len = kids.size(); idx < len; idx++) {
      ...
      var kidIsField =
        kid instanceof PDFDict_1.default && kid.has(PDFName_1.default.of("T"));
...
var createPDFAcroButton = function (dict, ref) {
  ...
  var flags =
    (_a =
      ffNumber === null || ffNumber === void 0
        ? void 0
        : ffNumber.asNumber()) !== null && _a !== void 0
      ? _a
      : 0;
