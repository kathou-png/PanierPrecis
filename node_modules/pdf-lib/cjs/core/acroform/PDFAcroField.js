...
var PDFHexString_1 = tslib_1.__importDefault(
  require("../objects/PDFHexString"),
);
...
var PDFAcroField = /** @class */ (function () {
  ...
  PDFAcroField.prototype.T = function () {
    return this.dict.lookupMaybe(
      PDFName_1.default.of("T"),
      PDFString_1.default,
      PDFHexString_1.default,
    );
  };
  ...
  PDFAcroField.prototype.DA = function () {
    ...
    if (
      da instanceof PDFString_1.default ||
      da instanceof PDFHexString_1.default
    )
      return da;
    return undefined;
  };
  ...
  PDFAcroField.prototype.getParent = function () {
    ...
    if (parentRef instanceof PDFRef_1.default) {
      var parent_1 = this.dict.lookup(
        PDFName_1.default.of("Parent"),
        PDFDict_1.default,
      );
  ...
  PDFAcroField.prototype.setParent = function (parent) {
    if (!parent) this.dict.delete(PDFName_1.default.of("Parent"));
    else this.dict.set(PDFName_1.default.of("Parent"), parent);
  };
  ...
  PDFAcroField.prototype.setPartialName = function (partialName) {
    if (!partialName) this.dict.delete(PDFName_1.default.of("T"));
    else
      this.dict.set(
        PDFName_1.default.of("T"),
        PDFHexString_1.default.fromText(partialName),
      );
  };
  PDFAcroField.prototype.setDefaultAppearance = function (appearance) {
    this.dict.set(
      PDFName_1.default.of("DA"),
      PDFString_1.default.of(appearance),
    );
  };
  ...
  PDFAcroField.prototype.setFontSize = function (fontSize) {
    var _a;
    var name =
      (_a = this.getFullyQualifiedName()) !== null && _a !== void 0 ? _a : "";
    var da = this.getDefaultAppearance();
    if (!da) throw new errors_1.MissingDAEntryError(name);
    var daMatch = utils_1.findLastMatch(da, tfRegex);
    if (!daMatch.match) throw new errors_1.MissingTfOperatorError(name);
    ...
    var modifiedDa =
      daStart + " /" + fontName + " " + fontSize + " Tf " + daEnd;
    this.setDefaultAppearance(modifiedDa);
  };
  PDFAcroField.prototype.getFlags = function () {
    var _a, _b;
    return (_b =
      (_a = this.Ff()) === null || _a === void 0 ? void 0 : _a.asNumber()) !==
      null && _b !== void 0
      ? _b
      : 0;
  };
