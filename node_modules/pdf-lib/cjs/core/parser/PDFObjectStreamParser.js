...
var PDFObjectStreamParser = /** @class */ (function (_super) {
  ...
  function PDFObjectStreamParser(rawStream, shouldWaitForTick) {
    var _this =
      _super.call(
        this,
        ByteStream_1.default.fromPDFRawStream(rawStream),
    ...
    _this.firstOffset = dict
      .lookup(PDFName_1.default.of("First"), PDFNumber_1.default)
      .asNumber();
    _this.objectCount = dict
      .lookup(PDFName_1.default.of("N"), PDFNumber_1.default)
      .asNumber();
    return _this;
  }
        ...
        switch (_b.label) {
          case 0:
            if (this.alreadyParsed) {
              throw new errors_1.ReparseError(
