...
var PDFPageLeaf_1 = tslib_1.__importDefault(
  require("../structures/PDFPageLeaf"),
);
var PDFPageTree_1 = tslib_1.__importDefault(
  require("../structures/PDFPageTree"),
);
...
var PDFObjectParser = /** @class */ (function (_super) {
  ...
  PDFObjectParser.prototype.parseObject = function () {
    ...
    if (
      byte === CharCodes_1.default.LessThan &&
  ...
  PDFObjectParser.prototype.parseDictOrStream = function () {
    ...
    this.skipWhitespaceAndComments();
    if (
      !this.matchKeyword(Keywords_1.Keywords.streamEOF1) &&
  ...
  PDFObjectParser.prototype.findEndOfStreamFallback = function (startPos) {
    ...
    while (!this.bytes.done()) {
      ...
      if (this.matchKeyword(Keywords_1.Keywords.stream)) {
        ...
        this.matchKeyword(Keywords_1.Keywords.EOF1endstream) ||
