...
var PDFCrossRefSection_1 = tslib_1.__importDefault(
  require("../document/PDFCrossRefSection"),
);
...
var PDFInvalidObject_1 = tslib_1.__importDefault(
  require("../objects/PDFInvalidObject"),
);
var PDFName_1 = tslib_1.__importDefault(require("../objects/PDFName"));
var PDFRawStream_1 = tslib_1.__importDefault(
  require("../objects/PDFRawStream"),
);
...
var PDFObjectStreamParser_1 = tslib_1.__importDefault(
  require("./PDFObjectStreamParser"),
);
var PDFXRefStreamParser_1 = tslib_1.__importDefault(
  require("./PDFXRefStreamParser"),
);
...
var PDFParser = /** @class */ (function (_super) {
  ...
  function PDFParser(
    ...
    var _this =
      _super.call(
        this,
        ByteStream_1.default.of(pdfBytes),
        PDFContext_1.default.create(),
        capNumbers,
      ) || this;
  ...
  PDFParser.prototype.parseIndirectObjectHeader = function () {
    ...
    if (!this.matchKeyword(Keywords_1.Keywords.obj)) {
      throw new errors_1.MissingKeywordError(
        this.bytes.position(),
        Keywords_1.Keywords.obj,
      );
    }
      ...
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              PDFObjectStreamParser_1.default
  ...
  PDFParser.prototype.maybeParseTrailerDict = function () {
    ...
    context.trailerInfo = {
      ...
      Encrypt:
        dict.get(PDFName_1.default.of("Encrypt")) ||
  ...
  PDFParser.prototype.skipJibberish = function () {
    ...
    while (!this.bytes.done()) {
      ...
      var byte = this.bytes.peek();
      var isAlphaNumeric =
        byte >= CharCodes_1.default.Space && byte <= CharCodes_1.default.Tilde;
      if (isAlphaNumeric) {
        if (
          this.matchKeyword(Keywords_1.Keywords.xref) ||
