...
var AppearanceCharacteristics = /** @class */ (function () {
  ...
  AppearanceCharacteristics.prototype.CA = function () {
    ...
    if (
      CA instanceof PDFHexString_1.default ||
      CA instanceof PDFString_1.default
    )
      return CA;
    return undefined;
  };
  AppearanceCharacteristics.prototype.RC = function () {
    ...
    if (
      RC instanceof PDFHexString_1.default ||
      RC instanceof PDFString_1.default
    )
      return RC;
    return undefined;
  };
  AppearanceCharacteristics.prototype.AC = function () {
    ...
    if (
      AC instanceof PDFHexString_1.default ||
      AC instanceof PDFString_1.default
    )
      return AC;
    return undefined;
  };
  ...
  AppearanceCharacteristics.prototype.getBorderColor = function () {
    ...
    var components = [];
    for (
      var idx = 0, len = BC === null || BC === void 0 ? void 0 : BC.size();
      idx < len;
      idx++
    ) {
  ...
  AppearanceCharacteristics.prototype.getBackgroundColor = function () {
    ...
    var components = [];
    for (
      var idx = 0, len = BG === null || BG === void 0 ? void 0 : BG.size();
      idx < len;
      idx++
    ) {
