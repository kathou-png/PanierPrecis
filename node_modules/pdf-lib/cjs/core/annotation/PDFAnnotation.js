...
var PDFAnnotation = /** @class */ (function () {
  ...
  PDFAnnotation.prototype.getRectangle = function () {
    ...
    var Rect = this.Rect();
    return (_a =
      Rect === null || Rect === void 0 ? void 0 : Rect.asRectangle()) !==
      null && _a !== void 0
      ? _a
  ...
  PDFAnnotation.prototype.getAppearanceState = function () {
    ...
    if (AS instanceof PDFName_1.default) return AS;
    return undefined;
  };
  ...
  PDFAnnotation.prototype.getAppearances = function () {
    ...
    var N = AP.lookup(
      PDFName_1.default.of("N"),
      PDFDict_1.default,
      PDFStream_1.default,
    );
    var R = AP.lookupMaybe(
      PDFName_1.default.of("R"),
      PDFDict_1.default,
      PDFStream_1.default,
    );
    var D = AP.lookupMaybe(
      PDFName_1.default.of("D"),
      PDFDict_1.default,
      PDFStream_1.default,
    );
  ...
  PDFAnnotation.prototype.getFlags = function () {
    var _a, _b;
    return (_b =
      (_a = this.F()) === null || _a === void 0 ? void 0 : _a.asNumber()) !==
      null && _b !== void 0
      ? _b
      : 0;
  };
