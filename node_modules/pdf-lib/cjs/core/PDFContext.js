...
var PDFOperatorNames_1 = tslib_1.__importDefault(
  require("./operators/PDFOperatorNames"),
);
var PDFContentStream_1 = tslib_1.__importDefault(
  require("./structures/PDFContentStream"),
);
...
var PDFContext = /** @class */ (function () {
  ...
  PDFContext.prototype.lookupMaybe = function (ref) {
    ...
    var result =
      ref instanceof PDFRef_1.default ? this.indirectObjects.get(ref) : ref;
  ...
  PDFContext.prototype.stream = function (contents, dict) {
    ...
    return PDFRawStream_1.default.of(
      this.obj(dict),
      utils_1.typedArrayFor(contents),
    );
  };
  PDFContext.prototype.flateStream = function (contents, dict) {
    ...
    return this.stream(
      pako_1.default.deflate(utils_1.typedArrayFor(contents)),
      tslib_1.__assign(tslib_1.__assign({}, dict), { Filter: "FlateDecode" }),
    );
  };
  ...
  PDFContext.prototype.getPushGraphicsStateContentStream = function () {
    ...
    var dict = this.obj({});
    var op = PDFOperator_1.default.of(
      PDFOperatorNames_1.default.PushGraphicsState,
    );
  ...
  PDFContext.prototype.getPopGraphicsStateContentStream = function () {
    ...
    var dict = this.obj({});
    var op = PDFOperator_1.default.of(
      PDFOperatorNames_1.default.PopGraphicsState,
    );
    var stream = PDFContentStream_1.default.of(dict, [op]);
  ...
  PDFContext.prototype.addRandomSuffix = function (prefix, suffixLength) {
    ...
    return (
      prefix + "-" + Math.floor(this.rng.nextInt() * Math.pow(10, suffixLength))
    );
  };
