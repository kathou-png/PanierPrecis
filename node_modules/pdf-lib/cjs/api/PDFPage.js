...
var PDFPage = /** @class */ (function () {
  function PDFPage(leafNode, ref, doc) {
    ...
    this.x = 0;
    this.y = 0;
    utils_1.assertIs(leafNode, "leafNode", [
      [core_1.PDFPageLeaf, "PDFPageLeaf"],
    ]);
  ...
  PDFPage.prototype.getCropBox = function () {
    ...
    return (_a =
      cropBox === null || cropBox === void 0
        ? void 0
        : cropBox.asRectangle()) !== null && _a !== void 0
      ? _a
      : this.getMediaBox();
  };
  /**
  ...
  PDFPage.prototype.getBleedBox = function () {
    ...
    return (_a =
      bleedBox === null || bleedBox === void 0
        ? void 0
        : bleedBox.asRectangle()) !== null && _a !== void 0
      ? _a
      : this.getCropBox();
  };
  /**
  ...
  PDFPage.prototype.getTrimBox = function () {
    ...
    return (_a =
      trimBox === null || trimBox === void 0
        ? void 0
        : trimBox.asRectangle()) !== null && _a !== void 0
      ? _a
      : this.getCropBox();
  };
  /**
  ...
  PDFPage.prototype.getArtBox = function () {
    ...
    return (_a =
      artBox === null || artBox === void 0 ? void 0 : artBox.asRectangle()) !==
      null && _a !== void 0
      ? _a
      : this.getCropBox();
  };
  ...
  PDFPage.prototype.scaleAnnotations = function (x, y) {
    ...
    for (var idx = 0; idx < annots.size(); idx++) {
      ...
      if (annot instanceof core_1.PDFDict) this.scaleAnnot(annot, x, y);
    }
  };
  /**
  ...
  PDFPage.prototype.pushOperators = function () {
    ...
    utils_1.assertEachIs(operator, "operator", [
      [core_1.PDFOperator, "PDFOperator"],
    ]);
  ...
  PDFPage.prototype.drawText = function (text, options) {
    ...
    utils_1.assertOrUndefined(options.color, "options.color", [
      [Object, "Color"],
    ]);
    utils_1.assertRangeOrUndefined(options.opacity, "opacity.opacity", 0, 1);
    utils_1.assertOrUndefined(options.font, "options.font", [
      [PDFFont_1.default, "PDFFont"],
    ]);
    utils_1.assertOrUndefined(options.size, "options.size", ["number"]);
    utils_1.assertOrUndefined(options.rotate, "options.rotate", [
      [Object, "Rotation"],
    ]);
    utils_1.assertOrUndefined(options.xSkew, "options.xSkew", [
      [Object, "Rotation"],
    ]);
    utils_1.assertOrUndefined(options.ySkew, "options.ySkew", [
      [Object, "Rotation"],
    ]);
    utils_1.assertOrUndefined(options.x, "options.x", ["number"]);
    utils_1.assertOrUndefined(options.y, "options.y", ["number"]);
    utils_1.assertOrUndefined(options.lineHeight, "options.lineHeight", [
      "number",
    ]);
    utils_1.assertOrUndefined(options.maxWidth, "options.maxWidth", ["number"]);
    utils_1.assertOrUndefined(options.wordBreaks, "options.wordBreaks", [
      Array,
    ]);
    utils_1.assertIsOneOfOrUndefined(
      options.blendMode,
      "options.blendMode",
      PDFPageOptions_1.BlendMode,
    );
    ...
    contentStream.push.apply(
      contentStream,
      operations_1.drawLinesOfText(encodedLines, {
        color:
          (_a = options.color) !== null && _a !== void 0 ? _a : this.fontColor,
        font: newFontKey,
        size: fontSize,
        rotate:
          (_b = options.rotate) !== null && _b !== void 0
            ? _b
            : rotations_1.degrees(0),
        xSkew:
          (_c = options.xSkew) !== null && _c !== void 0
            ? _c
            : rotations_1.degrees(0),
        ySkew:
          (_d = options.ySkew) !== null && _d !== void 0
            ? _d
            : rotations_1.degrees(0),
        x: (_e = options.x) !== null && _e !== void 0 ? _e : this.x,
        y: (_f = options.y) !== null && _f !== void 0 ? _f : this.y,
        lineHeight:
          (_g = options.lineHeight) !== null && _g !== void 0
            ? _g
            : this.lineHeight,
  ...
  PDFPage.prototype.drawImage = function (image, options) {
    ...
    contentStream.push.apply(
      contentStream,
      operations_1.drawImage(xObjectKey, {
        x: (_a = options.x) !== null && _a !== void 0 ? _a : this.x,
        y: (_b = options.y) !== null && _b !== void 0 ? _b : this.y,
        width:
          (_c = options.width) !== null && _c !== void 0
            ? _c
            : image.size().width,
        height:
          (_d = options.height) !== null && _d !== void 0
            ? _d
            : image.size().height,
        rotate:
          (_e = options.rotate) !== null && _e !== void 0
            ? _e
            : rotations_1.degrees(0),
        xSkew:
          (_f = options.xSkew) !== null && _f !== void 0
            ? _f
            : rotations_1.degrees(0),
        ySkew:
          (_g = options.ySkew) !== null && _g !== void 0
            ? _g
            : rotations_1.degrees(0),
        graphicsState: graphicsStateKey,
      }),
  ...
  PDFPage.prototype.drawPage = function (embeddedPage, options) {
    ...
    contentStream.push.apply(
      contentStream,
      operations_1.drawPage(xObjectKey, {
        x: (_a = options.x) !== null && _a !== void 0 ? _a : this.x,
        y: (_b = options.y) !== null && _b !== void 0 ? _b : this.y,
        xScale: xScale,
        yScale: yScale,
        rotate:
          (_c = options.rotate) !== null && _c !== void 0
            ...
            : rotations_1.degrees(0),
        xSkew:
          (_d = options.xSkew) !== null && _d !== void 0
            ? _d
            : rotations_1.degrees(0),
        ySkew:
          (_e = options.ySkew) !== null && _e !== void 0
            ? _e
            : rotations_1.degrees(0),
        graphicsState: graphicsStateKey,
      }),
  ...
  PDFPage.prototype.drawSvgPath = function (path, options) {
    ...
    utils_1.assertOrUndefined(options.borderWidth, "options.borderWidth", [
      "number",
    ]);
    utils_1.assertOrUndefined(options.color, "options.color", [
      [Object, "Color"],
    ...
    utils_1.assertIsOneOfOrUndefined(
      ...
      "options.borderLineCap",
      operators_1.LineCapStyle,
    );
    utils_1.assertRangeOrUndefined(
    ...
    contentStream.push.apply(
      ...
      operations_1.drawSvgPath(path, {
        ...
        borderColor:
          (_e = options.borderColor) !== null && _e !== void 0 ? _e : undefined,
        borderWidth:
          (_f = options.borderWidth) !== null && _f !== void 0 ? _f : 0,
        borderDashArray:
          (_g = options.borderDashArray) !== null && _g !== void 0
            ? _g
            : undefined,
        borderDashPhase:
          (_h = options.borderDashPhase) !== null && _h !== void 0
            ? _h
            : undefined,
        borderLineCap:
          (_j = options.borderLineCap) !== null && _j !== void 0
            ? _j
            : undefined,
        graphicsState: graphicsStateKey,
      }),
  ...
  PDFPage.prototype.drawLine = function (options) {
    ...
    utils_1.assertOrUndefined(options.thickness, "options.thickness", [
      "number",
    ]);
    utils_1.assertOrUndefined(options.color, "options.color", [
      [Object, "Color"],
    ...
    utils_1.assertOrUndefined(options.dashPhase, "options.dashPhase", [
      "number",
    ]);
    utils_1.assertIsOneOfOrUndefined(
      options.lineCap,
    ...
    contentStream.push.apply(
      contentStream,
      operations_1.drawLine({
        start: options.start,
        end: options.end,
        thickness: (_a = options.thickness) !== null && _a !== void 0 ? _a : 1,
        color: (_b = options.color) !== null && _b !== void 0 ? _b : undefined,
        dashArray:
          (_c = options.dashArray) !== null && _c !== void 0 ? _c : undefined,
        dashPhase:
          (_d = options.dashPhase) !== null && _d !== void 0 ? _d : undefined,
        lineCap:
          (_e = options.lineCap) !== null && _e !== void 0 ? _e : undefined,
        graphicsState: graphicsStateKey,
      }),
    );
  };
      ...
      operations_1.drawRectangle({
        ...
        ySkew:
          (_g = options.ySkew) !== null && _g !== void 0
            ...
            : rotations_1.degrees(0),
        borderWidth:
          (_h = options.borderWidth) !== null && _h !== void 0 ? _h : 0,
        color: (_j = options.color) !== null && _j !== void 0 ? _j : undefined,
        borderColor:
          (_k = options.borderColor) !== null && _k !== void 0 ? _k : undefined,
        borderDashArray:
          (_l = options.borderDashArray) !== null && _l !== void 0
            ? _l
            : undefined,
        borderDashPhase:
          (_m = options.borderDashPhase) !== null && _m !== void 0
            ? _m
            : undefined,
        graphicsState: graphicsStateKey,
        borderLineCap:
          (_o = options.borderLineCap) !== null && _o !== void 0
            ? _o
            : undefined,
      }),
    );
  ...
  PDFPage.prototype.drawEllipse = function (options) {
    ...
    contentStream.push.apply(
      contentStream,
      operations_1.drawEllipse({
        x: (_a = options.x) !== null && _a !== void 0 ? _a : this.x,
        y: (_b = options.y) !== null && _b !== void 0 ? _b : this.y,
        xScale: (_c = options.xScale) !== null && _c !== void 0 ? _c : 100,
        yScale: (_d = options.yScale) !== null && _d !== void 0 ? _d : 100,
        rotate:
          (_e = options.rotate) !== null && _e !== void 0 ? _e : undefined,
        color: (_f = options.color) !== null && _f !== void 0 ? _f : undefined,
        borderColor:
          (_g = options.borderColor) !== null && _g !== void 0 ? _g : undefined,
        borderWidth:
          (_h = options.borderWidth) !== null && _h !== void 0 ? _h : 0,
        borderDashArray:
          (_j = options.borderDashArray) !== null && _j !== void 0
            ? _j
            : undefined,
        borderDashPhase:
          (_k = options.borderDashPhase) !== null && _k !== void 0
            ? _k
            : undefined,
        borderLineCap:
          (_l = options.borderLineCap) !== null && _l !== void 0
            ? _l
            : undefined,
        graphicsState: graphicsStateKey,
      }),
  ...
  PDFPage.prototype.getFont = function () {
    if (!this.font || !this.fontKey) {
      var font = this.doc.embedStandardFont(
        StandardFonts_1.StandardFonts.Helvetica,
      );
      this.setFont(font);
    }
  ...
  PDFPage.prototype.scaleAnnot = function (annot, x, y) {
    ...
    for (var idx = 0, len = selectors.length; idx < len; idx++) {
      ...
      if (list instanceof core_1.PDFArray) list.scalePDFNumbers(x, y);
    }
    ...
    if (inkLists instanceof core_1.PDFArray) {
      for (var idx = 0, len = inkLists.size(); idx < len; idx++) {
        ...
        if (arr instanceof core_1.PDFArray) arr.scalePDFNumbers(x, y);
      }
    }
  };
  /**
  ...
  PDFPage.create = function (doc) {
    ...
    var pageLeaf = core_1.PDFPageLeaf.withContextAndParent(
      doc.context,
      dummyRef,
    );
