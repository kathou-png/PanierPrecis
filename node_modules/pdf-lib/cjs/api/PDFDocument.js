...
var FileEmbedder_1 = tslib_1.__importStar(
  require("../core/embedders/FileEmbedder"),
);
...
var JavaScriptEmbedder_1 = tslib_1.__importDefault(
  require("../core/embedders/JavaScriptEmbedder"),
);
/**
...
var PDFDocument = /** @class */ (function () {
        ...
        switch (_f.label) {
          case 0:
            (_a = options.ignoreEncryption),
              (ignoreEncryption = _a === void 0 ? false : _a),
              (_b = options.parseSpeed),
              (parseSpeed =
                _b === void 0 ? PDFDocumentOptions_1.ParseSpeeds.Slow : _b),
              (_c = options.throwOnInvalidObject),
              (throwOnInvalidObject = _c === void 0 ? false : _c),
              (_d = options.updateMetadata),
              (updateMetadata = _d === void 0 ? true : _d),
              (_e = options.capNumbers),
              (capNumbers = _e === void 0 ? false : _e);
            utils_1.assertIs(pdf, "pdf", ["string", Uint8Array, ArrayBuffer]);
            utils_1.assertIs(ignoreEncryption, "ignoreEncryption", ["boolean"]);
            utils_1.assertIs(parseSpeed, "parseSpeed", ["number"]);
            utils_1.assertIs(throwOnInvalidObject, "throwOnInvalidObject", [
              "boolean",
            ]);
            bytes = utils_1.toUint8Array(pdf);
            return [
              4 /*yield*/,
              core_1.PDFParser.forBytesWithOptions(
                bytes,
                parseSpeed,
                throwOnInvalidObject,
                capNumbers,
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
      ...
      return tslib_1.__generator(this, function (_b) {
        (_a = options.updateMetadata),
          (updateMetadata = _a === void 0 ? true : _a);
  ...
  PDFDocument.prototype.setKeywords = function (keywords) {
    ...
    this.getInfoDict().set(
      key,
      core_1.PDFHexString.fromText(keywords.join(" ")),
    );
  };
  /**
  ...
  PDFDocument.prototype.addPage = function (page) {
    utils_1.assertIs(page, "page", [
      "undefined",
      [PDFPage_1.default, "PDFPage"],
      Array,
    ]);
  ...
  PDFDocument.prototype.attach = function (attachment, name, options) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
      ...
      return tslib_1.__generator(this, function (_a) {
        utils_1.assertIs(attachment, "attachment", [
          "string",
          Uint8Array,
          ArrayBuffer,
        ]);
        ...
        utils_1.assertOrUndefined(options.description, "description", [
          "string",
        ]);
      ...
      return tslib_1.__generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              core_1.CustomFontSubsetEmbedder.for(
                fontkit,
                bytes,
                customName,
                features,
      ...
      return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            embedder = _b.sent();
            ref = this.context.nextRef();
            embeddedPages[idx] = PDFEmbeddedPage_1.default.of(
              ref,
              this,
              embedder,
            );
        ...
        switch (_e.label) {
          case 0:
            (_a = options.useObjectStreams),
              (useObjectStreams = _a === void 0 ? true : _a),
              (_b = options.addDefaultPage),
              (addDefaultPage = _b === void 0 ? true : _b),
              (_c = options.objectsPerTick),
              (objectsPerTick = _c === void 0 ? 50 : _c),
              (_d = options.updateFieldAppearances),
              (updateFieldAppearances = _d === void 0 ? true : _d);
            ...
            utils_1.assertIs(updateFieldAppearances, "updateFieldAppearances", [
              "boolean",
            ]);
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
      ...
      return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            (_a = options.dataUri),
              (dataUri = _a === void 0 ? false : _a),
              (otherOptions = tslib_1.__rest(options, ["dataUri"]));
    ...
    for (var idx = 0, len = pages.length; idx < len; idx++) {
      ...
      if (
        (annotations === null || annotations === void 0
          ? void 0
          : annotations.indexOf(ref)) !== undefined
      ) {
        return page;
      }
    }
...
function assertIsLiteralOrHexString(pdfObject) {
  if (
    !(pdfObject instanceof core_1.PDFHexString) &&
    !(pdfObject instanceof core_1.PDFString)
  ) {
    throw new core_1.UnexpectedObjectTypeError(
      [core_1.PDFHexString, core_1.PDFString],
      pdfObject,
    );
  }
}
