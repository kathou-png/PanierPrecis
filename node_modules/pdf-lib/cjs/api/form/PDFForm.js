...
var PDFForm = /** @class */ (function () {
  function PDFForm(acroForm, doc) {
    ...
    this.embedDefaultFont = function () {
      return _this.doc.embedStandardFont(
        StandardFonts_1.StandardFonts.Helvetica,
      );
    };
    utils_1.assertIs(acroForm, "acroForm", [
      [core_1.PDFAcroForm, "PDFAcroForm"],
    ]);
  ...
  PDFForm.prototype.getButton = function (name) {
    ...
    throw new errors_1.UnexpectedFieldTypeError(
      name,
      PDFButton_1.default,
      field,
    );
  ...
  PDFForm.prototype.flatten = function (options) {
    ...
    for (var i = 0, lenFields = fields.length; i < lenFields; i++) {
      ...
      for (var j = 0, lenWidgets = widgets.length; j < lenWidgets; j++) {
        ...
        var operators = tslib_1
          .__spreadArrays(
            [
              operators_1.pushGraphicsState(),
              operators_1.translate(rectangle.x, rectangle.y),
            ],
            operations_1.rotateInPlace(
              tslib_1.__assign(tslib_1.__assign({}, rectangle), {
                rotation: 0,
              }),
            ),
            [
  ...
  PDFForm.prototype.markFieldAsDirty = function (fieldRef) {
    utils_1.assertOrUndefined(fieldRef, "fieldRef", [
      [core_1.PDFRef, "PDFRef"],
    ]);
  ...
  PDFForm.prototype.findWidgetAppearanceRef = function (field, widget) {
    ...
    if (
      refOrDict instanceof core_1.PDFDict &&
      (field instanceof PDFCheckBox_1.default ||
        field instanceof PDFRadioGroup_1.default)
    ) {
      var value = field.acroField.getValue();
      var ref =
        (_a = refOrDict.get(value)) !== null && _a !== void 0
          ? _a
          : refOrDict.get(core_1.PDFName.of("Off"));
  ...
  PDFForm.prototype.findNonTerminal = function (partialName, parent) {
    var fields =
      parent instanceof core_1.PDFAcroForm
...
var addFieldToParent = function (_a, _b, partialName) {
  ...
  var fields = core_1.createPDFAcroFields(
