...
var PDFOptionList = /** @class */ (function (_super) {
  ...
  function PDFOptionList(acroListBox, ref, doc) {
    ...
    utils_1.assertIs(acroListBox, "acroListBox", [
      [core_1.PDFAcroListBox, "PDFAcroListBox"],
    ]);
  ...
  PDFOptionList.prototype.getOptions = function () {
    ...
    for (var idx = 0, len = options.length; idx < len; idx++) {
      var _a = rawOptions[idx],
        ...
        value = _a.value;
      options[idx] = (
        display !== null && display !== void 0 ? display : value
      ).decodeText();
    }
    return options;
  };
  ...
  PDFOptionList.prototype.updateWidgetAppearance = function (
    ...
    var apProvider =
      provider !== null && provider !== void 0
        ? provider
        : appearances_1.defaultOptionListAppearanceProvider;
