...
var PDFButton = /** @class */ (function (_super) {
  ...
  PDFButton.prototype.setImage = function (image, alignment) {
    ...
    for (var idx = 0, len = widgets.length; idx < len; idx++) {
      ...
      var streamRef = this.createImageAppearanceStream(
        widget,
        image,
        alignment,
      );
  ...
  PDFButton.prototype.addToPage = function (
    ...
    var widget = this.createWidget({
      x:
        ((_a = options === null || options === void 0 ? void 0 : options.x) !==
          null && _a !== void 0
          ? _a
          : 0) -
        ((_b =
          ...
          2,
      y:
        ((_c = options === null || options === void 0 ? void 0 : options.y) !==
          null && _c !== void 0
          ? _c
          : 0) -
        ((_d =
      ...
      textColor:
        (_g =
          options === null || options === void 0
            ? void 0
            : options.textColor) !== null && _g !== void 0
          ? _g
          : colors_1.rgb(0, 0, 0),
      backgroundColor:
        (_h =
          options === null || options === void 0
            ? void 0
            : options.backgroundColor) !== null && _h !== void 0
          ? _h
          : colors_1.rgb(0.75, 0.75, 0.75),
      borderColor:
      ...
      borderWidth:
        (_j =
          options === null || options === void 0
            ? void 0
            : options.borderWidth) !== null && _j !== void 0
          ? _j
          : 0,
      rotate:
        (_k =
    ...
    var font =
      (_l = options === null || options === void 0 ? void 0 : options.font) !==
        null && _l !== void 0
        ? _l
  ...
  PDFButton.prototype.needsAppearancesUpdate = function () {
    ...
    for (var idx = 0, len = widgets.length; idx < len; idx++) {
      var widget = widgets[idx];
      var hasAppearances =
        ((_a = widget.getAppearances()) === null || _a === void 0
          ? void 0
          : _a.normal) instanceof core_1.PDFStream;
  ...
  PDFButton.prototype.updateWidgetAppearance = function (
    ...
    var apProvider =
      provider !== null && provider !== void 0
        ? provider
        : appearances_1.defaultButtonAppearanceProvider;
    var appearances = appearances_1.normalizeAppearance(
