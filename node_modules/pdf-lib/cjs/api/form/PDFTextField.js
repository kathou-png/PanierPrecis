...
var PDFTextField = /** @class */ (function (_super) {
  ...
  function PDFTextField(acroText, ref, doc) {
    ...
    utils_1.assertIs(acroText, "acroText", [
      [core_1.PDFAcroText, "PDFAcroText"],
    ]);
  ...
  PDFTextField.prototype.setText = function (text) {
    ...
    if (maxLength !== undefined && text && text.length > maxLength) {
      throw new errors_1.ExceededMaxLengthError(
        text.length,
        maxLength,
        this.getName(),
      );
  ...
  PDFTextField.prototype.setMaxLength = function (maxLength) {
    ...
    if (maxLength === undefined) {
      ...
      if (text && text.length > maxLength) {
        throw new errors_1.InvalidMaxLengthError(
          text.length,
          maxLength,
          this.getName(),
        );
  ...
  PDFTextField.prototype.isCombed = function () {
    return (
      this.acroField.hasFlag(core_1.AcroTextFlags.Comb) &&
      !this.isMultiline() &&
      !this.isPassword() &&
      !this.isFileSelector() &&
  ...
  PDFTextField.prototype.addToPage = function (page, options) {
    ...
    var widget = this.createWidget({
      ...
      borderWidth:
        (_e = options.borderWidth) !== null && _e !== void 0 ? _e : 0,
      rotate:
        (_f = options.rotate) !== null && _f !== void 0
          ? _f
    ...
    var font =
      (_g = options.font) !== null && _g !== void 0
        ? _g
  ...
  PDFTextField.prototype.updateWidgetAppearance = function (
    ...
    var apProvider =
      provider !== null && provider !== void 0
        ? provider
        : appearances_1.defaultTextFieldAppearanceProvider;
