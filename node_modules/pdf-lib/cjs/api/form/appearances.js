...
exports.defaultOptionListAppearanceProvider =
  exports.defaultDropdownAppearanceProvider =
  exports.defaultTextFieldAppearanceProvider =
  exports.defaultButtonAppearanceProvider =
...
var getDefaultFontSize = function (field) {
  ...
  var daMatch =
    (_b = utils_1.findLastMatch(da, tfRegex).match) !== null && _b !== void 0
      ? _b
      : [];
...
var updateDefaultAppearance = function (field, color, font, fontSize) {
  ...
  var da = [
    ...
    operators_1
      .setFontAndSize(
        (_a = font === null || font === void 0 ? void 0 : font.name) !== null &&
          _a !== void 0
          ? _a
          : "dummy__noop",
        fontSize,
...
exports.defaultCheckBoxAppearanceProvider = function (checkBox, widget) {
  ...
  var rotation = rotations_1.reduceRotation(
    ap === null || ap === void 0 ? void 0 : ap.getRotation(),
  );
  var _d = rotations_1.adjustDimsForRotation(rectangle, rotation),
    width = _d.width,
    height = _d.height;
  var rotate = operations_1.rotateInPlace(
    tslib_1.__assign(tslib_1.__assign({}, rectangle), { rotation: rotation }),
  );
  var black = colors_1.rgb(0, 0, 0);
  var borderColor =
    (_b = colors_1.componentsToColor(
      ap === null || ap === void 0 ? void 0 : ap.getBorderColor(),
    )) !== null && _b !== void 0
      ? _b
      : black;
  var normalBackgroundColor = colors_1.componentsToColor(
    ap === null || ap === void 0 ? void 0 : ap.getBackgroundColor(),
  );
  var downBackgroundColor = colors_1.componentsToColor(
    ap === null || ap === void 0 ? void 0 : ap.getBackgroundColor(),
    0.8,
  );
  // Update color
  var textColor =
    (_c =
      widgetColor !== null && widgetColor !== void 0
        ? widgetColor
        : fieldColor) !== null && _c !== void 0
      ? _c
      : black;
  if (widgetColor) {
  ...
  return {
    normal: {
      on: tslib_1.__spreadArrays(
        rotate,
        operations_1.drawCheckBox(
...
exports.defaultButtonAppearanceProvider = function (button, widget, font) {
  ...
  var normalText =
    (_a =
      captions === null || captions === void 0 ? void 0 : captions.normal) !==
      null && _a !== void 0
      ? _a
      : "";
  var downText =
    (_c =
      (_b =
        captions === null || captions === void 0 ? void 0 : captions.down) !==
        null && _b !== void 0
        ? _b
        : normalText) !== null && _c !== void 0
      ? _c
      : "";
  var borderWidth =
  ...
  var black = colors_1.rgb(0, 0, 0);
  var borderColor = colors_1.componentsToColor(
    ap === null || ap === void 0 ? void 0 : ap.getBorderColor(),
  );
  var normalBackgroundColor = colors_1.componentsToColor(
    ap === null || ap === void 0 ? void 0 : ap.getBackgroundColor(),
  ...
  return {
    normal: tslib_1.__spreadArrays(
      rotate,
      operations_1.drawButton(
        tslib_1.__assign(tslib_1.__assign({}, options), {
          color: normalBackgroundColor,
...
exports.defaultTextFieldAppearanceProvider = function (
  textField,
  widget,
  font,
) {
  ...
  if (textField.isMultiline()) {
    ...
    var layout = layout_1.layoutCombedText(text, {
      ...
      bounds: bounds,
      cellCount:
        (_c = textField.getMaxLength()) !== null && _c !== void 0 ? _c : 0,
    });
  ...
  var options = {
    ...
    height: height - borderWidth,
    borderWidth:
      borderWidth !== null && borderWidth !== void 0 ? borderWidth : 0,
    borderColor: borderColor,
    textColor: textColor,
    font: font.name,
    fontSize: fontSize,
...
exports.defaultOptionListAppearanceProvider = function (
  optionList,
  widget,
  font,
) {
