...
exports.hasUtf16BOM =
  exports.utf16Decode =
  exports.lowSurrogate =
  exports.highSurrogate =
  exports.hasSurrogates =
  exports.isWithinBMP =
  exports.utf16Encode =
  exports.utf8Encode =
    void 0;
...
exports.utf8Encode = function (input, byteOrderMark) {
  ...
  for (var idx = 0, len = input.length; idx < len; ) {
    ...
    // Should never reach this case
      ...
      throw new Error(
        "Invalid code point: 0x" + strings_1.toHexString(codePoint),
      );
  }
...
exports.utf16Encode = function (input, byteOrderMark) {
  ...
  for (var idx = 0, len = input.length; idx < len; ) {
    ...
    // Four byte encoding (surrogate pair)
      ...
      encoded.push(
        exports.highSurrogate(codePoint),
        exports.lowSurrogate(codePoint),
      );
      idx += 2;
    }
    // Should never reach this case
