...
exports.assertPositive =
  ...
  exports.assertMultiple =
  exports.assertRangeOrUndefined =
  exports.assertRange =
  exports.assertEachIs =
  exports.assertOrUndefined =
  exports.assertIs =
  exports.createTypeErrorMsg =
  exports.isType =
  exports.getType =
  exports.assertIsSubset =
  exports.assertIsOneOfOrUndefined =
  exports.assertIsOneOf =
...
exports.assertIsOneOf = function (value, valueName, allowedValues) {
  ...
  throw new TypeError(
    exports.createValueErrorMsg(value, valueName, allowedValues),
  );
};
...
exports.createTypeErrorMsg = function (value, valueName, types) {
  ...
  for (var idx = 0, len = types.length; idx < len; idx++) {
    ...
    if (type === "string") allowedTypes[idx] = exports.backtick("string");
    else if (type === "number") allowedTypes[idx] = exports.backtick("number");
    else if (type === "boolean")
      allowedTypes[idx] = exports.backtick("boolean");
    else if (type === "symbol") allowedTypes[idx] = exports.backtick("symbol");
    else if (type === "bigint") allowedTypes[idx] = exports.backtick("bigint");
    else if (type === Array) allowedTypes[idx] = exports.backtick("Array");
    else if (type === Uint8Array)
      allowedTypes[idx] = exports.backtick("Uint8Array");
    else if (type === ArrayBuffer)
      allowedTypes[idx] = exports.backtick("ArrayBuffer");
    else allowedTypes[idx] = exports.backtick(type[1]);
  }
