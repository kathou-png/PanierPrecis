...
export declare const toHexStringOfMinLength: (
  num: number,
  minLength: number,
) => string;
...
export declare const copyStringIntoBuffer: (
  str: string,
  buffer: Uint8Array,
  offset: number,
) => number;
export declare const addRandomSuffix: (
  prefix: string,
  suffixLength?: number,
) => string;
...
export declare const charAtIndex: (
  text: string,
  index: number,
) => [string, number];
export declare const charSplit: (text: string) => string[];
export declare const breakTextIntoLines: (
  text: string,
  wordBreaks: string[],
  maxWidth: number,
...
export declare const findLastMatch: (
  value: string,
  regex: RegExp,
) => {
