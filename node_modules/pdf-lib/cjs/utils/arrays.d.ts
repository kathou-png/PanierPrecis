...
export declare const mergeIntoTypedArray: (
  ...arrays: (string | Uint8Array)[]
) => Uint8Array;
...
export declare const byAscendingId: <
  T extends {
    id: any;
  },
>(
...
export declare const sortedUniq: <T>(
  array: T[],
  indexer: (elem: T) => any,
) => T[];
...
export declare const canBeConvertedToUint8Array: (
  input: any,
) => input is string | Uint8Array | ArrayBuffer;
