...
export declare const drawLinesOfText: (
  lines: PDFHexString[],
...
export declare const drawSvgPath: (
  path: string,
  options: {
    x: number | PDFNumber;
    y: number | PDFNumber;
...
export declare const drawTextLines: (
  lines: {
    encoded: PDFHexString;
    x: number;
    y: number;
