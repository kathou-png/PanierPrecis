...
export var drawSvgPath = function (path, options) {
  ...
  return __spreadArrays(
    [
      ...
      rotateRadians(
        toRadians(
          (_a = options.rotate) !== null && _a !== void 0 ? _a : degrees(0),
        ),
      ),
...
export var drawCheckBox = function (options) {
  ...
  return __spreadArrays([pushGraphicsState()], outline, checkMark, [
    popGraphicsState(),
  ]);
};
export var drawRadioButton = function (options) {
  ...
  return __spreadArrays([pushGraphicsState()], outline, dot, [
    popGraphicsState(),
  ]);
};
export var drawButton = function (options) {
  ...
  return __spreadArrays([pushGraphicsState()], background, lines, [
    popGraphicsState(),
  ]);
};
...
export var drawTextField = function (options) {
  ...
  var markedContent = __spreadArrays(
    [beginMarkedContent("Tx"), pushGraphicsState()],
    lines,
    [popGraphicsState(), endMarkedContent()],
  );
  return __spreadArrays(
    [pushGraphicsState()],
    background,
