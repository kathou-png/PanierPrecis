...
var PDFPage = /** @class */ (function () {
  ...
  PDFPage.prototype.drawText = function (text, options) {
    ...
    contentStream.push.apply(
      ...
      drawLinesOfText(encodedLines, {
        ...
        size: fontSize,
        rotate:
          (_b = options.rotate) !== null && _b !== void 0 ? _b : degrees(0),
      ...
      drawImage(xObjectKey, {
        ...
        height:
          (_d = options.height) !== null && _d !== void 0
            ...
            : image.size().height,
        rotate:
          (_e = options.rotate) !== null && _e !== void 0 ? _e : degrees(0),
  ...
  PDFPage.prototype.drawPage = function (embeddedPage, options) {
    ...
    contentStream.push.apply(
      ...
      drawPage(xObjectKey, {
        ...
        yScale: yScale,
        rotate:
          (_c = options.rotate) !== null && _c !== void 0 ? _c : degrees(0),
  ...
  PDFPage.prototype.drawCircle = function (options) {
    ...
    assertOrUndefined(size, "size", ["number"]);
    this.drawEllipse(
      __assign(__assign({}, options), { xScale: size, yScale: size }),
    );
  };
