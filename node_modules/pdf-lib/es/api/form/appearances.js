...
var getDefaultFontSize = function (field) {
  ...
  var daMatch =
    (_b = findLastMatch(da, tfRegex).match) !== null && _b !== void 0 ? _b : [];
...
export var defaultCheckBoxAppearanceProvider = function (checkBox, widget) {
  ...
  var borderWidth =
    ...
    _a !== void 0
      ? _a
      : 0;
  var rotation = reduceRotation(
    ap === null || ap === void 0 ? void 0 : ap.getRotation(),
  );
  var _d = adjustDimsForRotation(rectangle, rotation),
    width = _d.width,
    height = _d.height;
  var rotate = rotateInPlace(
    __assign(__assign({}, rectangle), { rotation: rotation }),
  );
  var black = rgb(0, 0, 0);
  var borderColor =
    (_b = componentsToColor(
      ...
      ? _b
      : black;
  var normalBackgroundColor = componentsToColor(
    ap === null || ap === void 0 ? void 0 : ap.getBackgroundColor(),
  );
  var downBackgroundColor = componentsToColor(
    ap === null || ap === void 0 ? void 0 : ap.getBackgroundColor(),
    0.8,
  );
  // Update color
...
export var defaultButtonAppearanceProvider = function (button, widget, font) {
  ...
  var black = rgb(0, 0, 0);
  var borderColor = componentsToColor(
    ap === null || ap === void 0 ? void 0 : ap.getBorderColor(),
  );
  var normalBackgroundColor = componentsToColor(
    ap === null || ap === void 0 ? void 0 : ap.getBackgroundColor(),
...
export var defaultTextFieldAppearanceProvider = function (
  textField,
  widget,
  font,
) {
...
export var defaultDropdownAppearanceProvider = function (
  dropdown,
  widget,
  font,
) {
...
export var defaultOptionListAppearanceProvider = function (
  optionList,
  widget,
  font,
) {
