...
interface ListrLoggerOptions<Levels extends string>
  extends ProcessOutputRendererOptions,
...
> {
  ...
  prompt<T extends ListrPromptAdapter = ListrPromptAdapter>(
    adapter: new (
      task: Task<Ctx, Renderer, FallbackRenderer>,
      wrapper: TaskWrapper<Ctx, Renderer, FallbackRenderer>,
    ) => T,
  ): T;
  /**
...
interface ListrTestRendererOptions
  extends RendererLoggerOptions<ListrLogLevels> {
  /**
   * Log subtasks.
   *
   * @defaultValue `true`
...
interface ListrPrimaryRendererSelection<T extends ListrRendererValue>
  extends ListrPrimaryRendererOptions<T> {
...
interface ListrSecondaryRendererSelection<T extends ListrRendererValue>
  extends ListrSecondaryRendererOptions<T> {
...
declare class ListrRenderer {
  ...
  constructor(
    tasks: Task<any, ListrRendererFactory, ListrRendererFactory>[],
...
type ListrTaskResult<Ctx> =
  | string
  | Promise<any>
  | Listr<Ctx, ListrRendererValue, ListrRendererValue>
  | ReadableLike
  | ObservableLike<any>;
/**
 ...
 */
type ListrRendererTask<SelectedRenderer extends ListrRendererFactory> = Task<
  any,
  SelectedRenderer,
  SelectedRenderer
>;
...
> {
  ...
  rendererClassOptions: ListrGetRendererOptions<
    | ListrGetRendererClassFromValue<Renderer>
    | ListrGetRendererClassFromValue<FallbackRenderer>
  >;
...
export {
  ...
  type ListrDefaultRendererTaskOptions,
  type ListrDefaultRendererValue,
  ...
  ListrLogLevels,
  ListrLogger,
  type ListrLoggerOptions,
  type ListrLoggerStyleMap,
  type ListrOptions,
  type ListrPrimaryRendererOptions,
  type ListrPrimaryRendererSelection,
  type ListrPrimaryRendererTaskOptions,
  type ListrPrimaryRendererValue,
  ListrPromptAdapter,
  ListrRenderer,
  type ListrRendererCacheMap,
  ListrRendererError,
  type ListrRendererFactory,
  type ListrRendererOptions,
  ListrRendererSelection,
  type ListrRendererTask,
  type ListrRendererValue,
  type ListrSecondaryRendererOptions,
  type ListrSecondaryRendererSelection,
  type ListrSecondaryRendererTaskOptions,
  type ListrSecondaryRendererValue,
  type ListrSilentRenderer,
  type ListrSilentRendererOptions,
  type ListrSilentRendererTask,
  type ListrSilentRendererTaskOptions,
  type ListrSilentRendererValue,
  type ListrSimpleRenderer,
  type ListrSimpleRendererCache,
  type ListrSimpleRendererOptions,
  type ListrSimpleRendererTask,
  type ListrSimpleRendererTaskOptions,
  type ListrSimpleRendererValue,
  type ListrSubClassOptions,
  type ListrTask,
  ...
  type ListrTaskPrompt,
  type ListrTaskResult,
  type ListrTaskRetry,
  ListrTaskState,
  TaskWrapper as ListrTaskWrapper,
  type ListrTestRenderer,
  type ListrTestRendererOptions,
  type ListrTestRendererTask,
  type ListrTestRendererTaskOptions,
  type ListrTestRendererValue,
  type ListrVerboseRenderer,
  type ListrVerboseRendererCache,
  type ListrVerboseRendererOptions,
  type ListrVerboseRendererTask,
  type ListrVerboseRendererTaskOptions,
  type ListrVerboseRendererValue,
  type LoggerField,
  type LoggerFieldFn,
  ...
  PRESET_TIMESTAMP,
  type PresetTimer,
  type PresetTimestamp,
  ProcessOutput,
  ProcessOutputBuffer,
  type ProcessOutputBufferEntry,
  type ProcessOutputBufferOptions,
  type ProcessOutputOptions,
  type ProcessOutputRendererOptions,
  ProcessOutputStream,
  type ProcessOutputStreamMap,
  PromptError,
  type ReadableLike,
  type RendererLoggerOptions,
  type RendererPresetTimer,
  type RendererPresetTimestamp,
  SilentRenderer,
  SimpleRenderer,
  Spinner,
  ...
  type TestRendererSerializerOutput,
  type TestRendererSerializerTaskKeys,
  VerboseRenderer,
